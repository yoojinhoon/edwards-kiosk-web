((window.apn = window.apn || {}),
          ...
          : e == apn.P.LINEDASH2
            ...
            : e == apn.P.ITR_OP_WGT
              ? (apn.dbUI && apn.dbUI.system && apn.dbUI.system.flwModeHide
                ...
                'dragDrop' == t && a.push({ value: 'FDR', title: 'Send Drop Result' }),
    ...
    if (
      ...
      n.init.shape.type == bx.CCanvasWnd.SHAPE_LINE
        ...
        : ((n.layout && n.layout.children) ||
            (r && r.exeItrNoResize) ||
            ((o.size = { title: 'Size to', type: 2 }), (o.sizeBy = { title: 'Size by', type: 2 })),
          (r && r.exeItrNoZoom) || ((o.zoom = { title: 'Zoom to', type: 2 }), (i = !0))),
      r)
    ) {
      (r.styleMap &&
        (r.styleMap.angle && ((o.angle = { title: 'Rotate to', type: 2 }), (i = !0)),
        r.styleMap.visibility && (o.visibility = { title: 'Visibility', type: 1 }),
        r.styleMap.alpha && (o.alpha = { title: 'Opacity', type: 2 }),
        r.styleMap.text &&
          ((o.text = { title: 'Text', type: 1 }), (o.textColor = { title: 'Text color', type: 1 })),
        (r.styleMap.dragX || r.styleMap.dragY) && (o.drag = { title: 'Drag', type: 1 })),
      ...
      if (r.edtOnBuildRuntimeProperty)
        try {
          ...
          console.error(
            'Program error in edtOnBuildRuntimeProperty() of ' + n.create.data.wgtID + '\n\n' + e,
          );
        }
      else if (r.editor && r.editor.runtimeProperties)
        for (var p in r.editor.runtimeProperties)
          ((s = s || {}), (s[p] = bx.$cloneObject({}, r.editor.runtimeProperties[p])));
    ...
    if (
      ...
      (n.create.data.styles &&
        (wgtModule.styleMap.visibility &&
          (apn.Project.resolveStyle(e, 'visibility', n.create.data.styles.visibility) === !0
            ? (i.visibility = 'Show')
            : 1 === apn.Project.resolveStyle(e, 'visibility', n.create.data.styles.visibility)
              ? (i.visibility = 'Pass')
              : 2 === apn.Project.resolveStyle(e, 'visibility', n.create.data.styles.visibility)
                ? (i.visibility = 'Block')
                : (i.visibility = 'Hide')),
        wgtModule.styleMap.alpha &&
          (i.alpha = parseFloat(apn.Project.resolveStyle(e, 'alpha', n.create.data.styles.alpha))),
        wgtModule.styleMap.angle &&
          (i.angle = parseFloat(apn.Project.resolveStyle(e, 'angle', n.create.data.styles.angle))),
        wgtModule.styleMap.text &&
          !wgtModule.exeItrNoText &&
          ((i.text = apn.Project.resolveStyle(e, 'text', n.create.data.styles.text)),
          (i.textColor = apn.Project.resolveStyle(e, 'fontStyle', n.create.data.styles.fontStyle))),
        (wgtModule.styleMap.dragX || wgtModule.styleMap.dragY) &&
          ((i.drag = { dragX: 'No', dragY: 'No' }),
          n.create.data.styles && n.create.data.styles.dragX && (i.drag.dragX = 'Yes'),
          n.create.data.styles && n.create.data.styles.dragY && (i.drag.dragY = 'Yes'),
          (wgtModule.styleMap.dragInParent || wgtModule.styleMap.dragContainParent) &&
  ...
  (apn.P.$O7u = function (e) {
    ...
    if (e) {
      ...
      if (apn.widgetDevice[i] && apn.widgetDevice[i].event)
        return t ? bx.$copyObject(t, apn.widgetDevice[i].event) : apn.widgetDevice[i].event;
    }
    return t;
  }),
  ...
  (apn.P.getEvent = function (e, t, a, i, n, r) {
    function o(e, t) {
      return S.objects[e].create.data &&
        ...
        ? S.objects[t].create.data &&
          ...
          ? S.objects[e].create.data.styles.title > S.objects[t].create.data.styles.title
            ? 1
            : S.objects[e].create.data.styles.title < S.objects[t].create.data.styles.title
              ? -1
              : 0
    ...
    function s(e, t, a) {
      ...
      if (i)
        e[i.ev]
          ? (l[i.ev] || ((l[i.ev] = bx.$cloneObject({}, e[i.ev])), a && (l[i.ev].removed = !0)),
            (l[i.ev].$O3O = l[i.ev].$O3O || {}),
            (l[i.ev].$O3O[i.param] = !0))
          : a || bx.Trace.log('APN', 'warning', 'Unknown custom event=' + t, 'P.getEvent');
      else if (e[t]) {
    ...
    ((apn.P.eventTitle.pageLoad =
      (apn.dbUI && apn.dbUI.system && apn.dbUI.system.page ? apn.dbUI.system.page : 'Page') +
      ' Create'),
      ...
      h ||
        (g.CExeBookCore &&
          ('Y' == g.CExeBookCore.pageNoReset
            ...
            : 'N' == g.CExeBookCore.pageNoReset && (apn.P._usePageLoadEvent = !1)),
        apn.P._usePageLoadEvent && (h = !0));
    }
    if (void 0 === a)
      (i
        ? (u && ((l.flickLeft = {}), (l.flickRight = {}), (l.flickUp = {}), (l.flickDown = {})),
          (l.click = {}),
          h && (l.pageLoad = {}),
          (l.pageRun = {}),
          x && (l.pagePause = {}))
      ...
      if (!c.APX_NO_POINTER_EV) {
        ...
        (g.CExe && g.CExe.event && 'Y' == g.CExe.event.TS1
          ...
          u && ((l.flickLeft = {}), (l.flickRight = {}), (l.flickUp = {}), (l.flickDown = {})),
          (r || (apn.dbUI && apn.dbUI.system && 1 == apn.dbUI.system.exeEventHover)) &&
      ...
      if (y && y.properties && y.properties.attrs && y.properties.attrs.apxMediaControl)
        if (2 == y.properties.attrs.apxMediaControl)
          l.media = {
            ...
            param: { Start: 'Start', Resume: 'Resume', Pause: 'Pause', End: 'End' },
          };
        else if (!r && apn.dbUI && apn.dbUI.system && apn.dbUI.system.exeNativePlayer)
          l.media = {
            value: 'media',
            title: apn.P.eventTitle.media,
    ...
    if (c) {
      ...
      if (
        ...
        for (
          l.stateChange = { value: 'stateChange', title: apn.P.eventTitle.stateChange, param: {} },
            C = 0;
          C < I.length;
          C++
        )
    ...
    if (void 0 === a) {
      ...
      if (V && e.pages[t]) {
        for (C in e.pages[t].objects)
          if (
            (c = apn.Project.getWidgetModule(e.pages[t].objects[C].create.data)) &&
            c.events &&
            c.events.length
          )
    ...
    d = [];
    for (C in l) {
      if (l[C].param && l[C].$O3O) for (b in l[C].param) l[C].$O3O[b] || delete l[C].param[b];
  ...
  (apn.P.getEventWgtParam = function (e, t, a, i, n) {
    function r(e, t) {
      return x.objects[e].create.data &&
        ...
        ? x.objects[t].create.data &&
          ...
          ? x.objects[e].create.data.styles.title > x.objects[t].create.data.styles.title
            ? 1
            : x.objects[e].create.data.styles.title < x.objects[t].create.data.styles.title
              ? -1
              : 0
    ...
    ('dragDrop' == n &&
      (s.APX_NO_POINTER_EV ||
        ...
        (s.styleMap.dragX || s.styleMap.dragY) &&
          (o.dragDropResult = { param: { Accepted: 'Accepted', Rejected: 'Rejected' } }),
        (o.dragDrop = {}))),
      'dragDropResult' == n &&
        (s.APX_NO_POINTER_EV ||
          ((o = o || {}),
      ...
      'contentChange' == n &&
        ...
        ((o = o || {}), (o.contentChange = { param: s.edtOnCheckContentChange(t, a, i) })),
      'contentLoad' == n &&
        s.exeOnCheckContentLoad &&
        s.exeOnCheckContentLoad(t, a, i) &&
        ((o = o || {}), (o.contentLoad = { param: s.exeOnCheckContentLoad(t, a, i) })));
    ...
    if (
      ...
      if (((o = o || {}), 2 == p.properties.attrs.apxMediaControl))
        o.media = { param: { Start: 'Start', Resume: 'Resume', Pause: 'Pause', End: 'End' } };
      else if (!e && apn.dbUI && apn.dbUI.system && apn.dbUI.system.exeNativePlayer)
    ...
    if (
      ('animation' == n &&
        ...
        ((o = o || {}), (o.animation = { param: { Start: 'Start', End: 'End' } })),
      s.edtOnBuildEvent)
    ) {
      o = o || {};
      try {
    ...
    if ('stateChange' == n) {
      ...
      if (
        ...
        for (o = o || {}, o.stateChange = { param: {} }, d = 0; d < h.length; d++)
  ...
  (apn.P.isTransitionOP = function (e, t, a, i) {
    return (
      !!apn.P.isLinkOP(e) || ('CWS' == e && 2 == apn.Project.checkStateTypeByObjectID(t, a, i))
    );
  }),
  ...
  (apn.P.getLtpTarget = function (e, t, a) {
    ...
    for (var r in e.pages)
      i[e.pages[r].module] &&
        ((t && t != r) || (apn.dbUI && apn.dbUI.system && apn.dbUI.system.exeItrSelfReset)) &&
        (a[r] = e.pages[r]);
  }),
  (apn.P.getPropTextFit = function () {
    return [
      { title: apn.CExe.GL({ ko: '안함', en: 'No', ja: '無効' }), value: 0 },
      { title: apn.CExe.GL({ ko: '자간 조정', en: 'BySpacing', ja: '字間調整' }), value: 2 },
      { title: apn.CExe.GL({ ko: '자간 축소', en: 'ShrinkBySpacing', ja: '字間縮小' }), value: 4 },
      { title: apn.CExe.GL({ ko: '글자 압축', en: 'ShrinkByScaling', ja: '文字圧縮' }), value: 1 },
      {
        title: apn.CExe.GL({ ko: '자간&압축 축소', en: 'ShrinkByBoth', ja: '字間&圧縮縮小' }),
        value: 5,
      },
    ];
  }),
  ...
  (apn.Project.$O19 = function (e, t) {
    function a(t, i, n) {
      if (!e.pages[t].objects[i])
        return void (
          window.console && console.error('[AspenCHK] Dangling object', t, i, e.pages[t].objects[i])
        );
      var r = e.pages[t].objects[i].layout;
      if (r && r.children) {
        for (var o = 0; o < r.children.length; o++)
          if (r.children[o] == n && (r.children.splice(o, 1), o--, (s = -1), r.layers))
    ...
    function n(t, a) {
      ...
      if (r && r.layers && (!r.children || !r.children.length))
        return (
          window.console &&
            console.error('[AspenCHK] Broken layer container', t, a, e.pages[t].objects[a]),
      ...
      return 'apn.CLayer' != e.pages[t].objects[a].module || i(e.pages[t], a)
        ? n
        : (window.console &&
            console.error('[AspenCHK] Dangled layer', t, a, e.pages[t], e.pages[t].objects[a]),
          delete e.pages[t].objects[a],
          !0);
    }
    ...
    if ((apn.Project.docDcmpr(e), t)) {
      ...
      for (o in e.pages)
        for (var p in e.pages[o].objects)
          if (
            (d = apn.Project.getWidgetModule(e.pages[o].objects[p].create.data)) &&
            d.srcOnPreParse
          )
            try {
      ...
      for (n in e.pages[i].objects) {
        if (((l = e.pages[i].objects[n]), l.layout && l.layout.states))
          for (o in l.layout.states)
            if (l.layout.states[o].objects)
              for (s in l.layout.states[o].objects)
                for (d = l.layout.states[o].objects[s].create, r = 0; r < p.length; r++)
  ...
  (apn.Project.$O18 = function (e) {
    var t = {
      ...
      pages: {
        S: { UI: { title: 'START', noEditable: !0 }, objects: {}, module: 'apn.CFlowStartPage' },
        E: { UI: { title: 'OUT', noEditable: !0 }, objects: {}, module: 'apn.CFlowEndPage' },
        I: { UI: { title: 'IN', noEditable: !0 }, objects: {}, module: 'apn.CFlowInPage' },
        C: {
  ...
  (apn.Project.$O10 = function (e, t) {
    ((e.layouts[e.index.layoutID] = {
      ...
      t.deviceID || (apn.dbUI && apn.dbUI.device && (t.deviceID = apn.dbUI.device)),
      ...
      t.deviceID && apn.widgetDevice[t.deviceID]
        ? ((e.layouts[e.index.layoutID].CTXT.deviceID = t.deviceID),
          apn.widgetDevice[t.deviceID].skinID &&
            (e.layouts[e.index.layoutID].property.skinID = apn.widgetDevice[t.deviceID].skinID),
          apn.widgetDevice[t.deviceID].themeID &&
            (e.layouts[e.index.layoutID].property.themeID = apn.widgetDevice[t.deviceID].themeID),
          apn.widgetDevice[t.deviceID].wgtLibID &&
            (e.layouts[e.index.layoutID].CTXT.wgtLibID = apn.widgetDevice[t.deviceID].wgtLibID),
          (e.layouts[e.index.layoutID].property.skinShow = 1))
        : bx.Trace.log('APN', 'error', 'Unknown deviceID: ' + t.deviceID, 'Project.AL'),
      e.index.layoutID++);
  }),
    ...
    return (
      ...
      t && t.title
        ...
        : (e.pages[a].UI.title =
            ...
            ' ' +
            a),
      apn.Project.FILLSTYLE_PAGE && (e.pages[a].BG = { fillStyle: apn.Project.FILLSTYLE_PAGE }),
      t && t.color && ((e.pages[a].BG = e.pages[a].BG || {}), (e.pages[a].BG.fillStyle = t.color)),
      e.index.pageID++,
      a
    );
  }),
  ...
  (apn.Project.getPages = function (e, t, a, i) {
    function n(t) {
      a && 'object' == typeof a
        ? (a[e.pages[t].module] || p || (i && i.editable && !e.pages[t].UI.noEditable)) && s.push(t)
        : (e.pages[t].module == a || p || (i && i.editable && !e.pages[t].UI.noEditable)) &&
          s.push(t);
    }
    function r(t, a) {
  ...
  (apn.Project.getPageTitles = function (e, t, a) {
    for (var i = apn.Project.getPages(e, t, a), n = 0; n < i.length; n++)
      e.pages[i[n]] && e.pages[i[n]].UI.title ? (i[n] = e.pages[i[n]].UI.title) : (i[n] = '');
    return i;
  }),
  (apn.Project.$O8R = function (e, t, a, i, n, r, o, s) {
    ...
    function g(e) {
      for (var t = 0; t < e.length; t++)
        if (
          ...
          '$' != a.param.charAt(0) && T[a.param] && (e[t].event = a.ev + ':' + T[a.param]);
        }
    }
    function u(e) {
      if ('object' == typeof e && e instanceof Object)
        for (var a in e) ('layout' == a && e[a] && (t.remapLayout || c)(T, e[a]), u(e[a]));
    }
    t = t || {};
          ...
          for (var _ = 0; _ < v.length; _++) {
            if (((y = !1), v[_].name && C && C.js && C.js.fs.length))
              for (var m = 0; m < C.js.fs.length; m++)
                C.js.fs[m].js && C.js.fs[m].js.data && C.js.fs[m].js.name == v[_].name && (y = !0);
            y || (v.splice(_, 1), _--);
          }
        }
    ...
    var P,
      T = {};
    for (S in x.objects)
      T[S] || (I++, (T[S] = (t.allocObjectID || l)(I, (t.getObjectIdPostfix || d)(h))));
    var w, E;
    E =
  ...
  (apn.Project.$O14 = function (e, t, a, i, n, r, o, s) {
    ((e.rsc[t].type = a),
      ...
      void 0 !== s ? (e.rsc[t].UI = s) : void 0 !== e.rsc[t].UI && delete e.rsc[t].UI,
      apn.Project.$O3P(e),
  ...
  (apn.Project.$O1a = function (e, t, a, i) {
    ...
    for (var c in e.pages)
      for (r in e.pages[c].objects) {
        if (
          ...
          (l = apn.Project.getWidgetModule(p.create.data)) && l.edtOnRemoveAsset)
        )
          try {
            ...
            i &&
              i.IEditable &&
              i.onSystemError(
                'Program error in edtOnRemoveAsset() of ' + p.create.data.wgtID + '\n\n' + e,
              );
          }
        if (
    ...
    for (c in e.pages) (e.pages[c].BG && n(e.pages[c].BG, t), e.pages[c].UI && n(e.pages[c].UI, t));
    return (
      a &&
        (delete e.rsc[t],
        apn.Project.$O3P(e),
  ...
  (apn.Project.$O16 = function (e) {
    return (
      !e.states && ((e.states = { 0: { objects: {} } }), (e.state = '0'), (e.stateIndex = 0), !0)
    );
  }),
  ...
  (apn.Project.$O1c = function (e, t, a, i) {
    if (!apn.Project.checkStateByObjectID(e, t, a, i))
      return (
        bx.Trace.log('APN', 'warning', 'Invalid scene=' + i, 'Project.removeSceneByObjectID'),
        !1
      );
    if ('0' == i) return !1;
  ...
  (apn.Project.$O1d = function (e, t) {
    ...
    if (a) {
      for (var i = 0; i < a.length; i++) if (a[i] == t) return void a.splice(i, 1);
  ...
  (apn.Project.findITRs = function (e, t, a, i) {
    if (t)
      return e.pages[t]
        ? a && !apn.Project.$O5j(a)
          ? e.pages[t].objects[a]
            ? (i && (e.pages[t].objects[a].ITRs = e.pages[t].objects[a].ITRs || []),
  ...
  (apn.Project.createITR = function (e, t, a, i) {
    ...
    if (((n.event = i || 'click'), (n.action = t), 'LTP' == t))
      ...
      ((n.transit = {}), void 0 === a.objectID && (n.transit.effect = 'moveRight'));
    else if ('CWS' == t) {
      n.target = a || {};
      var r;
      ((r =
        void 0 === a.objectID ? e.pages[a.pageID] : e.pages[a.pageID].objects[a.objectID].layout),
      ...
      if (apn.Project.$O3Q(t.action)) {
        ...
        if (n && n.length)
          for (var r = 0; r < n.length; r++)
            if (n[r] != t && n[r].event == t.event && apn.Project.$O3Q(n[r].action)) return !0;
      }
      return !1;
    }
  ...
  (apn.Project.dictateITR = function (e, t, a, i, n) {
    ...
    function s(e) {
      ...
      return (
        'none' != e.effect &&
          ((t += 'with ' + h + apn.P.effectTitle[e.effect] + x + ' effect '), (t += p(e))),
        t
      );
    }
    function p(e) {
    ...
    function l(e) {
      ...
      return (
        e.type &&
          'none' != e.type &&
          (t += 'in trace of ' + h + apn.P.traceTitle[e.type] + '[' + e.ratio + ']' + x + ' '),
        t
      );
    }
    function d(e, t, a) {
    ...
    if (
      ...
      var f;
      if (!(f = e.pages[a].objects[u.target.objectID]) && apn.CClipboard && apn.CClipboard.$O5Z) {
      ...
      ('$F' == u.target.stateID
        ...
        : '$B' == u.target.stateID
          ...
          : '$RF' == u.target.stateID
            ? ((g += 'Set forward state of ' + h + v + x + ' '), (g += 'in round-robin '))
            : '$RB' == u.target.stateID
              ? ((g += 'Set forward state of ' + h + v + x + ' '), (g += 'in round-robin '))
              : (g += c
                  ? 'Set state of ' +
      ...
      if (
        (u.set &&
          void 0 !== u.set.text &&
          (g += 'Set text of ' + h + v + x + ' to ' + h + '"' + o(u.set.text) + '"' + x + ' '),
        u.set &&
          void 0 !== u.set.value &&
          (g += 'Set value of ' + h + v + x + ' to ' + h + '"' + o(u.set.value) + '"' + x + ' '),
        u.set &&
        ...
        u.set &&
          void 0 !== u.set.alpha &&
          (g += 'Set opacity of ' + h + v + x + ' to ' + h + r(100 * u.set.alpha) + '%' + x + ' '),
        u.set &&
          void 0 !== u.set.trOrg &&
          (g +=
        ...
        u.set &&
          ...
          (g +=
            ...
            x +
            '˚ '),
        u.set && void 0 !== u.set.media && (g += u.set.media + ' media of ' + h + v + x + ' '),
        u.set &&
        ...
        u.set &&
          u.set.pBk &&
          (g += 'Move ' + h + v + x + ' back to ' + h + 'Original position' + x + ' '),
        u.set &&
          u.set.positionBy &&
          (g +=
            'Move ' +
      ...
      if (
        (u.set &&
          ...
          (g +=
            'restore' == u.set.zIndex
              ...
              : 'Set z-index of ' + h + v + x + ' to ' + h + u.set.zIndex + x + ' level '),
        u.set &&
          u.set.drag &&
          ('No' == u.set.drag.dragX && 'No' == u.set.drag.dragY
            ...
            : ((g += 'Enable dragging for ' + h + v + x + ' by '),
              ...
              'Yes' == u.set.drag.dragInParent && (g += 'keeping in parent area '))),
        ...
        for (var E in u.set.extended) {
          if (
            ((P = u.set.extended[E]),
            T.extended && T.extended.extended[E] && T.extended.extended[E].input instanceof Array)
          )
          ...
          ((g +=
            ...
            ' ' +
            h +
            (T.extended && T.extended.extended[E] && T.extended.extended[E].title
      ...
      g += u.result ? 'Notify that this drop is accepted' : 'Notify that this drop is rejected';
      ...
      if (((g += 'Load ' + h + o(u.url) + x + ' '), '$URL_CW' == u.target.objectID))
    ...
    if (g && !c && 'CMT' != u.action && t.event && t.event.indexOf(':') != -1) {
      ...
      for (
        var S, V = apn.P.getEvent(e, a, i), j = apn.P.resolveCompositeSysEV(t.event), E = 0;
        E < V.length;
        E++
      )
        if (V[E].value == j.ev)
          if (V[E].param) {
            for (S in V[E].param)
              if (S == j.param) {
                g =
                  '$ELSE' == j.param
                    ? 'Else, ' + g.substring(0, 1).toLowerCase() + g.substring(1)
                    : 'On ' +
                      h +
                      V[E].param[S] +
                      x +
      ...
      for (a in e.pages[n].objects)
        if (e.pages[n].objects[a].ITRs && e.pages[n].objects[a].ITRs.length)
          for (i = 0; i < e.pages[n].objects[a].ITRs.length; i++)
            t(n, e.pages[n].objects[a].ITRs[i]) && (e.pages[n].objects[a].ITRs.splice(i, 1), i--);
    }
  }),
  ...
  (apn.Project.checkIfAnyScript = function (e) {
    ...
    if (i)
      for (var n in i)
        if (i[n] && i[n].spt2impt && i[n].spt2impt.js && i[n].js && t(i[n].spt2impt.js, i[n].js))
          return !0;
    var r;
    for (var o in e.pages) {
      for (ev in apn.P.eventTitle) if (apn.Project.getSPT(e, o, void 0, ev)) return !0;
      for (r in e.pages[o].objects)
        for (ev in apn.P.eventTitle) if (apn.Project.getSPT(e, o, r, ev)) return !0;
    }
    return !1;
  }),
  ...
  (apn.Project.resolveStyle = function (e, t, a, i) {
    if (void 0 === a) {
      ...
      if ((void 0 === r[t] && void 0 !== n[t] && (r[t] = n[t]), void 0 !== r[t])) return r[t];
    ...
    if (void 0 === a) {
      ...
      if ('exeScript' == t)
        return apn.dbUI && apn.dbUI.system && apn.dbUI.system.exeScripting
          ? apn.dbUI.system.exeScripting > 1 && apn.dbUI.system.exeScriptingDefault
  ...
  (apn.Project.resolveTiming = function (e, t) {
    (void 0 === t.timing && (t.timing = apn.Project.resolveProperty(e, 'trTiming')),
      void 0 === t.duration && (t.duration = apn.Project.resolveProperty(e, 'trDuration')));
  }),
  (apn.Project.resolveTransit = function (e, t, a) {
    (apn.Project.resolveTiming(e, t),
      void 0 === t.effect &&
        (t.effect = apn.Project.resolveProperty(e, a ? 'trEffectBackward' : 'trEffectForward')));
  }),
  ...
  (apn.Project.getScriptVer = function (e) {
    ...
    return (
      2 == t &&
        ((apn.dbUI && apn.dbUI.system && 2 == apn.dbUI.system.exeScripting) || (t = 1),
  ...
  (apn.Project.getExeModuleID = function (e, t) {
    if (
      ...
      if (
        ...
        return apn.widgetDevice[apn.Project.getLayout(e).CTXT.deviceID].exeModule[
          apn.Project.getLayout(e).CTXT.exeID
        ].module;
      t ||
        bx.Trace.log(
  ...
  (apn.Project.getFontList = function (prj, exe, standAlone) {
    ...
    var clsExe;
    if (
      (exe ? (clsExe = eval(exe)) : prj && (clsExe = apn.Project.getExeModule(prj)),
  ...
  (apn.Project.getGetPubModule = function (exe) {
    ...
    return (
      (clsExe = eval(exe)),
      clsExe && clsExe.IStub_dbGetPublishModule ? clsExe.IStub_dbGetPublishModule() : null
    );
  }),
        ...
        e.pages[n].objects[a].create.data &&
          ...
          (0 == e.pages[n].objects[a].create.data.wgtID.indexOf('apn.') ||
            (apn.widgets[e.pages[n].objects[a].create.data.wgtID] &&
              apn.widgets[e.pages[n].objects[a].create.data.wgtID].APX_PUB_PRELOAD) ||
            (i[e.pages[n].objects[a].create.data.wgtID] = !0));
    var r = apn.Project.getSpt2preq(e, 'widget');
    if (r)
      for (var n = 0; n < r.length; n++)
        if (r[n] && r[n].length)
          for (var a = 0; a < r[n].length; a++) (apn.widgets[r[n][a]] || t) && (i[r[n][a]] = !0);
    return i;
  }),
  (apn.Project.publishListFontFile = function (e, t, a, i, n) {
    function r(e) {
      if (((y[e] = !0), !f[e]))
        for (var a = 0; a < o.length; a++)
          if (
            ('file' == o[a].type || 'dir' == o[a].type || ('google' == o[a].type && t)) &&
            o[a].face == e
          ) {
            f[e] = !0;
            break;
    ...
    var h,
      ...
      f = {},
      y = {};
    a && ((h = apn.Project.resolveStyle(e, 'font')), r(h), 'Open Sans' != h && r('Open Sans'));
    var v, C, b;
    for (d in e.pages)
      if (!n || n == d)
        for (c in e.pages[d].objects)
          if (
            ...
            v &&
              v.styleMap &&
              v.styleMap.font &&
              r(apn.Project.resolveStyle(e, 'font', C.styles ? C.styles.font : void 0));
    for (d in e.pages)
      if (!n || n == d)
        for (c in e.pages[d].objects)
          ((C = e.pages[d].objects[c].create.data),
    ...
    for (g = 0; g < o.length; g++) {
      if (
        ((S =
          ('file' == o[g].type || 'dir' == o[g].type || ('google' == o[g].type && t)) &&
          f[o[g].face]),
      ...
      (l &&
        !l[o[g].face] &&
        (S && (S = !1), y[o[g].face] && ((T = !0), (w += (w ? ', ' : '') + o[g].title))),
  ...
  (apn.Project.publishListAsset = function (e, t, a) {
        ...
        for (var o in e)
          if ('mediaID' == o)
            if ('object' == typeof e[o])
              for (var s in e[o])
                ((e[o][s] && e[o][s].charAt && 'R' == e[o][s].charAt(0)) || a) &&
    ...
    if ((o || i(apn.Project.getLayout(e).property), t))
      ...
      for (s in e.pages)
        (r && r.page && r.page[s]) ||
          (e.pages[s].BG && i(e.pages[s].BG), e.pages[s].UI && i(e.pages[s].UI));
    if (void 0 === t && void 0 === a) {
      var l = apn.Project.publishGetPageTemplate(e, { all: !0 });
      if (l) for (var d in l) for (p = 0; p < l[d].length; p++) n[l[d][p]] && delete n[l[d][p]];
    }
    var c = [];
    for (p in n) c.push(p);
    return c;
  ...
  (apn.Project.getTemplatePropAsset = function (e) {
    ...
    if (n)
      for (var o in n)
        if ('splash' == o) n[o] && n[o].img && n[o].img.srcMediaID && (i[n[o].img.srcMediaID] = !0);
  ...
  (apn.Project.publishGetPageTemplate = function (e, t) {
    ...
    if ((i = apn.Project.isTemplateLinked(e)) && !i.built) {
      for (
        var n = apn.Project.getPages(e, void 0, void 0, { editable: !0 }), r = {}, o = 0;
        o < n.length;
        o++
      )
        r[n[o]] = n[o];
  ...
  (apn.Project.publishMeta = function (e, t, a) {
    function i(e, a, i) {
      e[t] &&
        (a && i
          ? ((o.pages = o.pages || {}), (o.pages[a] = o.pages[a] || {}), (o.pages[a][i] = e[t]))
          : (o.file = e[t]));
    }
    var n,
      r,
    ...
    return (
      a && apn.Project.getLayout(e).property[a] && i(apn.Project.getLayout(e).property[a]),
      o
    );
  }),
  (apn.Project.publishAttachments = function (e) {
        ...
        if (((a = e[n]), a.name && !c[a.name] && t && t.fs.length))
          for (var i = 0; i < t.fs.length; i++)
            if (t.fs[i].js.data && t.fs[i].js.name == a.name) {
              ((s = s || []), s.push({ name: a.name, data: t.fs[i].js.data }), (c[a.name] = !0));
              break;
            }
    }
    var a,
    ...
    for (var p in e.pages)
      for (a in e.pages[p].objects)
        if (
          ...
          (r = apn.Project.getWidgetModule(n.create.data)) && r.pubOnGetAttachment)
        ) {
          o = null;
          try {
            if ((o = r.pubOnGetAttachment(e, p, a)) && o && o.length)
              for (i = 0; i < o.length; i++)
                o[i].name &&
                  ((s = s || []), s.push({ name: p + '_' + a + o[i].name, data: o[i].data }));
          } catch (e) {
            console.error(
              '[AspenCHK] Program error in pubOnGetAttachment() of ' + n.create.data.wgtID,
              e,
            );
          }
        }
    ...
    if (l.IStub_getMetaFile) {
      ...
      if (d && d.length) for (i = 0; i < d.length; i++) ((s = s || []), s.push(d[i]));
    }
    var c = {},
    ...
    if (u) {
      ...
      for (var i = 0; i < h.length; i++)
        ((x = h[i].fId),
          u[x] && u[x].spt2impt && u[x].spt2impt.js && u[x].js && t(u[x].spt2impt.js, u[x].js));
    }
    var f,
  ...
  (apn.Project.publishAsyncStart = function (e, t, a) {
    ...
    function n() {
      ...
      return i.IStub_pubOnPrePublish ? i.IStub_pubOnPrePublish(e, t, a) : void t();
    }
    var r = 0,
      o = 0,
      s = 0,
  ...
  (apn.Project.publishCompressFont = function (e, t) {
    ...
    if (apn.dbUI && apn.dbUI.system && apn.dbUI.system.pubFontCompress) {
      for (var n = apn.Project.publishListFontFile(e, void 0, !0), r = {}, o = 0; o < n.length; o++)
        n[o].compress && (r[n[o].face] = { code: '', path: n[o].fontFile, face: n[o].face });
        ...
        for (s in e.pages[o].objects) {
          ...
          if (r[u] && (x = apn.Project.findITRs(e, o, s)))
            for (p = 0; p < x.length; p++)
              'CWP' == x[p].action && x[p].set && x[p].set.text && a(r[u], x[p].set.text + '');
        }
  ...
  (apn.Project.publishGetExMedia = function (e) {
    ...
    for (var n in e.pages)
      for (t in e.pages[n].objects) {
        ...
        a && a.pubOnGetExMedia && bx.$copyObject(i, a.pubOnGetExMedia(e, n, t) || {});
      }
    return i;
  }),
  ...
  (apn.Project.createNew = function (e) {
    ...
    return (apn.Project.$O11(t, { module: 'apn.CFlowPage' }), apn.Project.$O10(t, e), t);
  }),
    ...
    for (a in e.pages) {
      if (e.pages[a].SPT)
        for (n in e.pages[a].SPT)
          if (e.pages[a].SPT[n] && (e.pages[a].SPT[n] || '').indexOf(t) != -1) return !0;
  ...
  (apn.Project.$O8G = function (e, t) {
    if (e && e.rsc[t]) {
      if (e.rsc[t].type && e.rsc[t].type.split && e.rsc[t].type.split('/').length > 0)
  ...
  (apn.Project.$O1e = function (e, t, a, i, n) {
    ...
    if (!i) {
      ...
      (!s && asui && asui.PRJIF.getData() && (s = asui.PRJIF.getData().property.id),
        bx.CCookie.get('pid') != s && bx.CCookie.set('pid', s));
    }
    if (
      (n && n.path && (o = n.path + ('/' == n.path[n.path.length - 1] ? '' : '/')),
      ...
      if (t && t.charAt && 'X' == t.charAt(0)) {
        if (apn.dbUI && apn.dbUI.system && apn.dbUI.system.mediaExternal) {
          ...
          if ((y = apn.dbUI.system.mediaExternal[y])) {
            var v;
            if ((v = (y || '').indexOf('.')) > 0) {
              if (window[y.substring(0, v)] && window[y.substring(0, v)][y.substring(v + 1)])
                return window[y.substring(0, v)][y.substring(v + 1)](e, t, a, i);
  ...
  (apn.Project.$O5k = function (e, t, a, i) {
    window.asui && asui.API && asui.API.copyAssetFile && asui.API.copyAssetFile(e, t, a, i);
  }),
      ...
      if (n.data && n.type && n.type.split('/').length > 1) {
        ...
        'image' == r
          ? o[1].indexOf('svg') != -1
            ...
            : ('jpeg' == o[1] && (o[1] = 'jpg'), (i = 'asset/I/' + s + '.' + o[1]))
          : 'video' == r
  ...
  (apn.Project.$O5X = function (e, t, a, i, n, r, o) {
    if ('media' == a)
        ...
        if (0 == i.indexOf('^L')) {
          ...
          ('T' == s[2]
            ...
            (n.style.backgroundImage =
              'linear-gradient(' + p + s[3] + ',' + s[4] + ' ' + 100 * parseFloat(s[5]) + '%)'));
          ...
          ((l.onload = function () {
            'XY' == s[2] &&
              ...
              (n.style.backgroundSize =
                Math.round(r * this.width) + 'px ' + Math.round(o * this.height) + 'px'),
      ...
      'color' == a &&
        (i ? (n.style.backgroundColor = i) : (n.style.backgroundColor = 'transparent'));
  }),
  (apn.Project.$O4K = function (e, t, a) {
    ...
    if (t.layers) for (i in t.layers) e[t.layers[i].id] && (t.layers[i].id = e[t.layers[i].id]);
    if (t.connect)
      ...
      for (i in t.states)
        for (n in t.states[i].objects)
          e[n] &&
            ...
            a &&
              ((r = apn.Project.getWidgetModule(t.states[i].objects[e[n]].create.data)),
              r &&
                r.edtOnRemapObjectID &&
                r.edtOnRemapObjectID(a, t.states[i].objects[e[n]].create.data, e)));
    }
  }),
  (apn.Project._remapObject = function (e, t, a) {
    function i(e, t) {
      for (var a = 0; a < e.length; a++)
        if (
          ...
          '$' != i.param.charAt(0) && t[i.param] && (e[a].event = i.ev + ':' + t[i.param]);
        }
    }
    if (t.objects[a].layout && t.objects[a].layout.children)
      for (var n = 0; n < t.objects[a].layout.children.length; n++)
        e[t.objects[a].layout.children[n]] || (t.objects[a].layout.children.splice(n, 1), n--);
    ...
    (o && o.edtOnRemapObjectID && o.edtOnRemapObjectID(r, t.objects[a].create.data, e),
  ...
  (apn.Project.docCmpr = function (e) {
    ...
    for (t in e.pages)
      for (a in e.pages[t].objects)
        if (e.pages[t].objects[a].create.data && (n = e.pages[t].objects[a].create.data.styles))
          for (i in n) apn.Project.docMap[i] && ((n[apn.Project.docMap[i]] = n[i]), delete n[i]);
  }),
  (apn.Project.docDcmpr = function (e) {
    ...
    for (t in e.pages)
      for (a in e.pages[t].objects)
        if (e.pages[t].objects[a].create.data && (n = e.pages[t].objects[a].create.data.styles))
          for (i in n)
            apn.Project.docMapInv[i] && ((n[apn.Project.docMapInv[i]] = n[i]), delete n[i]);
  }),
  (window.apn = window.apn || {}),
  ...
  (apn.CRscLoader.prototype.load = function (e, t, a) {
    function i() {
      return t[this.apnImageLoaderId]
        ? (t[this.apnImageLoaderId].local &&
          ...
          this.apnImageLoaderNC || apn.CRscLoader.add(this.getAttribute('src'), this),
          p++,
          void (p + l == d && a(d, p, l)))
        : (l++, void console.error('Missing resource ID: ' + this.apnImageLoaderId));
    }
    function n() {
      (l++, p + l == d && a(d, p, l));
    }
    ...
    for (s in t)
      if (t[s].url)
        if (!t[s].noCache && !t[s].standAlone && t[s].url && apn.CRscLoader.check(t[s].url))
          ((t[s].image = apn.CRscLoader.check(t[s].url)), p++, p + l == d && a(d, p, l));
        else {
          var g = r(s);
        ...
        if (e.rsc[c]) {
          if ('image' == apn.Project.getMediaType(e, c) || 1 == t[s].type)
            if (1 == t[s].type && e.rsc[c].UI && e.rsc[c].UI.snapshot) {
              ...
              (0 == e.rsc[c].type.indexOf('audio') || 0 == e.rsc[c].type.indexOf('video'))
          ...
          ((t[s].src = o(
            apn.Project.$O1e(e, c, 1 == t[s].type, t[s].standAlone, { ignoreLocal: !0 }),
            t[s].noCache,
          )),
          'image' == apn.Project.getMediaType(e, c) || 1 == t[s].type)
        )
          if (!t[s].noCache && !t[s].standAlone && t[s].src && apn.CRscLoader.check(t[s].src))
            ((t[s].image = apn.CRscLoader.check(t[s].src)), p++, p + l == d && a(d, p, l));
          else {
            var g = r(s);
    ...
    if (a) {
      try {
        ...
        return (
          ...
          (apn.localStorage.error.msg = apn.localStorage.$O2u[apn.localStorage.error.code]),
          !1
        );
      }
      return !0;
  ...
  (apn.IWidget.getCanvasObjectStyle = function (e, t, a, i, n) {
    ...
    if (i) for (s in i) void 0 !== t.styleMap[s] && void 0 !== i[s] && (e[s] = i[s]);
  ...
  (apn.IWidget.createCanvasObject = function (e, t, a, i, n, r, o, s, p, l) {
    ...
    return (
      ...
      (d.module = a),
      (d.create = {
        type: 512 | l | (i != bx.CCanvasWnd.SHAPE_LINE || (o && o.keepRatio) ? 0 : 256),
  ...
  (apn.IWidget.exeSetLine = function (e, t, a, i, n) {
    ...
    if (e.apxRefreshOnStrokeChange) {
      if (
        ...
        var o = apn.Project.getWidgetModule(n.screen.objects[e.apnOID].create.data);
        o &&
          o.exeRenderTag &&
          o.exeRenderTag(
            n.viewer,
      ...
      t && a
        ? e._apxLineHeight
          ...
          : e.apxLineBorderTop
            ? ((e.style.borderTopWidth = Math.max(1, Math.round(parseInt(t) * i)) + 'px'),
              (e.style.borderTopColor = apn.CES.$O6l(a)))
            : ((e.style.borderWidth = Math.max(1, Math.round(parseInt(t) * i)) + 'px'),
  ...
  (apn.IWidget.exeSetLineDash = function (e, t, a) {
    if (e.apxRefreshOnStrokeChange) {
      if (
        ...
        var i = apn.Project.getWidgetModule(a.screen.objects[e.apnOID].create.data);
        i &&
          i.exeRenderTag &&
          i.exeRenderTag(
            a.viewer,
      ...
      (t && (n = 2 == t.length && t[0] == t[1] ? 'dotted' : 'dashed'),
        e.apxLineBorderTop ? (e.style.borderTopStyle = n) : (e.style.borderStyle = n));
    }
  }),
  (apn.IWidget.exeSetFillStyle = function (e, t, a) {
    if (e.apxRefreshOnStrokeChange) {
      ...
      t && apn.CES.$O6k(t)
        ? e.$CSS('filter', bx.$applyMsFilter(e, 'backgroundAlpha', apn.CES.$O6k(t)))
  ...
  (apn.IWidget.exeSetText = function (e, t, a, i, n, r, o, s, p, l, d, c, g) {
    (!e.apnCur.apxTextApplied &&
      ...
      (e.apnCur.forced || void 0 === e.apnCur.text || t != e.apnCur.text) &&
        ...
        void 0 === e.textTag
          ? e.apnSingleText
            ? apn.widgets['apn.wgt.singleText'].exeSetText(e, t, a, i, n, r, o, s, p, l, d)
            : e.apxInputTag
          ...
          : e.apnOnSetText
            ...
            : apn.widgets['apn.wgt.rect'].exeSetText(e, t, a, i, n, r, o, d, c, g),
  ...
  (apn.IWidget.exeRenderSize = function (e, t, a, i, n, r, o, s, p) {
    ...
    if (a.REFRESH_ON_RESIZE && !p) t.$O3x(a.apnOID);
      ...
      var l =
          (Math.round(i.init.position.x) * r - Math.round(Math.round(i.init.position.x) * r)) / r,
        d = (Math.round(i.init.position.y) * o - Math.round(Math.round(i.init.position.y) * o)) / o;
      if (bx.HCL.DV.isIE() && bx.HCL.DV.isIE() <= 7)
        ...
        var c = Math.max(
            0,
            apn.widgets.utils.$O2v(i.init.shape.w + l, r) + apn.IWidget.$O2z(1, n, i, r),
          ),
          g = Math.max(
            0,
            apn.widgets.utils.$O2w(i.init.shape.h + d, o) + apn.IWidget.$O2z(1, n, i, o),
          );
      ...
      a.create.data &&
        ...
        t.apnCur.LW.strokeStyle == a.create.data.styles.strokeStyle
          ...
          : ((t.apnCur.LW = t.apnCur.LW || {}),
            ...
            (p = t.apnCur.LW.value)));
      var l =
          apn.widgets.utils.$O2x(e, t, a.init.position.x, n) - p - (t.wgt_dx ? t.wgt_dx : 0) + 'px',
        d =
          apn.widgets.utils.$O2y(e, t, a.init.position.y, r) - p - (t.wgt_dy ? t.wgt_dy : 0) + 'px';
      (t.style.left != l && (t.style.left = l),
        t.style.top != d && (t.style.top = d),
        o && (t.REFRESH_ON_RESIZE || apn.IWidget.exeRenderSize(e.viewer, e, t, a, i, n, r, !0)));
    }
  ...
  (apn.IWidget.$O2z = function (e, t, a, i) {
    ...
    if (
      ...
      if (r > 1 && apn.Project.resolveStyle(t, 'strokeStyle', a.create.data.styles.strokeStyle, !0))
...
((apn.IWidget.exeApplyCSSpost = function (e, t, a, i, n, r, o, s, p) {
  (apn.IWidget.$O6x(t, a, s, p),
    void 0 !== t.angle &&
      apn.IWidget.exeSetAngle(a, t.angle, e.init, e.init.cx || 0, e.init.cy || 0),
  ...
  (apn.IWidget.$O6w = function (e, t, a, i, n, r, o) {
    if ((apn.IWidget.exeSetLine(t, e.lineWidth, e.strokeStyle, n), e.textPadding)) {
    ...
    if (
      ...
      for (
        var p = o.create.data.properties.attrs.apnPadding + '', l = p.split(' '), d = 0;
        d < l.length;
        d++
      )
        l[d] = parseInt(l[d]) || 0;
      if (1 == l.length) {
        ...
        var c = Math.min(i / 2, l[0]),
          g = Math.min(a / 2, l[1]);
        ((t.apnPadding = !0),
          (t.style.padding = Math.floor(c * r) + 'px ' + Math.floor(g * n) + 'px'));
      } else if (3 == l.length) {
        var u = l[0] + l[2] && l[0] + l[2] >= i ? Math.floor(l[0] * (i / (l[0] + l[2]))) : l[0],
          h = l[0] + l[2] && l[0] + l[2] >= i ? Math.floor(l[2] * (i / (l[0] + l[2]))) : l[2],
          g = Math.min(a / 2, l[1]);
        ((t.apnPadding = !0),
          (t.style.padding =
            Math.floor(u * r) + 'px ' + Math.floor(g * n) + 'px ' + Math.floor(h * r) + 'px'));
      } else if (l.length >= 4) {
        var u = l[0] + l[2] && l[0] + l[2] >= i ? Math.floor(l[0] * (i / (l[0] + l[2]))) : l[0],
          h = l[0] + l[2] && l[0] + l[2] >= i ? Math.floor(l[2] * (i / (l[0] + l[2]))) : l[2],
  ...
  (apn.IWidget.$O6x = function (e, t, a, i) {
    if (
      ...
      e.borderRadiusTopLeft
        ...
        : void 0 !== e.borderRadiusTopLeft && t.$CSS('borderTopLeftRadius', '0'),
      e.borderRadiusTopRight
        ? t.$CSS(
            'borderTopRightRadius',
            Math.max(1, Math.round(parseInt(e.borderRadiusTopRight) * a)) + 'px',
          )
        : void 0 !== e.borderRadiusTopRight && t.$CSS('borderTopRightRadius', '0'),
      e.borderRadiusBottomLeft
        ? t.$CSS(
            'borderBottomLeftRadius',
            Math.max(1, Math.round(parseInt(e.borderRadiusBottomLeft) * a)) + 'px',
          )
        : void 0 !== e.borderRadiusBottomLeft && t.$CSS('borderBottomLeftRadius', '0'),
      e.borderRadiusBottomRight
        ? t.$CSS(
            'borderBottomRightRadius',
            Math.max(1, Math.round(parseInt(e.borderRadiusBottomRight) * a)) + 'px',
          )
        : void 0 !== e.borderRadiusBottomRight && t.$CSS('borderBottomRightRadius', '0'),
  ...
  (apn.IWidget.exeRenderTagV1 = function (e, t, a, i, n, r, o) {
    var s = apn.IWidget.getCanvasObjectStyle({}, this, e.project, i.create.data.styles);
    return (
      o && o(s),
  ...
  (apn.IWidget.exeRenderTagV2 = function (e, t, a, i, n, r, o) {
    ...
    return (
      ...
      apn.IWidget.exeSetAngle(a, s.style.angle, i.init, i.init.cx || 0, i.init.cy || 0, void 0, t),
      s.style.text && apn.IWidget.exeApplyText(i, s.style, a, n, r),
      s
    );
  }),
  (apn.IWidget.exeRenderTagVhtml = function (e, t, a, i, n, r) {
    var o = apn.IWidget.getCanvasObjectStyle({}, this, e.project, i.create.data.styles);
    return (
      o.csr && 'inherit' != o.csr && apn.IWidget.exeSetCursor(a, o.csr),
      apn.IWidget.exeSetAngle(a, o.angle, i.init, i.init.cx || 0, i.init.cy || 0, void 0, t),
      o
    );
  }),
  (apn.IWidget.htmlCoord = function (e, t, a, i, n, r, o, s) {
    ...
    if (n)
      return 'x' == i
        ? apn.widgets.utils.$O2x(n, r, e.pages[t].objects[a].init.position.x, o) -
            apn.IWidget.$O2z(2, e, p, o)
        : apn.widgets.utils.$O2y(n, r, e.pages[t].objects[a].init.position.y, s) -
  ...
  (apn.IWidget.htmlW = function (e, t, a, i) {
    var n = (Math.round(t.init.position.x) * i - Math.round(Math.round(t.init.position.x) * i)) / i;
    return Math.max(
      0,
      apn.widgets.utils.$O2v(t.init.shape.w + n, i) + apn.IWidget.$O2z(1, e, t, i),
    );
  }),
  (apn.IWidget.htmlH = function (e, t, a, i) {
    var n = (Math.round(t.init.position.y) * i - Math.round(Math.round(t.init.position.y) * i)) / i;
    return Math.max(
      0,
      apn.widgets.utils.$O2w(t.init.shape.h + n, i) + apn.IWidget.$O2z(1, e, t, i),
    );
  }),
  (apn.IWidget.htmlRender = function (e, t, a, i, n, r, o) {
    ...
    if (
      ...
      u += h && h.useZIndex2 ? 'z-index:' + d.create.zi2 + ';' : 'z-index:' + d.create.zIndex + ';';
      ...
      (0 !== x.alpha && !x.alpha) || 1 == x.alpha || (u += 'opacity:' + x.alpha + ';');
      var v = 0;
      if (
        d.create.data &&
        ...
        for (
          var C = d.create.data.properties.attrs.apnPadding + '', b = C.split(' '), f = 0;
          f < b.length;
          f++
        )
          b[f] = parseInt(b[f]) || 0;
        if (1 == b.length) {
          ...
          u += 'padding:' + Math.floor(_ * p) + 'px ' + Math.floor(m * s) + 'px;';
        } else if (3 == b.length) {
          var I =
        ...
        x.textPadding &&
          ((v = Math.floor(
            Math.min(d.init.shape.h / 2, Math.min(d.init.shape.w / 2, x.textPadding)) * s,
          )),
          (u += 'padding:' + v + 'px;'));
      var w = 0;
      if (x.lineWidth && x.strokeStyle) {
        var E = 'solid';
        (x.lineDash &&
          (E = 2 == x.lineDash.length && x.lineDash[0] == x.lineDash[1] ? 'dotted' : 'dashed'),
          (w = Math.max(1, Math.round(parseInt(x.lineWidth) * s))),
          (u += 'border:' + E + ' ' + w + 'px ' + apn.CES.$O6l(x.strokeStyle) + ';'));
      }
      if (
        (x.fillStyle &&
        ...
        x.font &&
          (u +=
            'font:' +
            (x.fontItalic ? 'italic ' : '') +
            (!x.fontBold || (x.font && !apn.CExe.fontHasBold(x.font)) ? '' : 'bold ') +
      ...
      if (
        (x.textAlign &&
          (o
            ? void 0 === l.textTag && (u += 'text-align:' + (x.textAlign || 'center') + ';')
            : (u += 'text-align:' + x.textAlign + ';')),
        o)
      ) {
        var j = apn.IWidget.exeSetCursor(l, x.csr || 'inherit', !0);
        (j && (u += 'cursor:' + j + ';'), x.fontUnderlined || (l.$ObB = !1), (l.apnLW = w));
      }
    }
  ...
  (apn.IWidget.htmlRenderText = function (e, t, a, i, n, r) {
    ...
    return (
      ...
      n.style.ltrSp &&
        (l += 'letter-spacing:' + (parseFloat(n.style.ltrSp) * s).toFixed(3) + 'px;'),
      (l +=
...
((xa = {}),
  ...
  (xa.exeCreateTag = function (e, t, a, i, n, r) {
    var o;
    return (
      e.o.standAlone && r && (o = apn.CExe.getElementByAttr('div', 'data-apx-id', r))
        ? ((o.apnCur = {}),
        ...
        : ((o = document.body.$TAG('div', {
          ...
          (o.apnCur = {}),
          (o.textTag = null)),
      r && (o.apnCur.textIndent = bx.$checkNaN(parseFloat(t.wgtGetProperty(r, 'txtI')))),
      o
    );
  }),
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    ...
    if (a.apnCur.apxCreatedFromTag && 1 == n && 1 == r) {
      ...
      ((p.css += apn.IWidget.htmlRenderText(this, e.project, t.getPageID(), a.apnOID, p, t)),
        (a.style.cssText =
        ...
        p.style.text
          ...
          : (a.apnCur._apxTextStack = { styles: p.style, data: i, zx: n, zy: r }));
  ...
  (xa.workaroundAndroid7 = function (e, t, a) {
    ...
    if (
      ...
      (apn.Project.resolveStyle(e.project, 'borderRadiusBottomLeft', a.borderRadiusBottomLeft) ||
        apn.Project.resolveStyle(e.project, 'borderRadiusBottomRight', a.borderRadiusBottomRight) ||
        apn.Project.resolveStyle(e.project, 'borderRadiusTopLeft', a.borderRadiusTopLeft) ||
  ...
  (xa.exeOnScreenRefresh = function (e, t, a) {
    ...
    (a && a.font && a.font != e.wgtGetProperty(t, 'apxFont', !0) && (r = !1),
      r &&
        ...
        e.project.property.allowImmediateContentLoad || e.fireEvent('contentChange', 'all', t, !0)),
  ...
  (xa.exeGetSizeByContent = function (e, t, a, i) {
    var n = e.wgtTag(t);
    if ((!a && !i) || !n.textTag)
      return { w: e.screen.objects[t].init.shape.w, h: e.screen.objects[t].init.shape.h };
    var r = n.cloneNode(!0);
    ...
    ((r.style.visibility = 'hidden'),
      ...
      e.project.property.fixMeasureText
        ...
        : ((r.innerHTML = apn.IWidget.exeFormatText(e.wgtGetProperty(t, 'apxText'))),
          i
            ? (r.style.height = 'auto')
    ...
    return (
      ...
      { w: d - e.screen.objects[t].init.shape.w, h: c - e.screen.objects[t].init.shape.h }
    );
  }),
  (xa.exeSetText = function (e, t, a, i, n, r, o, s, p, l) {
    ...
    if (((l = l || e.$Obz), (s = s || e.$ObA), (a = a || e.$O5a), t && !e.textTag)) {
      ...
      if (
        (2 == e.apnCur._apnWgtRectTV
          ? (void 0 === a || 'top' == a || (u += 'display:table;table-layout:fixed;'),
            (u += 'height:100%;'),
            e.$O6m || (u += 'width:100%;'))
    ...
    if (
      (e.textTag &&
        ...
        ((e.textTag.style.overflowWrap = 'normal'), (e.textTag.style.wordWrap = 'keep-all')),
      ...
      e.textTag &&
        (n && r
          ? 'justify' != e.textTag.style.textAlign && (e.textTag.style.whiteSpace = 'pre-wrap')
      ...
      if (2 == e.apnCur._apnWgtRectTV)
        void 0 === a || 'top' == a
          ...
          : ((e.textTag.tv2 =
            ...
            e.textTag.tv2.style.textAlign != i && (e.textTag.tv2.style.textAlign = i),
            e.textTag.tv2.style.verticalAlign != a && (e.textTag.tv2.style.verticalAlign = a),
            'middle' == a &&
              (e.apnPadding || ((e.style.paddingTop = '0'), (e.style.paddingBottom = '0'))));
      else {
        e.textTag.innerHTML = apn.IWidget.exeFormatText(t);
        var x = !1;
        ...
        if (
          ...
          (e.textTag.scrollHeight && e.textTag.scrollHeight > C)
            ? (void 0 === e._apxTextBkPadding && (e._apxTextBkPadding = e.style.padding),
              (e.style.padding =
                Math.max(
                  0,
                  Math.floor(
                    bx.$checkNaN(parseInt(e.style.padding)) -
                      Math.max(e.textTag.scrollWidth - v, e.textTag.scrollHeight - C) / 2,
                  ),
                ) + 'px'))
            : void 0 !== e._apxTextBkPadding && (e.style.padding = e._apxTextBkPadding),
          void 0 !== a)
        ) {
          var b = a;
          n
            ? 'top' == b
              ? ((e.textTag.style.top = '0%'), (e.textTag.style.marginTop = '0px'))
              : 'bottom' == b
                ? ((e.textTag.style.top = '100%'),
                  (e.textTag.style.marginTop = -e.textTag.offsetHeight + 'px'))
                : ((e.textTag.style.top = '50%'),
                  (e.textTag.style.marginTop = -e.textTag.offsetHeight / 2 + 'px'))
            : 'top' == b
        ...
        (void 0 !== i && (n || (e.style.textAlign = i)),
          x && ((e.style.visibility = 'visible'), (e.style.display = f), y.appendChild(e)));
      }
    ...
    if ('vertex' == a || 'vertexInPage' == a) {
      ...
      if (l) {
        ...
        return [
          ...
          { x: apn.CES.$O5M(d, c, l, r + s, o), y: apn.CES.$O5N(d, c, l, r + s, o) },
          { x: apn.CES.$O5M(d, c, l, r + s, o + p), y: apn.CES.$O5N(d, c, l, r + s, o + p) },
          { x: apn.CES.$O5M(d, c, l, r, o + p), y: apn.CES.$O5N(d, c, l, r, o + p) },
          { x: apn.CES.$O5M(d, c, l, r, o), y: apn.CES.$O5N(d, c, l, r, o) },
        ];
      }
      return [
  ...
  (xa.exeCreateTag = function (e, t, a, i, n, r) {
    ...
    return (
      e.o.standAlone && r && (o = apn.CExe.getElementByAttr('div', 'data-apx-id', r))
        ? (o.apnCur = {})
        : ((o = document.body.$TAG('div', { style: 'position:absolute;' })), (o.apnCur = {})),
      (o.textTag = null),
  ...
  (xa.exePropGet = function (e, t, a, i) {
    if ('vertex' == a || 'vertexInPage' == a) {
      ...
      var y = (2 * Math.PI * u + 2 * Math.PI * h + 2 * Math.PI * x + 2 * Math.PI * f) / 4 / 3 + 5;
      return (
          ...
          e > 0 && o < n.length - 1
            ...
            : e < 0 &&
              ...
              Math.round(r) &&
                ...
                (a = !0))),
          a || (i += n[o]));
      ((t.innerHTML = i), 'div' == t.tagName && (t.style.letterSpacing = 'normal'));
    }
  }),
        ...
        if (i && i.length && r) {
          ...
          ((e.style.width = 'auto'),
            ...
            'static' == e.style.position && e._singleTextClientWidthBack
              ...
              : ((c = e.clientWidth),
                'static' != e.style.position && (e._singleTextClientWidthBack = c)));
          var u = !1;
          if (
            ...
            if (
              ...
              (h ? d.genLtrSp(f, e.firstChild) : (e.firstChild.style.letterSpacing = f + 'px'),
              ...
              if (50 == r) {
                ...
                ('left' == e.style.textAlign
                  ? (x = '0 0')
                  : 'right' == e.style.textAlign && (x = '100% 0'),
                  e.firstChild.$CSS({ transformOrigin: x, transform: 'scaleX(' + g / v + ')' }));
              } else
                e.firstChild.$CSS({ transformOrigin: '0 0', transform: 'scaleX(' + g / v + ')' });
            }
            e._txtFitApplied = !0;
          }
          ((e.style.width = s),
            o && ((e.style.visibility = 'visible'), (e.style.display = p), l.appendChild(e)));
        }
      }),
      l
    );
    ...
    if (a.apnCur.apxCreatedFromTag && 1 == n && 1 == r) {
      ...
      (!apn.widgets['apn.wgt.singleText']._apxNoFloatLetterSpacing ||
        ...
        a.parentNode.apxCreateForGroup &&
          ((a.style.left = parseInt(a.style.left) - parseInt(a.parentNode.style.left) + 'px'),
          (a.style.top = parseInt(a.style.top) - parseInt(a.parentNode.style.top) + 'px')));
  ...
  (xa.exeSetText = function (e, t, a, i, n, r, o, s, p, l, d) {
    ...
    ((e.style.lineHeight = parseInt(e.style.height) - 2 * c + 'px'),
      (e.style.textAlign = i),
      d ? (e.style.letterSpacing = d + 'px') : (e.style.letterSpacing = 'normal'),
      (s && p) || l ? (e.style.overflow = 'hidden') : (e.style.overflow = 'visible'),
  ...
  (xa.exeGetSizeByContent = function (e, t, a, i) {
    ...
    return (
      i && (l = Math.ceil((s / parseInt(n.style.height)) * e.screen.objects[t].init.shape.h)),
      a && (p = Math.ceil((o / parseInt(n.style.width)) * e.screen.objects[t].init.shape.w)),
      { w: p - e.screen.objects[t].init.shape.w, h: l - e.screen.objects[t].init.shape.h }
    );
  }),
  ...
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    return (
      ...
      10 == bx.HCL.DV.isIE() &&
        ((a.style.backgroundColor = 'rgba(255,255,255,0)'), (a._apxIE10eventPassProblem = !0)),
      a
    );
  }),
  ...
  (xa.properties = {
    attrs: {
      ...
      dto: '',
      join: '',
      cfg: { sdC: '#000000', sdW: 0, sdOx: 0, sdOy: 0, sdP: '1', idImg: '', cClr: null },
    },
    state: 'r',
  }),
  ...
  (xa.exeCreateTag = function (e, t, a, i, n, r) {
    ...
    if (o && o.attrs && 'Y' == o.attrs.dto) {
      var s = apn.widgets['apn.wgt.rect'].exeCreateTag.call(this, e, t, a, i, n);
      ((s._dataOnly = !0),
  ...
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    function o(e, t, r, o, l, d, g, u) {
      ...
      if (s.polygon) {
        if ((e.clearRect(0, 0, e.canvas.width, e.canvas.height), u && u.fillOnly)) {
          var f = e.fillStyle;
        ...
        if ('apn.CPolycurve' == i.module) apn.widgets.utils.curve(e, s.polygon, h, x);
        else {
          e.beginPath();
    ...
    if (!a._dataOnly) {
      ...
      if (
        ...
        var u = t.wgtTag(d.idImg),
          h = a.ctx.thisX,
          x = a.ctx.thisY;
        (u.parentNode != t.tag && ((h -= t.getTagX(u.parentNode)), (x -= t.getTagY(u.parentNode))),
  ...
  (xa.exeDetect = function (e, t, a, i, n, r) {
    ...
    function s(e, i, n, r, o, s) {
      ...
      if (('apn.CPolycurve' == a.module && (p = t.ctx.curve), t.xx_polygon))
        ...
        t.xx_polygon = [];
        for (var l = 0; l < p.length; l++)
          t.xx_polygon.push({ x: n + Math.round(p[l].x * o), y: r + Math.round(p[l].y * s) });
      }
      ...
      if (p.length >= 3)
        for (
          var d,
            c,
            g = {},
            u = { x: (p[0].x + p[p.length - 1].x) / 2, y: (p[0].y + p[p.length - 1].y) / 2 },
            h = 0;
          h < p.length;
          h++
        ) {
          for (
            ...
            ((c = o(d, u, p[h], g)),
              t.ctx.curve.length
                ? Math.abs(t.ctx.curve[t.ctx.curve.length - 1].x - c.x) * a.init.shape.w +
                    Math.abs(t.ctx.curve[t.ctx.curve.length - 1].y - c.y) * a.init.shape.h >
  ...
  (xa.exeOnLoad = function (e, t) {
    function a(a, r, o) {
      'load' == a &&
        (n = e.wgtTag(t)) &&
        n.ctx &&
        ((n.ctx.img = r), p.exeRenderTag(e.viewer, e, n, i, 1 / e.getZoomX(), 1 / e.getZoomY()));
    }
    ...
    if (((n.ctx = {}), s && s.idImg && (o = e.wgtTag(s.idImg)))) {
      ...
      (l &&
        ...
        this.exeRenderTag(e.viewer, e, n, i, 1 / e.getZoomX(), 1 / e.getZoomY())),
    ...
    if ('vertex' == a || 'vertexInPage' == a) {
      ...
      for (var c = 0; c < o.create.data.styles.polygon.length; c++)
        ((s[c] = {}),
          ...
          p
            ? ((s[c].x = apn.CES.$O5M(l, d, p, n, r)), (s[c].y = apn.CES.$O5N(l, d, p, n, r)))
            : ((s[c].x = n), (s[c].y = r)),
          'vertexInPage' == a && ((s[c].x += o.init.position.x), (s[c].y += o.init.position.y)));
      ...
      if (i && i.length > 1) {
        ...
        if (((l -= s), (d -= p), l && d)) {
          for (
            ...
            o.create.data.styles.polygon.push({ x: (i[c].x - s) / l, y: (i[c].y - p) / d });
          var r = e.wgtTag(t);
  ...
  (xa.calcInitPosition = function (e, t, a) {
    ...
    var d,
      c,
      g = apn.IWidget.getCanvasObjectStyle({}, this, e.viewer.project, n.create.data.styles);
    if ((d = e.wgtGetParent(t.apnOID)) && (c = e.screen.objects[d]) && c.layout && c.layout.states)
    ...
    (a && delete l.getXY,
      ...
      t.parentNode != e.tag && ((p.x += e.getTagX(t.parentNode)), (p.y += e.getTagY(t.parentNode))),
      (t.ctx.thisX = p.x),
      (t.ctx.thisY = p.y),
    ...
    if ('vertex' == a || 'vertexInPage' == a) {
      ...
      for (var g = 0; g < r.ctx.curve.length; g++)
        ((p[g] = {}),
          ...
          l
            ? ((p[g].x = apn.CES.$O5M(d, c, l, o, s)), (p[g].y = apn.CES.$O5N(d, c, l, o, s)))
            : ((p[g].x = o), (p[g].y = s)),
          'vertexInPage' == a && ((p[g].x += n.init.position.x), (p[g].y += n.init.position.y)));
      return p;
    }
  }),
  ...
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    function o(e, t, a, r, o, u, h) {
      ...
      if (s.polygon && t) {
        ...
        if (
          ...
          var m = s.lD2.concat();
          if ('butt' != s.lineEnd) for (var I = 1; I < m.length; I += 2) m[I] += 2;
          for (var I = 0; I < m.length; I++) m[I] = m[I] * Math.max(1, Math.round(s.lineWidth * n));
          e.setLineDash(m);
        }
        ((e.lineJoin = y || 'round'),
          (e.lineWidth = s.lineWidth * n),
          (e.strokeStyle = s.strokeStyle),
          (e.lineCap = s.lineEnd),
          p && d && (l = apn.widgets.utils.drawArrow(e, x(1), f(1), x(0), f(0), s, 0, n)),
          p &&
            g &&
        ...
        (e.stroke(),
          p && d && (l = apn.widgets.utils.drawArrow(e, x(1), f(1), x(0), f(0), s, p, n)),
          p &&
            g &&
            (c = apn.widgets.utils.drawArrow(
              e,
    ...
    if (!a._dataOnly) {
      ...
      s.lineWidth &&
        ...
        s.lE2[0] &&
        ((p = parseInt(s.lE2[0])),
        'S' == s.lE2[1] ? (d = !0) : 'E' == s.lE2[1] ? (g = !0) : ((d = !0), (g = !0)));
      var u;
      (d || g) &&
        (u = {
    ...
    function o(e, i, n, r, o, s) {
      ...
      for (var d, c, l = 0; l < t.xx_polygon.length - 1; l++)
        if (
          ((d = t.xx_polygon[l]),
          (c = t.xx_polygon[l + 1]),
          bx.CCanvasWnd.intersect_circle_line(e, i, Math.round(t._LW / 2), d.x, d.y, c.x, c.y))
        )
          return !0;
      return !1;
    }
  ...
  (xa.exeCreateTag = function (e, t, a, i, n, r) {
    ...
    if (o && ((o.cfg && parseInt(o.cfg.mr) >= 1) || p)) {
      var l = document.body.$TAG('div', { style: 'position:absolute;cursor:inherit;' });
      s
        ? (l.$ObC = l.$TAG('img', {
        ...
        : ((l.$ObC = l.$TAG('div', {
          ...
          (l._tagSvg = l.$ObC.$TAG('img', { style: 'position:absolute;left:0;top:0;', alt: '' })));
    } else var l = $TAG('img', { style: 'position:absolute;cursor:inherit;', alt: '' });
  ...
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    ...
    return (
      p.strokeStyle &&
        p.lineWidth &&
        ((s = {}), (s.strokeStyle = p.strokeStyle), (s.lineWidth = p.lineWidth)),
    ...
    function r() {
      if ((apn.widgets['apn.wgt.image']._resizeImage(apx, t), t.$ObC && p && p.cfg)) {
        ...
        (1 == p.cfg.mr
          ...
          : 2 == p.cfg.mr
            ? (e += 'rotateX(180deg)')
            : 3 == p.cfg.mr && ((a = '50% 50%'), (e += 'rotateX(180deg) rotateY(180deg)')),
  ...
  (xa._resizeImage = function (e, t) {
    if (t._tagSvg) {
      ...
      (parseInt(t.style.width) == a && parseInt(t.style.height) == i) ||
        ...
        t._tagSvg.$CSS(
          'transform',
          'scale(' + parseInt(t.style.width) / a + ',' + parseInt(t.style.height) / i + ')',
        ));
    }
  }),
  ...
  (xa.exeScriptMediaID = !0),
  (xa.editor = { runtimeProperties: { ImageURL: { title: 'Image URL', input: 'http://' } } }),
  (xa.styles = { lineWidth: 0, fillStyle: 'transparent' }),
  ...
  (xa.exeOnLoad = function (e, t) {
    ...
    function i(a, i) {
      if (a == t) {
        ...
        if (i)
          try {
            ((n = JSON.parse(i)), void 0 !== n.x && void 0 !== n.y && (o.$ObD(e, t, n), (s = !0)));
          } catch (e) {}
  ...
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    ...
    if (
      ...
      this.apnWgtImg2DOM2 && e.o.exeDOM2
        ? apn.IWidget.exeRenderTagV2.call(this, e, t, a, i, n, r, s)
        : apn.IWidget.exeRenderTagV1.call(this, e, t, a, i, n, r, o);
    (apn.Project.resolveStyle(e.project, 'borderRadiusTopLeft', p.borderRadiusTopLeft) ||
      apn.Project.resolveStyle(e.project, 'borderRadiusTopRight', p.borderRadiusTopRight) ||
      apn.Project.resolveStyle(e.project, 'borderRadiusBottomLeft', p.borderRadiusBottomLeft) ||
      apn.Project.resolveStyle(e.project, 'borderRadiusBottomRight', p.borderRadiusBottomRight)) &&
      (a.style.overflow = 'hidden');
    var d = i.create.data.properties;
    (apn.Project.isInHTML(t.project, t.getPageID(), a.apnOID) &&
      d &&
      (d.attrs && d.attrs.cfg && void 0 !== d.attrs.cfg.mr && delete d.attrs.cfg.mr,
      ...
      (a.tagOnPostResize = function (e, a) {
        if (
          ...
          a.imageCrop && bx.CImageEditor.applyToDIV(a.uTagHolder || a, a.imageCrop),
  ...
  (xa.exeAssetLoad = function (e, t, a, i) {
    if (this.styleMap.text || this.apnWgtImg2oldLoad || !this.styleMap.dragX) {
      if (i) return ((t.style.backgroundImage = 'none'), void (t.$ObG && (t.$ObG.src = '')));
      ...
      (!a &&
        ...
        a &&
          ...
          t.$ObG || (t.$ObG = t.$TAG('img', { style: 'display:none;', alt: '' })),
      ...
      if (i) return void (o.$ObG && (o.$ObG.parentNode.removeChild(o.$ObG), delete o.$ObG));
      var n = e.screen.objects[t.apnOID].create.data;
      if (
        (a ||
        ...
        (e.tagPassPointerEvent(o.$ObG, !0),
          ...
          n &&
            ...
            n.properties.attrs &&
            n.properties.attrs.cfg &&
            apn.widgets['apn.wgt.image2']._mirrorApply(e, t, n.properties.attrs.cfg.mr));
      }
    }
  }),
  ...
  (xa.exeGetSizeByContent = function (e, t, a, i) {
    ...
    if (!o || !o.width || !o.height)
      return (
        e.log(t, 'Cannot get the size of image because its image file is not loaded yet.'),
        { w: 0, h: 0 }
      );
  ...
  (xa.exeCreateTag = function (e, t, a, i, n, r) {
    var o;
    if (e.o.standAlone && r && (o = apn.CExe.getElementByAttr('img', 'data-apx-id', r)))
  ...
  (xa.exeAssetLoad = function (e, t, a, i) {
    if (t.width && t.height && t.apnCur.apxCreatedFromTag && !t.apnCur.apxAssetLoadTried)
  ...
  (xa.exeOnStart = function (e, t) {
    ...
    a.apnCur.apxAssetLoadTried &&
      ...
      this.exeOnCheckContentLoad &&
        e.fireEvent('contentLoad', 'i', t, !0, e.project.property.allowImmediateContentLoad));
  }),
  ...
  (xa.exeCreateTag = function (e, t, a, i, n, r) {
    if (e.o.standAlone && r && apn.CExe.getElementByAttr('div', 'data-apx-id', r)) {
      ...
      var o = document.body.$TAG('div', { style: 'position:absolute;overflow:hidden;' });
      o.apnCur = {};
    }
    return o;
  }),
  ...
  (xa.exeSetState = function (e, t, a, i, n) {
    a != i && e.fireEvent('stateChange', a, t.apnOID, void 0, void 0, void 0, n);
  }),
  (xa.exeOnLoad = function (e, t) {
    function a(a, i) {
      if (a == t) {
    ...
    (e.wgtListenProperty(t, 'layout', a),
      'dd' == e.wgtGetProperty(t, 'Mode') &&
        (new bx.CGesture(document, i, { noDelayedEvent: !0, noLongholdEvent: !0 }),
        'block' == n.style.display &&
  ...
  (xa.edtOnBuildEvent = function (e, t, a, n) {
    ...
    r &&
      ...
      ((n.wgtEvent = { value: 'wgtEvent', title: apn.P.eventTitle.wgtEvent, param: {} }),
...
((xa.exeOnLoad = function (e, t) {
  ...
  (xa.exeSetState = function (e, t, a, n, r) {
    this.fireApxStep
      ...
      : apn.widgets['apn.wgt.pagedContainer'].fireApxStep.call(this, e, t, a, n);
    var o,
      s,
      p = e.screen.objects[t.apnOID].layout.layers;
    for (i in p)
      if (i != a)
        for (o = e.getWidgetsByProperty('apxMediaControl', p[i].id), s = 0; s < o.length; s++)
  ...
  (xa.exeOnLoad = function (e, t) {
    ...
    function i(a, i) {
      if (a == t) {
        ...
        n.length && (e.stateLayerActivate(t, n[0].id), e.stateSetActive(t, n[0].id));
      }
    }
    function n(a, i) {
      if (a == t) {
        ...
        if (r && r[i]) e.wgtSetProperty(t, 'apxLayer', r[i].id);
          ...
          o &&
            ...
            o[i] && o[i].stateID && e.wgtSetProperty(t, 'apxLayer', o[i].stateID));
        }
      }
    }
    var r = e.wgtTag(t);
      ...
      if (r && r.length) {
        ...
        for (o = 0; o < a.length; o++) {
          ...
          p ||
            e.log(
              t,
              "Invalid layer(pane) title='" + a[o] + "' is referenced from 'activePane' setting.",
            );
        }
      }
    }
      ...
      (d >= 0 &&
        ...
        c &&
          ...
          (e.wgtGetProperty(t.apnOID, '_overflowEF') &&
            ...
            (c.style.left = '0px'),
            g &&
              ((g.style.left = parseInt(c.style.left) - parseInt(g.style.width) + 'px'),
              (g.style.display = 'block')),
            u &&
              ((u.style.left = parseInt(c.style.left) + parseInt(c.style.width) + 'px'),
              (u.style.display = 'block'))),
          t.onBxPageDragEnd ||
            (t.onBxPageDragEnd = function (a) {
              1 == a && t._nxtID
                ? (e.stateLayerActivate(t.apnOID, t._nxtID), e.stateSetActive(t.apnOID, t._nxtID))
                : 2 == a &&
                  t._prvID &&
                  (e.stateLayerActivate(t.apnOID, t._prvID), e.stateSetActive(t.apnOID, t._prvID));
            }),
          bx.PageDrag(
            t,
            c,
            g,
            u,
            apn.P.effectFromTitle[e.wgtGetProperty(t.apnOID, 'Effect')] || 'move',
            'Horizontal' == e.wgtGetProperty(t.apnOID, 'Direction') ? 'x' : 'y',
            { fnCanDrag: r },
          ),
          e.wgtGetProperty(t.apnOID, '_overflowEF') && (t.style.overflow = 'visible')),
        apn.widgets['apn.wgt.pagedContainer'].exeSetState.call(this, e, t, a, i, n));
    }
  }),
  ...
  (xa.exeCreateTag = function (e, t, a, i, n) {
    var r = document.body.$TAG('div', { style: 'position:absolute;overflow:hidden;' });
    return (
      (r.apnCur = {}),
      a.create.data &&
        a.create.data.properties &&
  ...
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    return (apn.widgets['apn.wgt.layerContainer'].exeRenderTag.call(this, e, t, a, i, n, r), a);
  }),
  (xa.exeOnStart = function (e, t) {
  ...
  (xa.exeSetState = function (e, t, a, i, n) {
    if ('refresh' == a) {
      ...
      (e.wgtGetProperty(t.apnOID, '_scrollPaddingR') &&
        ((r = r || {}), (r.paddingRight = e.wgtGetProperty(t.apnOID, '_scrollPaddingR'))),
        e.wgtGetProperty(t.apnOID, '_scrollPaddingB') &&
          ((r = r || {}), (r.paddingBottom = e.wgtGetProperty(t.apnOID, '_scrollPaddingB'))));
  ...
  (xa.exePropSet = function (e, t, a, i, n) {
    if ('layout' == a) {
      ...
      (e.wgtGetProperty(t, '_scrollPaddingR') &&
        ((o = o || {}), (o.paddingRight = e.wgtGetProperty(t, '_scrollPaddingR'))),
        e.wgtGetProperty(t, '_scrollPaddingB') &&
          ((o = o || {}), (o.paddingBottom = e.wgtGetProperty(t, '_scrollPaddingB'))));
  ...
  (xa.exeOnLoad = function (e, t) {
    function a(e, t) {
      (bx.HCL.DV.isIOS() && bx.HCL.DV.hasTouchEvent() && c.$CSS('overflowScrolling', 'auto'),
    ...
    function i(a, i) {
      'auto' == i || 'hidden' == i
        ...
        : 'always' == i
          ...
          : e.log(
              t,
              "Unknown parameter for wgt.run(id,'displayBar" + a + ",...), param='" + i + "'",
            );
    }
    function n(e, a) {
      e == t && i('X', a);
    ...
    function o(a, i) {
      if (a == t && i && i.w && i.h) {
        var n;
        (e.wgtGetProperty(t, '_scrollPaddingR') &&
          ((n = n || {}), (n.paddingRight = e.wgtGetProperty(t, '_scrollPaddingR'))),
          e.wgtGetProperty(t, '_scrollPaddingB') &&
            ((n = n || {}), (n.paddingBottom = e.wgtGetProperty(t, '_scrollPaddingB'))));
        ...
        (apn.IWidget.exeRenderSize(
          ...
          e.wgtSetProperty(t, 'scrollX', Math.round(c.scrollLeft * e.getZoomX()), !0),
          e.wgtSetProperty(t, 'scrollY', Math.round(c.scrollTop * e.getZoomY()), !0));
      }
    }
    function s(e, i) {
      if (e == t) {
        ...
        if ('top' == i || 'bottom' == i) {
          var n = parseInt(c.style.height),
            ...
            o = 0;
          (c.clientHeight && (o = n - c.clientHeight), a('bottom' == i ? -(n - r) + o : 0));
        } else if ('left' == i || 'right' == i) {
          var s = parseInt(c.style.width),
            p = parseInt(c.firstChild.style.width),
            o = 0;
          (c.clientWidth && (o = s - c.clientWidth), 'right' == i ? a(-(s - p) + o, !0) : a(0, !0));
        }
      }
    }
    function p(i, n) {
    ...
    (e.wgtListenProperty(t, 'displayBarX', n), e.wgtListenProperty(t, 'displayBarY', r));
    (e.wgtSetProperty(
      t,
      'scrollArea',
      { w: Math.round(c.scrollWidth * e.getZoomX()), h: Math.round(c.scrollHeight * e.getZoomY()) },
      !0,
    ),
      ...
      'dd' == e.wgtGetProperty(t, 'Mode') &&
        (new bx.CGesture(document, d, { noDelayedEvent: !0, noLongholdEvent: !0 }),
        'block' == c.style.display &&
          apn.widgets['apn.wgt.scrollContainer']._onDdShow(c, 'click')));
  }),
  (xa._onDdShow = function (e, t) {
    ('click' != t && 'tapStart' != t) ||
      ((e.__scrollContainer_showEvent = t), 'tapStart' == t && (e.__scrollContainer_show = !0));
  }),
  (xa.exeOnStart = function (e, t) {
    var a = e.wgtTag(t);
    (e.fireEvent('wgtEvent', 'none' == a.style.display ? 'hd' : 'sh', t),
  ...
  (xa.edtOnBuildEvent = function (e, t, a, i) {
    ((i.wgtEvent = { value: 'wgtEvent', title: apn.P.eventTitle.wgtEvent, param: {} }),
  ...
  (xa.properties = { attrs: { cfg: { bg: { mediaID: void 0, x: 0, y: 0, w: 1e3, h: 1e3 } } } }),
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    if (
      (apn.widgets['apn.wgt.layerContainer'].exeRenderTag.call(this, e, t, a, i, n, r),
      a.apnCur.apxCreatedFromTag && 1 == n && 1 == r)
    );
    else {
      var o = i.create.data;
      o &&
        ...
        ((a.style.backgroundPosition =
          o.properties.attrs.cfg.bg.x * n + 'px ' + o.properties.attrs.cfg.bg.y * r + 'px'),
        (a.style.backgroundImage = 'url(' + t.mediaURL(o.properties.attrs.cfg.bg.mediaID) + ')'),
        (a.style.backgroundRepeat = 'no-repeat'),
        a.$CSS(
          'backgroundSize',
          o.properties.attrs.cfg.bg.w * n + 'px ' + o.properties.attrs.cfg.bg.h * r + 'px',
        ));
    }
    return a;
  }),
  (xa.exeOnPostCreateTag = function (e, t, a) {
    if (e.viewer.constructor.IStub_pubArrangeHTML) {
      ...
      for (var o, s = e.wgtTag(n), r = 0; r < i.length; r++)
        ((o = e.wgtTag(i[r])),
          s.lastElementChild && o.parentNode == s && bx.DOM.putAfter(o, s.lastElementChild));
    }
  }),
  ...
  (xa.exePropGet = function (e, t, a, i) {
    if ('vertex' == a || 'vertexInPage' == a) {
      ...
      var p = n.init.shape.w,
        ...
        d = n.init.cx || 0,
        c = n.init.cy || 0,
        g = n.create.data && n.create.data.styles ? parseFloat(n.create.data.styles.angle) : 0;
      return (
        apn.CES.$O4p(o, s, p, l, g || 0, r, 2 * Math.ceil(Math.max(p, l) / 3), d, c),
        r.push({ x: r[0].x, y: r[0].y }),
        r
      );
    }
  ...
  (xa.exeCreateTag = function (e, t, a, i, n, r) {
        ...
        if (n) {
          ...
          if (('edge' == bx.HCL.DV.getBrowserType() && c(!0), x && t.wgtTag(y.oId))) {
            ...
            s &&
              ...
              (s.style.bottom = 'auto'),
              'right' == v ? (s.style.right = 'auto') : (s.style.marginLeft = 0),
              s.fsBkPrtNode &&
            ...
            (g.mediaTag.mozRequestFullScreen || 'edge' == bx.HCL.DV.getBrowserType()) &&
              'System' != C &&
    ...
    function l(e) {
      ...
      this == a.parentNode &&
        ((a.style.visibility = 'visible'), h && clearTimeout(h), (h = setTimeout(o, f)));
    }
    function d(e) {
            ...
            : t < a
              ? (g.mediaTag.$CSS('transform', 'scale(' + a / t + ',1)'),
                (g.mediaTag.style.left =
                  (parseInt(g.style.width) - t * parseInt(g.style.height)) / 2 + 'px'),
                (g.mediaTag.style.top = '0px'),
              ...
              : t > a &&
                ...
                (g.mediaTag.style.top =
                  (parseInt(g.style.height) - (1 / t) * parseInt(g.style.width)) / 2 + 'px'),
                (g.mediaTag.style.left = '0px'),
                (g.mediaTag.style.height = (1 / t) * parseInt(g.style.width) + 'px'),
                (g.mediaTag.style.width = '100%'));
        }
      } else
        (g.mediaTag.$CSS('transform', 'none'),
    ...
    (g.$CSS({ boxSizing: 'border-box' }),
      (g.apnCur = {}),
      e.o.standAlone && r && apn.CExe.getElementByAttr('video', 'data-apx-id', r)
    ...
    (e.constructor.IStub_getConfiguration &&
      ...
      (v = e.constructor.IStub_getConfiguration(e.project).exeFullscreenControlAlign),
      bx.HCL.DV.isIE()
      ...
      u &&
        ...
        g.mediaTag.setAttribute('poster', t.mediaURL(u.attrs.apxPoster.mediaID)));
    var C = 'System';
    if ((u && u.attrs && u.attrs.Control && (C = u.attrs.Control), 'Simple' == C)) {
      ...
      ((g.simplePlayTag.apxOnEvent = function (e, t) {
        if ('click' == t)
          return ((g.sourceTag.src || (g.sourceTag2 && g.sourceTag2.src)) && b.exeMediaPlay(g), !0);
      }),
  ...
  (xa.exeOnStart = function (e, t) {
    ...
    e.wgtGetProperty(t, 'apxStep') &&
      ...
      (e.wgtSetProperty(t, 'apxStep', { current: 0, count: a.apnPlayList.length }),
      (a._uStepCur = 0));
  }),
          ...
          if (o.subs[s].oId && e.wgtTag(o.subs[s].oId)) {
            ...
            if (((a = e.wgtGetValue(o.subs[s].oId, 'value')), a && a.length))
              for (r = 0; r < a.length; r++)
                bx.HCL.DV.isIE() || 'edge' == bx.HCL.DV.getBrowserType()
                  ? n.addCue(new TextTrackCue(a[r].stime, a[r].etime, a[r].text))
  ...
  (xa.mediaHandler = function (e, t, a) {
    function i() {
      e.exeOnMediaEvent &&
        e.exeOnMediaEvent(
          'trackStart',
          e.apnPlayList && e.apnPlayList.length > 1 ? e.apnPlayList && e.apnPlayList.length : 1,
          e.apnPlayList.apnCurrent + 1,
        );
      var a = h.exeMediaSupportTrack(t.screen, e.apnOID);
      if (
        (a !== !1 &&
          (e.apnTrackPlayIdx || 1 === a || t.fireEvent('media', 'trackStart', e.apnOID),
          t.fireEvent(
            'media',
            'trS_' + (e.apnTrackPlayIdx || e.apnPlayList.apnCurrent + 1),
            e.apnOID,
          )),
        t.wgtGetProperty(e.apnOID, 'apxStep') && e.apnPlayList && e.apnPlayList.length > 1)
      ) {
        var i = (e.apnTrackPlayIdx || e.apnPlayList.apnCurrent + 1) - 1;
        (void 0 !== e._uStepCur && e._uStepCur == i) ||
          (t.wgtSetProperty(e.apnOID, 'apxStep', { current: i, count: e.apnPlayList.length }),
          (e._uStepCur = i));
      }
    }
    function n() {
      if (!e.$ObK || e.mediaTag.$ObJ == e.apnOID) {
        ...
        ((e.apnPlayEnded = !1),
          ...
          e.mediaTag.currentTime < 0.1 &&
            ...
            e.exeOnMediaEvent &&
              (0 == e.apnPlayList.apnCurrent && e.exeOnMediaEvent('listStart'), i()),
    ...
    function r(a) {
      if (!e.$ObK || e.mediaTag.$ObJ == e.apnOID) {
        ...
        if (
          (void 0 !== e._apnPlaySectionStartVol && h.exeMediaControl(e, 'volume', e.__bkVolume),
          1 == e.apnPlayEnded)
        ) {
          ...
          if (i !== !1) {
            var n =
              e.apnTrackPlayIdx ||
              (e.apnPlayList && e.apnPlayList.length > 1 ? e.apnPlayList.apnCurrent + 1 : 1);
            (e.apnTrackPlayIdx || 1 === i || t.fireEvent('media', 'trackEnd', e.apnOID, !0),
    ...
    function o(i) {
      if (!e.$ObK || e.mediaTag.$ObJ == e.apnOID) {
            ...
            !e.apnPlayOnlyThisTrack &&
              ...
              n &&
                ...
                e.apnPlayListMIME[e.apnPlayList.apnCurrent] &&
                  (e.sourceTag.type = e.apnPlayListMIME[e.apnPlayList.apnCurrent]),
                e.sourceTag2 &&
        ...
        (p !== !1 &&
          ...
          (s == r || e.apnTrackPlayIdx) && t.fireEvent('media', 'End', e.apnOID));
      }
    }
    function s(t) {
    ...
    function p(a) {
      if (!e.$ObK || e.mediaTag.$ObJ == e.apnOID) {
        (e.mediaTag.duration &&
          e.exeOnMediaEvent('infoDuration', e.mediaTag.currentTime, e.mediaTag.duration),
        ...
        (!i ||
          ...
          (t.wgtSetProperty(e.apnOID, 'apxStep', { current: 0, count: i }), (e._uStepCur = 0)),
          apn.widgets['apn.wgt.video'].subsInit.call(this, t, e),
          e.isFull && apn.widgets['apn.wgt.video'].subsShow.call(this, t, e, !0),
    ...
    function l() {
      if (
        !(
          (e.$ObK && e.mediaTag.$ObJ != e.apnOID) ||
          (e.$ObN && 0 == e.mediaTag.currentTime && !e.apnPlayEnded && i(), e.mediaTag.paused)
        )
      ) {
        (e.exeOnMediaEvent('infoPlayTime', e.mediaTag.currentTime, e.mediaTag.duration),
          (e.$ObN = e.mediaTag.currentTime),
          t.wgtSetProperty(e.apnOID, 'currentTime', e.mediaTag.currentTime || 0, !0));
        var a;
              ...
              n < a.from || n > a.to
                ...
                : n - a.from < p
                  ...
                  : a.to - n < p
                    ? a.to - n
                    : p),
              void 0 !== s && h.exeMediaControl(e, 'volume', e.__bkVolume * (s / p)));
          }
        ...
        if (l && !(e.apnPlayList && e.apnPlayList.length > 1)) {
          ...
          (void 0 !== e._uStepCur && e._uStepCur == c) ||
            (t.wgtSetProperty(e.apnOID, 'apxStep', { current: c, count: l }), (e._uStepCur = c));
        }
      }
    }
    function d(t) {
    ...
    function c(t) {
      (e.$ObK && e.mediaTag.$ObJ != e.apnOID) ||
        (bx.HCL.DV.isIE() && (e.mediaTag.apxSeeking = !1), e.exeOnMediaEvent('seeked'));
    }
    function g(t) {
    ...
    function u(a) {
      if (!e.$ObK || e.mediaTag.$ObJ == e.apnOID) {
        if (
          (e._delayedSeekTo &&
            (h.exeMediaSeek(e, e._delayedSeekTo.seek, e._delayedSeekTo.play, e._delayedSeekTo.opts),
            delete e._delayedSeekTo),
          e._iePlaybackRate && (e.mediaTag.playbackRate = e._iePlaybackRate),
          e.$ObK)
        )
          for (var i in e.$ObK)
            h.exeMediaInfo(e, i) != e.$ObK[i] && h.exeMediaControl(e, i, e.$ObK[i]);
        e._cLoadFired ||
    ...
    (bx.Event.add(e.mediaTag, 'play', n, !1),
      ...
      (e.mediaTag.apxMediaOnEndException = e.mediaTag.apxMediaOnEndException || []),
      e.mediaTag.apxMediaOnEndException.push(function () {
        o();
      }),
      (e.$O7I = function () {
        for (var t = 0; t < e.mediaTag.apxMediaOnEndException.length; t++)
          e.mediaTag.apxMediaOnEndException[t] && e.mediaTag.apxMediaOnEndException[t]();
      }),
  ...
  (xa.exeOnScreenFull = function (e, t, a) {
    var i = e.wgtTag(t);
    ((i.isFull = a.on), apn.widgets['apn.wgt.video'].subsShow.call(this, e, i, a.on));
  }),
  (xa.exeOnLoad = function (e, t) {
    function a(a, i) {
      a == t &&
        (u.exeMediaControl(h, 'playbackRate', bx.$checkNaN(parseFloat(i)) || 1),
        e.wgtSetProperty(t, 'playbackRate', u.exeMediaInfo(h, 'playbackRate'), !0));
    }
    function i(a, i) {
      a == t &&
        (u.exeMediaControl(h, 'volume', Math.min(1, Math.max(0, bx.$checkNaN(parseFloat(i))))),
          ...
          ? ((h._apnPlaySectionStart = i.from),
            i.fadeInOut
              ? ((h._apnPlaySectionStartVol = 0),
                void 0 === h.__bkVolume && (h.__bkVolume = u.exeMediaInfo(h, 'volume')))
    ...
    function s(a, i) {
      a == t &&
        ('On' == i ? (i = !0) : 'Off' == i && (i = !1), e.wgtSetMediaInfo(t, 'fullScreen', i));
    }
    function p() {
      setTimeout(function () {
        u.$ObQ(e, t, !0);
    ...
    var u = this,
      h = e.wgtTag(t);
    (e.wgtSetProperty(t, 'playbackRate', this.exeMediaInfo(h, 'playbackRate'), !0),
      ...
      e.wgtSetProperty(t, 'supportFullScreen', e.wgtGetMediaInfo(t, 'supportFullScreen')),
      this.$ObP &&
        this.$ObP(e, t) &&
  ...
  (xa.exeOnTick = function (e, t) {
    ...
    if (
      ...
      e.wgtGetProperty(t, 'playSection') || e.wgtGetProperty(t, 'highResolutionPlaytime'))
    ) {
      var i = e.wgtTag(t);
  ...
  (xa.exeOnPause = function (e, t) {
    (e.viewer.ISub_onCloseWidgetMedia && e.viewer.ISub_onCloseWidgetMedia(e, t)) ||
    ...
    if (!i.$ObK || i.mediaTag.$ObJ == i.apnOID) {
      ...
      if (n && 'P' == n.mediaOnHidden);
        ...
        if (
          ...
          e.viewer.constructor.IStub_getConfiguration(e.project).apxBackgroundOnSystemHidden
        )
          return;
      }
      if (((i.__apxLastScreenVisibility = a), 'visible' == a)) {
        ...
        'hidden' == a &&
          (this.exeMediaInfo(i, 'pause') ||
            ('S' == r ? this.exeMediaStop(i) : (i.mediaTag.pause(), (i.$ObR = !0), (i.$ObN = 0))));
    }
  }),
  (xa.exeOnVisibilityChange = function (e, t, a) {
    var i,
  ...
  (xa.exeAssetLoad = function (e, t, a, i) {
    function n(a, i, n) {
      (t.apnPlayList.push(e.mediaURL(a) || a || ''),
        n &&
          ((t.apnPlayListMIME[t.apnPlayList.length - 1] = apn.Project.getMediaMimeType(
            e.project,
            a,
          )),
          i
            ? ((t.apnPlayListSub[t.apnPlayList.length - 1] = e.mediaURL(i) || i),
              (t.apnPlayListSubMIME[t.apnPlayList.length - 1] = apn.Project.getMediaMimeType(
                e.project,
                i,
              )))
    ...
    if (
      ...
      (e.viewer.ISub_getMediaPreload && e.viewer.ISub_getMediaPreload(e, t.apnOID)) ||
        (o && o.mdLD && 'V' == o.mdLD.type && (r = !0)),
      'WebAudioAPI' == t.apxMediaLayer)
    );
    else if (!t.$ObK) {
      var s;
      e.viewer.ISub_getMediaPreload && (s = e.viewer.ISub_getMediaPreload(e, t.apnOID))
        ...
        : o && o.mdLD && ('P' == o.mdLD.type || ('Pi' == o.mdLD.type && bx.HCL.DV.isIOS()))
    ...
    if ((a || (p && p.styles && (a = p.styles.mediaID)), a))
      if (a.main && a.main.length)
        for (var l = 0; l < a.main.length; l++) n(a.main[l], a.sub ? a.sub[l] : void 0, !0);
    ...
    (t._iePlaybackRate && delete t._iePlaybackRate,
      ...
      t.$ObK
        ? (t.mediaTag.paused || this.exeMediaPause(t),
          ...
          t.exeOnMediaEvent && t.exeOnMediaEvent('listSet', t.apnPlayList.length))
        : t.apnPlayList.length &&
          ('WebAudioAPI' == t.apxMediaLayer
            ? (t.mediaTag.setMedia(t.apnPlayList[0]), (t.apnPlayList.apnCurrent = 0))
              ...
              t.mediaTag.load &&
                ...
                !e.wgtIsVisible(t.apnOID)
                  ...
                  : t._apxAutoLoadDelayedByDev ||
                    (t._delayedSeekTo && delete t._delayedSeekTo, t.mediaTag.load()))),
          t.exeOnMediaEvent && t.exeOnMediaEvent('listSet', t.apnPlayList.length)),
      ...
      if ('WebAudioAPI' == e.apxMediaLayer)
        ...
        if (e._apxApCHset || e.mediaTag.$ObJ != e.apnOID) {
          ((e._apxApCHset = !1),
            ...
            (e.mediaTag.apnPlayEnded = !1));
          var r;
          (e.apnPlayList[n] && e.sourceTag.getAttribute('src') == e.apnPlayList[n]
            ? (r = !0)
      ...
      if (
        ...
        (t || e.apnPlayEnded) &&
          ...
          'WebAudioAPI' == e.apxMediaLayer
            ? ((e.apnPlayList.apnCurrent = n), e.mediaTag.setMedia(e.apnPlayList[n]))
            : ((e.sourceTag.src = e.apnPlayList[n] || ''),
              e.apnPlayListMIME[n] && (e.sourceTag.type = e.apnPlayListMIME[n]),
              e.sourceTag2 &&
                (e.apnPlayListSub[n]
        ...
        if (e.mediaTag.paused) e.$O7I && e.$O7I();
          ...
          try {
            if (t) {
              ...
              bx.HCL.DV.isChrome() &&
                (e.apnPlayReqBySeek || (e.mediaTag.apnPlayEnded && (e.mediaTag.currentTime = 0)));
          } catch (t) {
  ...
  (xa.exeMediaPause = function (e) {
    if (!e.$ObK || e.mediaTag.$ObJ == e.apnOID)
      if ('WebAudioAPI' == e.apxMediaLayer) e.mediaTag.pause();
        ...
        try {
          (e.mediaTag.pause(),
            e.mediaTag.paused && e.simplePlayTag && (e.simplePlayTag.style.display = 'block'));
        } catch (e) {}
      }
  }),
  (xa.exeMediaStop = function (e, t, a) {
    if (!e.$ObK || e.mediaTag.$ObJ == e.apnOID)
      if ('WebAudioAPI' == e.apxMediaLayer)
        ((e.apnPlayEnded = !0), (e.mediaTag.apnPlayEnded = !0), e.mediaTag.stop());
      else {
        if (!e.mediaTag.pause) return;
        if (!(e.sourceTag.src || (e.sourceTag2 && e.sourceTag2.src))) return;
        try {
  ...
  (xa.exeMediaSeek = function (e, t, a, i) {
    if ((!e.$ObK || e.mediaTag.$ObJ == e.apnOID) && e.mediaTag)
      if (e._apxAutoLoadDelayedByDev)
        ...
        var n = 0;
        ((n = 'string' == typeof t ? (bx.$checkNaN(parseFloat(t)) / 100) * e.mediaTag.duration : t),
          (n = Math.min(n, e.mediaTag.duration)));
        var r, o;
        if ((i && (i instanceof Object ? ((r = i.rangeCheck), (o = i.seekOnly)) : (r = !0)), r)) {
        ...
        (o
          ? ((bx.HCL.DV.isIE() || 'edge' == bx.HCL.DV.getBrowserType()) &&
            ...
            (e.mediaTag.currentTime = n))
          : (a || e.mediaTag.paused || e.mediaTag.pause(), a && (e.mediaTag.currentTime = n)),
          e.mediaTag.apnOnSeek && e.mediaTag.apnOnSeek(n),
          e.exeOnMediaEvent && e.exeOnMediaEvent('infoPlayTime', n, e.mediaTag.duration),
          o
            ...
            : a &&
              e.mediaTag.paused &&
              (bx.HCL.DV.isChrome() && (e.apnPlayReqBySeek = !0), this.exeMediaPlay(e)));
      }
  }),
  (xa.exeMediaControl = function (e, t, a) {
    if (e.mediaTag) {
      ...
      if ('WebAudioAPI' == e.apxMediaLayer) {
        ...
        if ('playbackRate' == t)
          return ((e.mediaTag.playbackRate = a), bx.HCL.DV.isIE() && (e._iePlaybackRate = a), !0);
      }
    }
    return !1;
  }),
  (xa.exeMediaInfo = function (e, t) {
    if (e.mediaTag) {
      ...
      if ('WebAudioAPI' == e.apxMediaLayer) {
        ...
        if ('seeking' == t)
          return void 0 !== e.mediaTag.apxSeeking ? e.mediaTag.apxSeeking : e.mediaTag.seeking;
        if ('end' == t) return e.mediaTag.apnPlayEnded;
      }
    }
  }),
  ...
  (xa.$ObQ = function (e, t, a) {
    ...
    if (i.mediaTag.videoWidth && (a || !i.mediaTag.paused)) {
      ...
      for (
        var p, l = s.data, d = e.wgtGetProperty(t, 'apxAlpha'), c = 0, g = l.length;
        c < g;
        c += 4
      )
        ((p = 0),
          0 == d[0].cnd
            ...
            : 1 == d[0].cnd && l[c + 0] > bx.$checkNaN(parseInt(d[0].v))
              ...
              : 2 == d[0].cnd && l[c + 0] < bx.$checkNaN(parseInt(d[0].v))
                ? p++
                : 3 == d[0].cnd && l[c + 0] == bx.$checkNaN(parseInt(d[0].v)) && p++,
          0 == d[1].cnd
            ? p++
            : 1 == d[1].cnd && l[c + 1] > bx.$checkNaN(parseInt(d[1].v))
              ...
              : 2 == d[1].cnd && l[c + 1] < bx.$checkNaN(parseInt(d[1].v))
                ? p++
                : 3 == d[1].cnd && l[c + 1] == bx.$checkNaN(parseInt(d[1].v)) && p++,
          0 == d[2].cnd
            ? p++
            : 1 == d[2].cnd && l[c + 2] > bx.$checkNaN(parseInt(d[2].v))
              ...
              : 2 == d[2].cnd && l[c + 2] < bx.$checkNaN(parseInt(d[2].v))
                ? p++
                : 3 == d[2].cnd && l[c + 2] == bx.$checkNaN(parseInt(d[2].v)) && p++,
          3 == p && (l[c + 3] = 0));
  ...
  (xa.edtOnRemapObjectID = function (e, t, a) {
    if (t && t.properties && t.properties.attrs && t.properties.attrs.fs) {
      ...
      if (
        (i.oId &&
          (a[i.oId] ? (i.oId = a[i.oId]) : e.getScreenData().objects[i.oId] || (i.oId = '')),
        i.subs)
      )
        for (var n = 0; n < i.subs.length; n++)
          i.subs[n].oId &&
            (a[i.subs[n].oId]
              ...
              : e.getScreenData().objects[i.subs[n].oId] || (i.subs[n].oId = ''));
    }
  }),
  ...
  (xa.exeOnCheckContentLoad = apn.widgets['apn.wgt.video'].exeOnCheckContentLoad),
  (xa.exeCreateTag = function (e, t, a, i, n, r) {
    var o = $TAG('div', { style: 'position:absolute;' });
    if ((o.$CSS({ boxSizing: 'border-box' }), (o.apnCur = {}), e.IDevice_useWebAudio()))
      ...
      if (
        ...
        apn.CExe.IWidget_getAudioAutoplayCount(e.project) &&
          ...
          s.attrs.cfg &&
          s.attrs.cfg.apxApCH &&
          s.attrs.cfg.apxApCH <= apn.CExe.IWidget_getAudioAutoplayCount(e.project))
      )
        ((o.mediaTag = e.$ObT.$O3d[s.attrs.cfg.apxApCH - 1]),
          ...
          s && s.attrs && 'Yes' == s.attrs.Loop ? (o.$ObK.loop = !0) : (o.$ObK.loop = !1));
      else {
        (e.o.standAlone && r && apn.CExe.getElementByAttr('audio', 'data-apx-id', r)
          ? ((o.mediaTag = apn.CExe.getElementByAttr('audio', 'data-apx-id', r)),
          ...
          s &&
            s.attrs &&
            (s.attrs.apxMediaSubFormat || (s.attrs.sub && s.attrs.sub.mediaID)) &&
            (o.sourceTag2 = o.mediaTag.$TAG('source')));
        var p = 'System';
        (s && s.attrs && s.attrs.Control && (p = s.attrs.Control),
          'System' == p ? (o.mediaTag.controls = !0) : (o.mediaTag.controls = !1),
          o.mediaTag.setAttribute('controlsList', 'nodownload'),
          apn.widgets['apn.wgt.video'].mediaHandler.call(this, o, t, a),
          s && s.attrs && 'Yes' == s.attrs.Loop ? (o.mediaTag.loop = !0) : (o.mediaTag.loop = !1));
      }
    }
    return o;
  }),
  ...
  (xa.mediaHandler_waAPI = function (e, t, a) {
    ...
    function r(i) {
      ...
      (!e.apnPlayOnlyThisTrack &&
        ...
        e.apnPlayList.length > 1 &&
        (a.create.data.styles && a.create.data.styles.mediaLoop
          ? ((e.apnPlayList.apnCurrent = (e.apnPlayList.apnCurrent + 1) % e.apnPlayList.length),
            (n = !0))
          : e.apnPlayList.apnCurrent < e.apnPlayList.length - 1 &&
            (e.apnPlayList.apnCurrent++, (n = !0)),
        n && (e.mediaTag.setMedia(e.apnPlayList[e.apnPlayList.apnCurrent]), e.mediaTag.play())),
        (e.apnPlayOnlyThisTrack = !1),
    ...
    function p() {
      (e.exeOnMediaEvent &&
        ...
        t.wgtSetProperty(e.apnOID, 'duration', e.mediaTag.getInfoDuration() || 0, !0));
    }
    function l() {
      (e.exeOnMediaEvent &&
        e.exeOnMediaEvent(
        ...
        t.wgtSetProperty(e.apnOID, 'currentTime', e.mediaTag.getInfoPlayTime() || 0, !0));
    }
    var d = this;
  ...
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    ...
    var s = apn.IWidget.getCanvasObjectStyle({}, this, e.project, i.create.data.styles),
      p = apn.widgets.utils.$O2x(t, a, i.init.position.x + i.init.shape.x[0], n),
      l = apn.widgets.utils.$O2y(t, a, i.init.position.y + i.init.shape.y[0], r),
      d = apn.widgets.utils.$O2x(t, a, i.init.position.x + i.init.shape.x[1], n),
      c = apn.widgets.utils.$O2y(t, a, i.init.position.y + i.init.shape.y[1], r),
      g = 0;
    s.lineWidth && s.strokeStyle && (g = s.lineWidth * Math.min(n, r));
    var u = 0;
    '1px' == a.style.height && (u = 1);
    var h;
    bx.HCL.DV.isIE() && 'round' == s.lineEnd && g >= 3 && ((h = !0), (a._apxLineHeight = !0));
    ...
    if (
      ...
      var f = 'solid';
      (s.lineDash &&
        (f = 2 == s.lineDash.length && s.lineDash[0] == s.lineDash[1] ? 'dotted' : 'dashed'),
        h
          ? ((a.style.height = (0 == g ? 0 : Math.round(g) || 1) + 'px'),
            (a.style.backgroundColor = s.strokeStyle))
          : (a.style.borderTop =
              f + ' ' + (0 == g ? 0 : Math.round(g) || 1) + 'px ' + s.strokeStyle));
    }
  ...
  (apn.widgets.utils.$O2F = function (e, t, a, i, n, r, o, s, p, l, d, c) {
    ...
    ((t.style.left = n + 'px'),
      (t.style.top = r + 'px'),
      (parseInt(t.width) == o && parseInt(t.height) == s) || ((t.width = o), (t.height = s)),
      (t.style.width = o + 'px'),
      (t.style.height = s + 'px'));
    ...
    (i.fillStyle && (C.fillStyle = i.fillStyle),
      ...
      d &&
        d(C, !(!i.lineWidth || !i.strokeStyle), !!i.fillStyle, (o - y) / 2, (s - v) / 2, y, v, c),
      i.text &&
        bx.CCanvasWnd.drawText(
          ...
          i.text,
          i.textMultiLine,
          Math.round(parseInt(i.fontSize) * l) + 'px' || bx.CEditorWnd.FONT_SIZE_DEF,
  ...
  (apn.widgets.utils.$O2G = function (e, t, a, i, n, r, o) {
    var s = a.init.shape.w,
      p = a.init.shape.h,
      l = bx.$checkNaN(
        parseFloat(apn.Project.resolveStyle(e, 'angle', a.create.data.styles.angle)),
      );
    if (l) {
  ...
  (apn.widgets.utils.$O2C = function (e, t, a, i, n, r, o) {
    ...
    if (p) {
      ...
      var u = parseInt(apn.Project.resolveStyle(t, 'fontSize', s.data.styles.fontSize)) * g;
      ...
      h && h > 0 ? (d.style.textIndent = h + 'em') : (d.style.textIndent = 'initial');
    } else {
      var d = l.singleTxt;
    ...
    (apn.Project.resolveStyle(t, 'ltrSp', s.data.styles.ltrSp)
      ? (d.style.letterSpacing =
          apn.Project.resolveStyle(t, 'ltrSp', s.data.styles.ltrSp) * (1 / e.getZoomY()) + 'px')
    ...
    return (
      ...
      (d.onblur = function (t) {
        ('textarea' == this.tagName.toLowerCase() &&
          ...
          /[ \t]$/.test(this.value) &&
          bx.UX.showToast(apn.CEditorS.GL(apn.CEditorS.TXT_EDT_WARN_IOS_RIGHTSPACE), {
            css: 'bxToastErr',
            time: 3e3,
          }),
          e.$O1i({ text: this.value }, s),
      ...
      (d.onkeypress = d.onkeyup =
        function (n) {
          (d.value
            ? (l.dummy.innerHTML = d.value.replace(/\n$/, '<br>&nbsp;').replace(/\n/g, '<br>'))
            : (l.dummy.innerHTML = '&nbsp;'),
            ...
            p
              ? l.dummy.offsetHeight < l.clientHeight
                ? ((d.style.height = l.clientHeight + 'px'),
                  'middle' == x.textValign
                    ? ((d.style.paddingTop = (l.clientHeight - l.dummy.offsetHeight) / 2 + 'px'),
                      (d.style.paddingBottom = (l.clientHeight - l.dummy.offsetHeight) / 2 + 'px'))
                    : 'bottom' == x.textValign
                      ? (d.style.paddingTop = l.clientHeight - l.dummy.offsetHeight + 'px')
                      : (d.style.paddingBottom = l.clientHeight - l.dummy.offsetHeight + 'px'))
        ...
        : ((l.dummy.style.width = 'auto'),
          l.dummy.offsetHeight < l.clientHeight
            ...
            : ((d.style.height = l.dummy.offsetHeight + 'px'),
              (d.style.paddingTop = '0px'),
              (d.style.paddingBottom = '0px')),
          a.edtOnChangeSingleTextEditor && a.edtOnChangeSingleTextEditor(e, t, i, d, l.dummy)),
      !1
    );
  }),
  (apn.widgets.utils.$O2x = function (e, t, a, i) {
    ...
    if (t.parentNode.apnOID && t.parentNode.apnPID) {
      ...
      return (
        'apn.CLayer' == e.screen.objects[n].module && (n = t.parentNode.parentNode.apnOID),
  ...
  (apn.widgets.utils.$O7H = function (e) {
    try {
      for (
        var t = atob(e.split(',')[1]), a = new ArrayBuffer(t.length), i = new Uint8Array(a), n = 0;
        n < t.length;
        n++
      )
        i[n] = t.charCodeAt(n);
    ...
    if (r) var s = parseInt(r) || 0;
      ...
      var s =
        apn.dbUI && apn.dbUI.system && apn.dbUI.system.exePatchOverlap
          ...
          : 0;
    e.$ObU = e.$ObU || e.$TAG('div', { style: o + 'left:0px;top:0px;width:100%;height:100%' });
    var p = e.$ObU;
    if (
      ...
      p.tagC
        ? (p.tagC.style.height =
            2 * s + parseFloat(e.style.height) - (a.naturalHeight + n.naturalHeight) * l + 'px')
        : ((p.tagC = p.tagC || p.$TAG('div')),
          p.tagC.$A({
            style:
              ...
              (a.naturalHeight * l - s) +
              'px;height:' +
              (2 * s + parseFloat(e.style.height) - (a.naturalHeight + n.naturalHeight) * l) +
      ...
      p.tagC
        ? (p.tagC.style.width =
            2 * s + parseFloat(e.style.width) - (a.naturalWidth + n.naturalWidth) * l + 'px')
        : ((p.tagC = p.tagC || p.$TAG('div')),
          p.tagC.$A({
            style:
              o +
              ...
              (a.naturalWidth * l - s) +
              'px;width:' +
              (2 * s + parseFloat(e.style.width) - (a.naturalWidth + n.naturalWidth) * l) +
  ...
  (apn.widgets.utils.patch9 = function (e, t, a, i, n, r, o, s, p, l, d, c, g, u) {
    ...
    ((t = t || 1),
      (a = a || 1),
      (e.$ObZ = e.$ObZ || e.$TAG('div', { style: h + 'left:0px;top:0px;width:100%;height:100%' })));
    var f = e.$ObZ;
    if (
      ...
      ((f.tagT = f.tagT || f.$TAG('canvas')),
        f.tagT.$A({
          ...
          width: 2 * x + parseFloat(e.style.width) - (i.naturalWidth + l.naturalWidth) * t,
      ...
      ((f.tagT = f.tagT || f.$TAG('div')),
        f.tagT.$A({
          style:
            ...
            (i.naturalWidth * t - x) +
            'px;top:0px;width:' +
            (2 * x + parseFloat(e.style.width) - (i.naturalWidth + l.naturalWidth) * t) +
            'px;height:' +
            d.naturalHeight * a +
            'px;background:url(' +
            d.getAttribute('src') +
      ...
      ((f.tagB = f.tagB || f.$TAG('div')),
        f.tagB.$A({
          style:
            ...
            (r.naturalWidth * t - x) +
            'px;bottom:0px;width:' +
            (2 * x + parseFloat(e.style.width) - (r.naturalWidth + s.naturalWidth) * t) +
            'px;height:' +
            o.naturalHeight * a +
            'px;background:url(' +
            o.getAttribute('src') +
    ...
    if (bx.HCL.DV.isChrome() && g) {
      ((f.tagL = f.tagL || f.$TAG('canvas')),
        f.tagL.$A({
          ...
          height: 2 * x + parseFloat(e.style.height) - (i.naturalHeight + r.naturalHeight) * a,
      ...
      ((f.tagL = f.tagL || f.$TAG('div')),
        f.tagL.$A({
          style:
            ...
            (i.naturalHeight * a - x) +
            'px;left:0px;height:' +
            (2 * x + parseFloat(e.style.height) - (i.naturalHeight + r.naturalHeight) * a) +
            'px;width:' +
            n.naturalWidth * t +
            'px;background:url(' +
            n.getAttribute('src') +
      ...
      ((f.tagR = f.tagR || f.$TAG('div')),
        f.tagR.$A({
          style:
            ...
            (l.naturalHeight * a - x) +
            'px;right:0px;height:' +
            (2 * x + parseFloat(e.style.height) - (l.naturalHeight + s.naturalHeight) * a) +
            'px;width:' +
            p.naturalWidth * t +
            'px;background:url(' +
            p.getAttribute('src') +
  ...
  (apn.widgets.utils.interpolatePath = function (e, t) {
    ...
    if (void 0 === e._distAll) {
      ...
      ((e.pt1 = { x: e.path[0].x, y: e.path[0].y }), (e.pt2 = { x: e.path[0].x, y: e.path[0].y }));
    }
  ...
  (apn.widgets.utils.interpolatePathGetRatio = function (e, t) {
    ...
    if (e.length > 1)
      for (var n = 0; n < e.length - 1; n++)
        (0 === e[n].lw ||
          (a += Math.sqrt(Math.pow(e[n + 1].x - e[n].x, 2) + Math.pow(e[n + 1].y - e[n].y, 2))),
          t - 1 == n && (i = a));
    return a ? i / a : 0;
  }),
...
((xa = {}),
  ...
  (xa.editor = { placeHolder: 'Double click to edit' }),
  (xa.properties = { attrs: { v: 2, plainText: '', text: '', exeText: '', mediaID: [] } }),
    ...
    if (o && (o.text || o.exeText)) {
      ...
      if (s.length)
        for (var p = 0; p < s.length; p++)
          s[p].dataset && s[p].dataset.id && (s[p].src = t.mediaURL(s[p].dataset.id));
    }
    if (1 != i || 1 != n) {
  ...
  (xa.edtOnRemoveResource = function (e, t, a) {
    ...
    if (o && o.text) {
      ...
      for (var s = 0; s < n.length; s++) n[s].parentElement && n[s].parentElement.removeChild(n[s]);
      ((o.text = i.innerHTML), (o.mediaID = []), (n = i.querySelectorAll('img[data-id]') || []));
      for (var s = 0; s < n.length; s++)
        o.mediaID.indexOf(n[s].dataset.id) == -1 && o.mediaID.push(n[s].dataset.id);
      (e.$Oc6(o, r), r.refresh());
    }
  }),
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    function o(e, t) {
      if (
        ...
        var a = parseInt(t.fontSize) * (0.1 + Math.abs(0.02 * parseInt(t.letterSpacing)));
    ...
    if (!a.firstElementChild && (s.text || s.exeText))
      return void bx.Trace.log('RTXT', 'warning', 'cannot render rxtx. wrapper tag empty');
    var p = apn.IWidget.getCanvasObjectStyle({}, this, e.project, i.create.data.styles);
    (apn.IWidget.exeApplyCSSpre(
      i,
      p,
      a,
  ...
  (xa.onEdit = function (e, t, a, i) {
    var n = e.getObjectByID(t),
      r = e.getRichEditTAG(),
      o = apn.IWidget.getCanvasObjectStyle({}, this, e.getData(), n.data.styles);
  ...
  (xa.$Oc8 = function (e, t, a, i) {
    ...
    ((i.style.transform = 'translate(' + o + 'px,' + s + 'px) scale(' + p + ',' + p + ')'),
      t.getAngle && t.getAngle() && (i.style.transform += 'rotate(' + t.getAngle() + 'rad)'),
  ...
  (xa.pubOnGetFontList = function (e, t, a, i) {
    ...
    if (
      ...
      ((n = document.createElement('div')),
        (n.innerHTML = this._convertXhtmlRule(r.create.data.properties.attrs.exeText)));
      var o,
        s,
        p,
        l = '',
        d = [],
        c = document.createNodeIterator(n.firstElementChild, NodeFilter.SHOW_ELEMENT, null, !1);
      for (
        r.create.data.styles && r.create.data.styles.font
          ? i
            ? ((l = {
              ...
              d.push(l))
            : 'inherit' !== r.create.data.styles.font && d.push(r.create.data.styles.font)
          : i && ((l = { font: apn.Project.resolveStyle(e, 'font'), str: '' }), d.push(l));
        (p = c.nextNode());
      )
        if (p.style && p.style.fontFamily && 'inherit' !== p.style.fontFamily) {
          ...
          s
            ...
            : d.push(i ? { font: p.style.fontFamily, str: p.textContent } : p.style.fontFamily);
        } else i && l && 'SPAN' == p.tagName && p.textContent && (l.str += p.textContent);
      for (c.detach(), o = 0; o < d.length; o++)
        d[o] && (i ? (d[o].font = d[o].font.replace(/\"/g, '')) : (d[o] = d[o].replace(/\"/g, '')));
      return d;
    }
    return [];
  }),
...
((xa = {}),
  ...
  (xa.editor = { placeHolder: 'Double click to edit' }),
  (xa.properties = { attrs: { exeText: '', prvText: '', text: '', plainText: '' } }),
  (xa.createAsCanvasObject = function (e, t, a, i, n) {
    return apn.IWidget.createCanvasObject(
      e,
      this,
  ...
  (xa.exeCreateTag = function (e, t, a, i, n, r) {
    ...
    if (e.o.standAlone && r && apn.CExe.getElementByAttr('div', 'data-apx-id', r))
      ...
      ((o = document.body.$TAG('div', { style: 'position:absolute;overflow:hidden;' })),
        (o.apnCur = {}),
        (o.apnCur.apxCreatedFromTag = !1));
      var s = (a.create.data.properties && a.create.data.properties.attrs) || {};
      ((o.innerHTML = (e.o.standAlone ? this._convertXhtmlRule(s.exeText) : s.prvText) || ''),
  ...
  (xa.exeRenderTag = function (e, t, a, i, n, r) {
    ...
    if (!a.firstElementChild && (s.text || s.exeText))
      return void bx.Trace.log('RTXT', 'warning', 'cannot render rxtx. wrapper tag empty');
    if (
      !(e.o.standAlone && a.apnOID && apn.CExe.getElementByAttr('div', 'data-apx-id', a.apnOID))
    ) {
      var p = apn.IWidget.getCanvasObjectStyle({}, this, e.project, i.create.data.styles);
      (apn.IWidget.exeApplyCSSpre(
        i,
      ...
      for (
        r.create.data.styles && r.create.data.styles.font
          ? i
            ...
            : 'inherit' !== r.create.data.styles.font && d.push(r.create.data.styles.font)
          : i
            ? ((l = { font: apn.Project.resolveStyle(e, 'font'), str: '' }), d.push(l))
  ...
  (xa.pubOnGetHTML = function (e, t, a, i) {
    ...
    (r.style.textAlign && (r.css += 'text-align:' + r.style.textAlign + ';'),
      r.style.ltrSp && (r.css += 'letter-spacing:' + parseFloat(r.style.ltrSp).toFixed(3) + 'px;'),
      isNaN(r.style.lnSp) || (r.css += 'line-height:' + n(r.style).toFixed(1) + 'px;'),
      (o += ' style="' + r.css + '"'),
      (o += ' class="apxWgt1"'),
  ...
  (apn.CExe = function (e, t, a, i) {
    bx.inClassing ||
      ...
      apn.dbUI && apn.dbUI.system && apn.dbUI.system.exeDOM2 && (this.o.exeDOM2 = !0),
      ...
      apn.CExe.$O2K++,
      (a = a || {}),
      (a.type = a.type ? a.type | bx.CWnd.TYPE_NO_VIEWPORT : bx.CWnd.TYPE_NO_VIEWPORT),
  ...
  (apn.CExe.sceneEditableStyles = { visibility: !0, alpha: !0, angle: !0, polygon: !0 }),
  ...
  (bx.HCL.getElementX2 = function (e, t) {
    var a = 0;
    for (void 0 === this.$Ocb && (this.$Ocb = bx.HCL.DV.isIE()); e && e != document; )
  ...
  (apn.CExe.getElementByAttr = function (e, t, a) {
    ...
    for (var i = document.getElementsByTagName(e || '*'), n = 0; n < i.length; n++)
  ...
  (apn.CExe.getScript2List = function (e) {
    ...
    if (p) {
      ...
      for (var a = 0; a < l.length; a++)
        ((d = l[a].fId),
          p[d] && p[d].spt2impt && p[d].spt2impt.js && p[d].js && t(p[d].spt2impt.js, p[d].js));
    }
    for (var c in e.pages)
  ...
  (apn.CExe.prototype.init = function (e) {
    function t(e) {
      function t(t) {
        t.canvas && t.canvas.$O3X('exeOnScreenRefresh', t.id, { font: e.data.data });
      }
      ...
      if (e.data && e.data.CExe) {
        ...
        'onVisibilityChange' == t.type &&
          ...
          'visible' == s._iframeVisibilityState
            ...
            : 'hidden' == s._iframeVisibilityState && bx.Transition.pauseTimer());
      }
    }
    function i() {
      function e(e) {
    ...
    function n(e) {
      if (
        ...
        var t = apn.Project.getWidgetModule(
          s.project.pages[s.getCurrentPageID()].objects[e.data.apxID].create.data,
        );
    ...
    function r(e) {
      (e.ctrlKey &&
        ...
        ((e.keyCode >= 112 && e.keyCode <= 121) || 123 == e.keyCode) && bx.Event.preventDefault(e));
    }
    function o(e, t) {
    ...
    (this.updateStart(),
      ...
      this.$O2J.init(!0),
      (apn.CExeBookEPUB3 && this.constructor == apn.CExeBookEPUB3) ||
        (this.$Occ.tag.style.backgroundColor = apn.CES.$O6l(this.o.backgroundColor)),
      this.o.exePreview || (window.parent != window && bx.Event.add(window, 'message', a, !1)),
      ...
      bx.$getParamFromURL(location.href, 'APXABRDPXY') &&
        ...
        (bx.Event.add(window, 'keydown', r, !0), bx.Event.setupMouseWheel(window, o, 30)),
      this.updateEnd(),
      this.o.exePreview &&
  ...
  (apn.CExe.prototype.onResize = function (e, t, a, i) {
    if (this.isPreview2()) {
      ...
      return (
        this.hasSkin() ? this._skinShow && this._skinShow() : this.$O51 && this.$O51(),
        this.project &&
          2 != this.$O3W &&
          !i &&
          this.project &&
  ...
  (apn.CExe.prototype.onStyleScrollBar = function (e, t, a, i, n) {
    if (!bx.HCL.DV.isIOS() && !bx.HCL.DV.isAndroid())
      if (
        ...
        var o;
        (bx.HCL.getCssRule('.apnCExeScroll') || bx.HCL.addCssRule('.apnCExeScroll', ' '),
          ...
          (o = bx.HCL.getCssRule('.apnCExeScroll::-webkit-scrollbar-track:vertical'))
            ? (o.style.cssText =
                'border-radius:' +
                r +
          ...
          (o = bx.HCL.getCssRule('.apnCExeScroll::-webkit-scrollbar-track:horizontal'))
            ? (o.style.cssText =
                'border-radius:' +
                r +
                'px;background-clip:content-box;background-color:' +
          ...
          (o = bx.HCL.getCssRule('.apnCExeScroll::-webkit-scrollbar-thumb'))
            ? ((o.style.cssText =
                ...
                3 * bx.CCanvasWnd.ZINDEX_OBJECT +
                ';'),
              (o = bx.HCL.getCssRule('.apnCExeScroll::-webkit-scrollbar-thumb:hover')) &&
                (e == t
                  ? (o.style.cssText =
                      'border-radius:' +
                      r +
  ...
  (apn.CExe.prototype.IWidget_onFullScreen = function (e, t) {
    ...
    if (!this.o.exePreview) {
      ...
      ((window.opener || (window.parent && parent != window)) &&
        ...
        i &&
          i.postMessage(
            { CExe: { type: 'onFullscreenChangeByMedia', data: { fullscreen: e } } },
            '*',
          ));
    }
  }),
  ...
  (apn.CExe.IWidget_getAudioAutoplayCount = function (e) {
    ...
    return (
      t.CExe && t.CExe.apCH && t.CExe.apCH.acnt && t.CExe.apCH.acnt > a && (a = t.CExe.apCH.acnt),
      a
    );
  }),
  (apn.CExe.prototype.IStub_sptInfo = function (e) {
    ...
    for (var a in this._sptGetInfo)
      this._sptGetInfo[a].help && (t.fns[a] = bx.$cloneObject({}, this._sptGetInfo[a].help));
    return t;
  }),
  (apn.CExe.prototype.IStub_sptRunCheck = function (e, t, a) {
    if (
      ...
      if ((a && this.$O2J.get(a) && this.$O2J.get(a).canvas && (i = this.$O2J.get(a).canvas), i))
    ...
    if (
      ...
      if ('currentFrame' == t) window.location.href = e;
        ...
        1 == i
          ? flx.sys.openURL(e)
          : 2 == i
            ? a({ abr: { type: 'device', data: { type: 'runURL', param: { url: e } } } })
  ...
  (apn.CExe.prototype.IStub_runScreen = function (e) {
    this.isPreview2() ? this.sbxIF('loadPage', { pId: e }) : this.run(void 0, e);
  }),
  (apn.CExe.prototype.IStub_fullScreen = function (e) {
    bx.DOM.isVisible(this.tag) &&
      this.project &&
      (this.isRunning() || this.isPreview2()) &&
      ((this.$O7J = e), this.isPreview2() && (this._resizeByPrvFullScreen = e), this.restore());
  }),
      ...
      for (s in t.pages[c].objects) {
        ...
        if (p && p.pubOnGetFonts)
          for (l = p.pubOnGetFonts(t, c, s, e), i = 0; i < l.length; i++)
            d[l[i].face] || ((n.fonts = n.fonts || []), n.fonts.push(l[i]), (d[l[i].face] = !0));
      }
    return n;
  }),
  ...
  (apn.CExe.prototype.preloadLoadAssets = function (e) {
    if (!this.$Ocg) {
      if (((this.$Ocf = e), e.url)) {
        ...
        ((this.$Ocg.src = e.url),
          'rotate' == e.css &&
            this.$Ocg.$CSS('animation', 'apxSpnRotate 1.2s infinite linear both'));
      } else
        e.css &&
          ((e.w = e.h =
            Math.ceil(0.15 * Math.min(this.getProjectSize().w, this.getProjectSize().h))),
          (this.$Ocg = this.tag.$TAG('div', { style: 'display:none;position:absolute;left:50%;' })),
  ...
  (apn.CExe.prototype.preloadImageReset = function () {
    ...
    if ((e = this.$Ocg)) {
      this.hasSkin()
        ? (e.style.top = this.$O2N.y + (this.$O2N.h / 2) * this.getStretchY() + 'px')
        : (e.style.top = '50%');
      var t = Math.ceil(
          this.$Ocf.w * (1 / this.$O2O) * Math.min(this.getStretchX(), this.getStretchY()),
        ),
        a = Math.ceil(
          this.$Ocf.h * (1 / this.$O2P) * Math.min(this.getStretchX(), this.getStretchY()),
        );
      ((e.style.width = t + 'px'),
        (e.style.height = a + 'px'),
  ...
  (apn.CExe.prototype.pause = function (e) {
    function t(t) {
      t.canvas &&
        (e
          ? (t.canvas.$O3X('exeOnPause', t.id), (t.canvas.$O7K = !0), t.canvas.$O3M())
  ...
  (apn.CExe.prototype.clear = function () {
    ...
    (this.$O51 && this.$O51(),
      this.$Ocg && (this.$Ocg.parentNode.removeChild(this.$Ocg), delete this.$Ocg),
      (this.$Oci = void 0),
      (this._hasAnyScript = void 0),
      (this._sptVer = void 0),
      (this._fontLoadEvtFired = !1),
      (this._fontLoadTimeoutFired = !1),
      this.isPreview2() || (this.stretch(1, 1, { noNotify: !0, cleanup: !0 }), this.$O2J.reset()),
      delete this.project,
      delete this.flow,
  ...
  (apn.CExe.prototype.load = function (e, t, a) {
      ...
      if (
        ...
        ((a.onload = function () {
          ...
          (1 != l.getStretchX() && (a = l.getStretchX()),
            ...
            t.$CSS('backgroundSize', a * this.width + 'px ' + n * this.height + 'px'));
        }),
          (a.src = i(e.style.bgImg.mediaID)));
      } else if (e.style && 'tileOrg' == e.style.bgImgPtn && e.style.bgImg && e.style.bgImg.mediaID)
        ((t.style.backgroundImage = 'url(' + i(e.style.bgImg.mediaID) + ')'),
          (t.style.backgroundRepeat = 'repeat'));
    ...
    function r(e) {
      function t(t) {
        for (var a = 0; a < t.length; a++)
          if (t[a] && t[a].accept)
            for (var i = 0; i < t[a].accept.length; i++) if (t[a].accept[i] == e) return !0;
      }
    ...
    if (
      (this._loadSession++,
      t ? (bx.CCanvasWnd.maxFontWaitTime = 1500) : (bx.CCanvasWnd.maxFontWaitTime = 3e4),
      this.clear(),
      ...
      apn.Project._sptSearchScript(e, apn.P.eventTitle.contentChange)
        ...
        : r(apn.P.eventTitle.contentChange) && (this._sptContentChangeUsed = !0),
    ...
    for (var d in this.flow.pages)
      this.project.pages[d] ||
        (bx.Trace.err('APN', 'Unknown page is in flow: pageID=' + d, 'CExe.load'),
    ...
    (c &&
      (c.screenBackgroundColor &&
        (this.hasSkin()
          ? ((this.tag.style.backgroundColor = 'transparent'),
            (this.$Occ.tag.style.backgroundColor = apn.CES.$O6l(this.o.backgroundColor)))
          : ((this.tag.style.backgroundColor = apn.CES.$O6l(c.screenBackgroundColor)),
            (this.$Occ.tag.style.backgroundColor = apn.CES.$O6l(c.screenBackgroundColor))),
      ...
      c.screenNoResize && (this.o.exePreview ? (this.o.noResize = !1) : (this.o.noResize = !0)),
    ...
    if (
      ...
      this.o.exePreview ||
        (g && g.brTm && g.brTm.frameClr && bx.$setMeta('theme-color', g.brTm.frameClr)),
    ...
    if (
      ...
      g && g.loading && 'S' == g.loading.type
        ? this.preloadLoadAssets({ css: g.loading.spinner.type, color: g.loading.spinner.fillClr })
        : g && g.loading && 'I' == g.loading.type && g.loading.img && g.loading.img.mediaID
          ? this.preloadLoadAssets({ css: g.loading.img.type, url: i(g.loading.img.mediaID) })
      ...
      this._layoutPaddingApplied &&
        ((g && g.layout && g.layout.padding && g.layout.padding.ofl) ||
          ((this.$Occ.tag.style.overflow = 'visible'), (this.$O2J.tag.style.overflow = 'visible')),
        ...
        this.project.property.fontLoadTimeout &&
          setTimeout(function () {
            if (!l._fontLoadEvtFired) {
              ...
              for (var t = 0; t < e.length; t++)
                e[t].canvas && e[t].canvas.fireEvent('spt_fontLoad', 'Timeout', void 0, !0);
              ...
              for (var a = 0; a < e.fontfaces.length; a++) {
                ...
                if (1 == l._loadedFontList[i]) {
                  for (var n = 0; n < t.length; n++)
                    t[n].canvas &&
                      t[n].canvas.$O3X('exeOnScreenRefresh', t[n].canvas.id, { font: i });
                  l._loadedFontList[i] = 2;
                }
              }
              for (var n = 0; n < t.length; n++)
                t[n].canvas && t[n].canvas.fireEvent('spt_fontLoad', 'End', void 0, !0);
    ...
    if (
      (apn.Project.resolveProperty(this.project, 'exeNetworkMode') &&
        ...
        (this.remoteConnect(window.apxNetConnection, o) ||
          bx.Trace.log('APN', 'warning', 'Cannot connect to data switching server', 'CExe.load')),
      !this.o.exePreview &&
        document.getElementsByTagName('TITLE').length &&
        this.project.property.title)
    )
      try {
        document.getElementsByTagName('TITLE')[0].innerHTML = this.project.property.title;
      } catch (e) {}
    ...
    if (y.length)
      for (var d = 0; d < y.length; d++) {
        ...
        if (
          ...
          v.execRun({ data: { noNotifyToEditor: !0, fileDomainEventReceive: !0 } }),
          this.project.pages[y[d]].UI.apnCExe && 'B' == this.project.pages[y[d]].UI.apnCExe.layer)
        ) {
  ...
  (apn.CExe.prototype.getScreenSize = function (e, t, a, i, n, r) {
    ...
    if (p && ('H' == s.layout.layout || s.layout.layout.indexOf('yh') != -1))
      return (
        ...
        s.layout.layout.indexOf('$FIX') != -1 && ((o.x = 0), (o.y = 0), (o.noClip = !0)),
        o
      );
    ...
    if (n)
      ((o.zoomX = 1),
        ...
        this.o.noLayout
          ? ((o.x = 0), (o.y = 0))
          : ((o.x = Math.round((e - o.w) / 2)), (o.y = Math.round((t - o.h) / 2))));
    else {
      var l,
        d,
        c = e / a;
  ...
  (apn.CExe.prototype.resize = function () {
    ...
    if (
      ...
      this.$O3T && this.$O3T.setPosition(new bx.CPosition(bx.$cloneObject({}, g))),
      !this.isPreview2())
    )
    ...
    if (
      ...
      (this.selectMargin = Math.ceil(0.01 * Math.min(this.$O2N.w, this.$O2N.h))),
      e && this.$O50 ? this.$O50(t.skinID, apn.dbSkin[t.skinID]) : this.$O51 && this.$O51(),
      this.$Ocf && this.preloadImageReset(),
      !this.isPreview2() && this.o.screenStretch)
    ) {
      if (this.isNeedChromeScaleFix())
        var x = { w: this.getProjectSize().w / this.$O2O, h: this.getProjectSize().h / this.$O2P };
  ...
  (apn.CExe.prototype.stretch = function (e, t, a) {
    ...
    (bx.HCL.DV.supportCSS3D() &&
      ...
      (a && a.noNotify) ||
        (this.IDriver_onZoomChange && this.IDriver_onZoomChange(e, t, !(!a || !a.inDrag))));
  }),
  ...
  (apn.CExe.prototype._applyExeProp = function (e) {
    ...
    this.constructor.IStub_getConfiguration &&
      ...
      t.CExe &&
      ((a.CExe = a.CExe || {}), t.CExe.layout && !a.CExe.layout && (a.CExe.layout = t.CExe.layout));
  }),
  (apn.CExe.prototype.getFonts = function (e) {
    ...
    var a,
      i = apn.Project.publishListFontFile(this.project, !0, void 0, this.o.standAlone),
    ...
    if (
      (bx.$getParamFromURL(location.href, 'APXFONTPATH') &&
        ((p = bx.$getParamFromURL(location.href, 'APXFONTPATH')), p && (p = decodeURIComponent(p))),
      !p && this.o.pathFont && (p = this.o.pathFont),
      p)
    )
      for (var l, s = 0; s < i.length; s++) {
        if (this.o.standAlone) {
          if (apn.dbUI && apn.dbUI.system && apn.dbUI.system.pubFontCompress && i[s].compress)
            continue;
          if ('zzpdf' == i[s].ln) continue;
        }
        ('file' != i[s].type && 'google' != i[s].type && 'dir' != i[s].type) ||
          ((l = (i[s].path || '').split('/')),
          (l[l.length - 1].indexOf('.css') == -1 && l[l.length - 1].indexOf('.ttf') == -1) ||
    ...
    if (e)
      for (
        var c,
          g = apn.Project.publishListFontFile(this.project, void 0, void 0, this.o.standAlone, e),
          s = 0;
        s < i.length;
        s++
      ) {
  ...
  (apn.CExe.prototype.$O4Z = function (e, t, a, i) {
    ...
    function r(t, a, i) {
      ...
      (s++,
        (p._loadedFontList && 2 == p._loadedFontList[a]) || (p.$O2J && p.$O2J.iteratePage(r)),
        s == o.length &&
          (p._supportFontLoad || (p.$O2J && p.$O2J.iteratePage(n)),
          (p._fontLoadEvtFired = !0),
          e && e()),
        i && bx.Trace.log('APN', 'error', 'Failed to load a font. Face=[' + a + ']', 'CExe.LF'));
    }
    ...
    if (apn.dbUI && apn.dbUI.system && apn.dbUI.system.pubFontCompress && this.o.standAlone) {
      var l;
      if ((l = apn.Project.publishCompressFont(this.project, { needTextMap: !0 })))
      ...
      if (
        ('file' == o[d].type
          ? this.o.exeAPN
            ? (c = '/' + o[d].path)
            : ((u = o[d].path.split('/')),
              (c = this.o.standAlone && !o[d]._prepro ? 'fonts/' + u[u.length - 1] : o[d].path))
          : 'dir' == o[d].type
            ? this.o.exeAPN
              ? (c = '/' + o[d].path)
              : ((u = o[d].path.split('/')),
        ...
        try {
          ('ko' == o[d].ln &&
            (o[d].txtTest ? (o[d].txtTest += '홁내음이나면') : (o[d].txtTest = '홁내음이나면')),
            this._loadedFontList &&
              (this._loadedFontList[o[d].face] || (this._loadedFontList[o[d].face] = 1)),
  ...
  (apn.CExe.prototype.run = function (e, t, a, i) {
    ...
    function r(e) {
      return e
        ...
        : void _.$O2J.canRun(t, { transit: y, transitDuration: f, transitTiming: v });
    }
    function o() {
      function e() {
        _.$O2J.get(a).show();
    ...
    function s() {
      return _.$O2J.canRun(t, { transit: y, transitDuration: f, transitTiming: v });
    }
    function p(e) {
      r(!0) && n(!0);
    }
    ...
    function d() {
      if (s()) {
        ...
        (void 0 !== e && void 0 !== _.$O2J.getCurrent()
          ...
          : bx.Trace.log('APN', 'warning', 'Invalid link flow case', 'CExe.run'),
          o());
      }
    }
    function c() {
    ...
    if (this.project && !this.isPreview2()) {
      ...
      if (e) e.to && e.to.reset && (i = !0);
        ...
        (t || (t = this.$O36()),
          t && (e = { action: 'LTP', to: { pageID: t }, transit: { effect: 'none' } }),
          (h = !0));
      }
      if (!e) {
        for (u in this.project.pages)
          if ('apn.CFlowPage' == this.project.pages[u].module) {
            ((t = u),
              (e = { action: 'LTP', to: { pageID: t }, transit: { effect: 'none' } }),
              (h = !0));
            break;
          }
        if (!e)
          for (u in this.project.pages) {
            ((t = u), (e = { action: 'LTP', to: { pageID: t }, transit: { effect: 'none' } }));
            break;
          }
      ...
      if (
        ...
        ((x = this.$O2J.get(t)) ||
          ...
          bx.$checkNaN(parseInt(e.transit.duration)) || (e.transit.effect = 'none'));
        var f,
          ...
          C = !h && '3' == e.to.type,
          b =
            !h && void 0 !== this.$O2J.getCurrent() && this.$O2J.get(this.$O2J.getCurrent()).popup;
        h ||
          ...
          void 0 !== this.$O2J.getCurrent() &&
            ...
            'apn.CPopupPage' == this.project.pages[this.$O2J.getCurrent()].module &&
            (b = !0));
        var _ = this;
        b
          ? a
          ...
          if (a.objects[o].ITRs && a.objects[o].ITRs.length)
            for (r = 0; r < a.objects[o].ITRs.length; r++)
              'LTP' != a.objects[o].ITRs[r].action ||
                ...
                ((i[a.objects[o].ITRs[r].to.pageID] = !0), e(a.objects[o].ITRs[r].to.pageID));
      }
    }
    var t = [],
      a = this.$O36();
      ...
      if (this.project.pages[t].ITRs && this.project.pages[t].ITRs.length)
        for (i = 0; i < this.project.pages[t].ITRs.length; i++)
          if ('LTP' == this.project.pages[t].ITRs[i].action)
            if (2 == e) {
              if (this.project.pages[t].ITRs[i].from.objectID == apn.Project.ID_2NDARY_POINT)
                return this.project.pages[t].ITRs[i].to.pageID;
            } else if (
              this.o.exePreview &&
              this.o.useSecondaryFlow &&
              this.project.pages[t].ITRs[i].from.objectID == apn.Project.ID_2NDARY_POINT
            )
              return this.project.pages[t].ITRs[i].to.pageID;
    if (void 0 === e || 1 == e)
      for (var t in this.flow.pages)
        if (this.project.pages[t].ITRs && this.project.pages[t].ITRs.length)
          for (i = 0; i < this.project.pages[t].ITRs.length; i++)
            if (
              ...
              this.project.pages[t].ITRs[i].from.objectID == apn.Project.ID_START_POINT
            )
              return this.project.pages[t].ITRs[i].to.pageID;
      ...
      if (this.project.pages[e].ITRs && this.project.pages[e].ITRs.length)
        for (i = 0; i < this.project.pages[e].ITRs.length; i++)
          if (
            ...
            this.project.pages[e].ITRs[i].from.objectID == apn.Project.ID_END_POINT
          )
    ...
    for (var e in this.flow.pages)
      if (this.project.pages[e].ITRs && this.project.pages[e].ITRs.length)
        for (i = 0; i < this.project.pages[e].ITRs.length; i++)
          if (
            'LTP' == this.project.pages[e].ITRs[i].action &&
            this.project.pages[e].ITRs[i].from.objectID == apn.Project.ID_IN_POINT
          )
            return this.project.pages[e].ITRs[i].to.pageID;
    return null;
  }),
  ...
  (apn.CExe.prototype.getScriptVer = function () {
    return (
      void 0 === this._sptVer && (this._sptVer = apn.Project.getScriptVer(this.project)),
      this._sptVer
    );
  }),
  (apn.CExe.prototype.showLoading = function (e, t) {
    if (!this.$O39) {
      ...
      this.$O39 = this.tagVP.$TAG(
        ...
        { align: 'center' },
        {
          ...
          padding:
            Math.floor(a / 2) + 'px ' + 2 * a + 'px ' + Math.floor(a / 2) + 'px ' + 2 * a + 'px',
    ...
    if (
      (this.$O2U && 'block' == this.$O2U.style.display
        ? (this.$O39.style.bottom =
            parseInt(this.$O2U.style.height) + parseInt(0.01 * this.height) + 'px')
    ...
    ((this.$O39.style.display = 'block'),
      ...
      (this.$O39.style.left = parseInt((this.width - this.$O39.offsetWidth) / 2) + 'px'));
  }),
  ...
  (apn.CExePage.prototype.execInit = function () {
    (this.updateStart(),
      (this.tag.style.zIndex = 0),
      (this.canvas = new (
        this.o.CExePage && this.o.CExePage.clsCanvas ? this.o.CExePage.clsCanvas : apn.CES
      )(this.tagVP)),
  ...
  (apn.CExePage.prototype.execRun = function (e) {
    ...
    if (
      ...
      e && e.data && e.data.fileDomainEventReceive && (this.fileDomainEventReceive = !0),
      (this.apxInRun = !1),
      this.canvas
        ? this._everExecuted &&
          e &&
          ...
          e.data.refresh &&
          (this.canvas.$O37(),
          this.viewer.IDriver_onRefreshScreen && this.viewer.IDriver_onRefreshScreen(this.id),
          (t = !1))
        : (this.execInit(), (this.initialized = !0), (t = !1)),
      this.popup ||
        (this.tag.parentNode.bxPageTransition &&
          this.tag.parentNode.bxPageTransition.tagPopup &&
          (this.tag.parentNode.bxPageTransition.tagPopup.style.display = 'none')),
      t && this.canvas.$O41)
    ) {
      var a = this;
      setTimeout(function () {
    ...
    ((this.canvas.$O41 = !0),
      ...
      (e && e.data && (e.data.noStart || e.data.noNotifyToEditor)) ||
        (this.viewer.IDriver_onRunScreen && this.viewer.IDriver_onRunScreen(this.id)),
  ...
  (apn.CExePage.prototype.execTransitStart = function () {
    this.popup && this.canvas && this.canvas.project
      ? (apn.Project.$O5X(
        ...
        this.canvas.screen.BG
          ? apn.Project.$O5X(
              ...
              this.viewer.o.standAlone,
              'media',
              this.canvas.screen.BG.mediaID || this.canvas.screen.BG.mediaFillStyle,
              this.tag.parentNode.bxPageTransition.tagPopup,
              1 / this.canvas.getZoomX(),
              1 / this.canvas.getZoomY(),
            )
      ...
      : void 0 !== this.tag._orgBackground &&
        ((this.tag.style.background = this.tag._orgBackground), delete this.tag._orgBackground);
  }),
  (apn.CExePage.prototype.execTransitEnd = function (e) {
    ...
    (this.popup && (this.tag.parentNode.bxPageTransition.tagPopup.style.display = 'block'),
    ...
    if (bx.HCL.DV.isIE() && bx.HCL.DV.isIE() <= 8)
      if (void 0 !== e.apxTrRotate && 0 !== e.apxTrRotate) {
        ...
        ((n = bx.CCanvasWnd.getEnclosingRect(
          ...
          e.$CSS(
            'filter',
            bx.$applyMsFilter(e, 'matrix', 'M11=' + a + ',M12=' + -i + ',M21=' + i + ',M22=' + a),
          ));
      ...
      (void 0 !== e.apxTrRotateZ &&
        0 !== e.apxTrRotateZ &&
        (p += p ? ' rotateZ(' + e.apxTrRotateZ + 'deg)' : 'rotateZ(' + e.apxTrRotateZ + 'deg)'),
        void 0 !== e.apxTrRotateX &&
          0 !== e.apxTrRotateX &&
          (p += p ? ' rotateX(' + e.apxTrRotateX + 'deg)' : 'rotateX(' + e.apxTrRotateX + 'deg)'),
        void 0 !== e.apxTrRotateY &&
          0 !== e.apxTrRotateY &&
          (p += p ? ' rotateY(' + e.apxTrRotateY + 'deg)' : 'rotateY(' + e.apxTrRotateY + 'deg)'),
        void 0 !== e.apxTrRotate &&
          0 !== e.apxTrRotate &&
          (p += p ? ' rotate(' + e.apxTrRotate + 'deg)' : 'rotate(' + e.apxTrRotate + 'deg)'),
        ...
        void 0 !== e.apxTrResizeX &&
          1 !== e.apxTrResizeX &&
          (p += p ? ' scaleX(' + e.apxTrResizeX + ')' : 'scaleX(' + e.apxTrResizeX + ')'),
        void 0 !== e.apxTrResizeY &&
          1 !== e.apxTrResizeY &&
          (p += p ? ' scaleY(' + e.apxTrResizeY + ')' : 'scaleY(' + e.apxTrResizeY + ')'),
        ...
        p
          ? (e.$CSS('transform', p),
            e.$O7L || e.$O7O
              ? e.$CSS('transformOrigin', (e.$O7L || '50%') + ' ' + (e.$O7O || '50%'))
    ...
    if (
      ...
      if (t.length >= 4) {
        ...
        var a,
          i = '';
        return (
          (a = new Number(Math.floor(255 * bx.$checkNaN(parseFloat(t[3])))).toString(16)),
          (i += 1 == a.length ? '0' + a : a),
  ...
  (apn.CES.toRGBA = function (e, t) {
    var a = (g = b = 0);
    if (((t = t || 0), (e = e || ''), (e = e.toLowerCase()), '#' == e[0] && 7 == e.length))
      return (
  ...
  (apn.CES.prototype.getTagX = function (e) {
    var t = 0;
    for (void 0 === this.$Ocb && (this.$Ocb = bx.HCL.DV.isIE()); e && e != this.tag; )
  ...
  (apn.CES.prototype.setCursor = function (e, t, a) {
    ...
    ((this.$Ocl.onload = function () {
      i.$Ocl &&
        ((i.$Ocl.style.width = Math.round((1 / i.getZoomX()) * this.naturalWidth) + 'px'),
        (i.$Ocl.style.height = Math.round((1 / i.getZoomY()) * this.naturalHeight) + 'px'),
  ...
  (apn.CES.prototype.$O44 = function () {
    function e(e, t, i, n, r, o, s) {
      ...
      if (
        ...
        a.startDrag && (t == bx.CGesture.POINTER_DRAG || t == bx.CGesture.POINTER_END))
      ) {
        var h = a.startDrag,
          x = a.startDragX,
          f = a.startDragY;
        if (
          (a.$O46(h) || (x = !1), a.$O47(h) || (f = !1), t == bx.CGesture.POINTER_DRAG && (x || f))
        ) {
          if (
            (h.x_inDrag ||
              ((h.x_inDrag = !0), (a.inDragTag = h), h.$CSS({ transitionDuration: 0 })),
              ...
              (a.$O5z(h)
                ? C < 0
                  ...
                  : C > h.parentNode.clientWidth - y &&
                    ((b = h.parentNode.clientWidth - y - C), (C = h.parentNode.clientWidth - y))
                : a.$O7Q(h) &&
                  (C > 0
                    ? ((b = -C), (C = 0))
                ...
                h.apnOID &&
                  ...
                  (a.screen.objects[h.apnOID].init.position.x += apn.widgets.utils.$O3Z(
                    i + b - h.x_inDragEX,
                    1 / a.$O2O,
                  ))),
                (h.style.left = C + 'px'),
              ...
              (a.$O5z(h)
                ? _ < 0
                  ...
                  : _ > h.parentNode.clientHeight - v &&
                    ((m = h.parentNode.clientHeight - v - _), (_ = h.parentNode.clientHeight - v))
                : a.$O7Q(h) &&
                  (_ > 0
                    ? ((m = -_), (_ = 0))
                ...
                h.apnOID &&
                  ...
                  (a.screen.objects[h.apnOID].init.position.y += apn.widgets.utils.$O40(
                    n + m - h.x_inDragEY,
                    1 / a.$O2P,
                  ))),
                (h.style.top = _ + 'px'),
            ...
            (x || f) &&
              ...
              a.screen.objects[h.apnOID] &&
              (a.$O4a(h, 'drag'),
              (apn.dbUI && apn.dbUI.system && apn.dbUI.system.exeApxMoveWgtByDOM) ||
                apn.IWidget.exeRenderPosition(
                  a,
                  h,
                  a.screen.objects[h.apnOID],
            ...
            !h.apxOnDragEnd ||
              ...
              h.apnOID &&
                ...
                f &&
                  ...
                  (a.screen.objects[h.apnOID].init.position.y = h.x_inDragScY)))),
        ...
        if (t == bx.CGesture.PINCH_END) {
          ...
          R && bx.Event.getElement(s).apnOID
            ? (!bx.DOM.IsDescendantOf(R, a.tag) ||
              ...
              (a.$O6A(null), a.$O6B('pointerOut', bx.Event.getElement(s), r, o, s, i, n))
            : R || (a.$O6E && (a.$O6B('pointerOut', a.$O6E, r, o, s, i, n), (a.$O6E = null)));
        } else
          !a.inDragLastTime ||
          a.inDragLastTime != s.timeStamp ||
  ...
  (apn.CES.prototype.$O4d = function (e, t, a, i, n, r) {
    if (e == bx.CGesture.POINTER_START) {
      ...
      var p = this._event2canScrollX(o, r),
        ...
        d = this.$O46(o),
        c = this.$O47(o);
      for (p && (d = !1), l && (c = !1); o && o != this.tag && !d && !c && (!p || !l); )
        (o = o.parentNode) &&
      ...
      if (d || c)
        if (
          (this.viewer.uOnGestureDragStartControl && this.viewer.uOnGestureDragStartControl(r),
          !o.apxOnDragStart ||
            o.apxOnDragStart(
              this,
              t,
          ...
          ((o.x_inDragSX = t),
            ...
            'none' != o.$css('user-select')
              ? ((o._x_dragCssSel = o.$css('user-select')), o.$CSS('userSelect', 'none'))
  ...
  (apn.CES.prototype.$O5B = function (e, t) {
    ...
    if (a && a.length) for (var i = 0; i < a[0].length; i++) if ('FDR' == a[0][i].action) return !0;
    return (
  ...
  (apn.CES.prototype.$O5A = function (e, t, a) {
    function i(e, t) {
      return (
        s._getWgtZIndex(s.screen.objects[t].create) - s._getWgtZIndex(s.screen.objects[e].create)
      );
    }
    var n,
  ...
  (apn.CES.prototype.$O5d = function (e) {
    if (
      ...
      !(e.apxOnEvent || e.apxOnGesture || e.apxOnDragStart || e.apxOnDrag || e.apxOnDragEnd)
    )
      return !0;
  }),
  ...
  (apn.CES.prototype.$O4e = function (e, t, a, i, n, r, o) {
    if (void 0 === i || void 0 === n) var s = null;
      ...
      if (document.msElementsFromPoint) var p = document.msElementsFromPoint(i, n);
      ...
      if (p && p.length)
        for (
          ...
          (o && s.apnPassPointerEventButHit && o(s), s != this.tag && s != this.tag.ownerDocument);
          d++
        );
      var c,
        g = bx.HCL.DV.isIE();
      ...
      for (
        y &&
        y.tagName &&
        ('input' == y.tagName.toLowerCase() || 'textarea' == y.tagName.toLowerCase()) &&
    ...
    if (o) {
      var v = s;
      (!this.startDrag || (e != bx.CGesture.POINTER_DRAG && e != bx.CGesture.POINTER_END)
        ? this.__drgStart2 && e == bx.CGesture.POINTER_END && (v = this.__drgStart2)
        : (v = this.startDrag),
        v && v.apxOnGesture && (v.apnBlockPointerEvent || v.apxOnGesture(this, e)));
    }
    return s;
  }),
    ...
    if (l) {
      ...
      if ((('click' != s && 'tapStart' != s) || this.viewer.initAutoplay(), '_pointerMove' == s)) {
        var d = this.$O6D('pointerOver', l),
          c = this.$O6A(d || l);
        (c && c.pointerOut && this.$O6B('pointerOut', c.pointerOut, i, n, r, t, a),
          c && c.pointerOver && this.$O6B('pointerOver', c.pointerOver, i, n, r, t, a));
  ...
  for (
    ...
    (this.$O49(l, a, i, n, r, o, e) !== !0 &&
      ('pointerOver' == e || 'pointerOut' == e
        ? l.apxOnEventOver &&
          (s = !!l.apnBlockPointerEvent || l.apxOnEventOver(this, 'pointerOver' == e, n))
        : l.apxOnEvent &&
          (s =
            !!l.apnBlockPointerEvent ||
            l.apxOnEvent(this, e, a, i, r * this.getZoomX(), o * this.getZoomY(), n))),
    !s);
  )
    l = l.parentNode;
  for (
...
((apn.CES.prototype.$O6D = function (e, t) {
  ...
  (apn.CES.prototype.$O6A = function (e) {
    if (this.$O6E) {
      if (this.$O6E != e) {
        ...
        return (
          (this.$O6E = null),
          e && (e.apnOID || e.apxOnEventOver) && ((this.$O6E = e), (t.pointerOver = e)),
          t
        );
      }
    } else if (e && (e.apnOID || e.apxOnEventOver)) return ((this.$O6E = e), { pointerOver: e });
  }),
  ...
  (apn.CES.prototype.$O34 = function (e, t, a, i) {
    ...
    for (var s = 0; s < e.length; s++)
      (i && 'FCE' == e[s].action && (e[s].src = i), this.$O35(e[s], t ? n : void 0, a));
  }),
  ...
  (apn.CES.prototype.$O3i = function (e, t, a, i) {
    ...
    switch (e.action) {
      ...
      case 'LTB':
        if (this.viewer.$O2J.uLinkToPrev) this.viewer.$O2J.uLinkToPrev(this.getPageID());
          ...
          this.viewer.showLoading('No page to go back in history.', apn.CExe.TIME_TOASTMSG_ERROR);
        break;
      case 'CWP':
    ...
    return (
      n || (bx.Trace.log('APN', 'error', 'Invalid ITR', 'CES.runInteraction'), bx.Trace.data(e)),
      n
    );
  }),
  (apn.CES.prototype.$O3s = function (e, t, a, i) {
    ...
    if (void 0 === l) {
      if (!(o && o.exeOnGetStateList && s.length))
        return (
          bx.Trace.log('APN', 'warning', 'Invalid current state=' + a, 'CES.opCWS'),
          bx.Trace.data(t),
          null
        );
        ...
        : '$F' == e
          ...
          : '$B' == e
            ? l - 1 >= 0
              ? s[l - 1]
              : null
            : (bx.Trace.log('APN', 'warning', 'Invalid state=' + e, 'CES.opCWS'), null);
  }),
  ...
  (apn.CES.prototype.$O3r = function (e) {
    function t() {
      s.screen &&
        (s.$O3p(s.screen, a, i), (o.$O7R = (o.$O7R || 0) - 1), o.$O7R < 0 && (o.$O7R = 0));
    }
    if (e.target && e.target.stateID && this.screen.objects[e.target.objectID]) {
      ...
      if ((i && '$' == i.charAt(0) && (i = this.$O3s(i, a, n, e.target.objectID)), null === i))
        return !0;
      if (1 == apn.Project.checkStateType(a)) {
        ...
        r = this.$O3n(this.project, this.screen, a, n, i, e.timing, o.apnCur.ver);
        var s = this;
        return (
      ...
      if (p && l && d) {
        ...
        return (
          ...
          (!e.transit.duration || e.transit.duration < 50) && (e.transit.effect = 'none'),
  ...
  (apn.CES.prototype.$O3j = function (e, t, a, i) {
    ...
    function o(e, t, a) {
      (O.use && (a = O.x),
        S.$O5D(S.screen.objects[e.apnOID], a - S.screen.objects[e.apnOID].init.position.x, void 0),
        (S.screen.objects[e.apnOID].init.position.x = a));
    }
    function s(e, t, a) {
      (O.use && (a = O.y),
        S.$O5D(S.screen.objects[e.apnOID], void 0, a - S.screen.objects[e.apnOID].init.position.y),
    ...
    function b(e, t, a) {
      ((S.screen.objects[e.apnOID].init.position.y = a),
        T &&
          T.exeRenderTag &&
          T.exeRenderTag(S.viewer, S, e, S.screen.objects[e.apnOID], 1 / S.$O2O, 1 / S.$O2P));
    }
    function _(e, t, a) {
    ...
    if (e.target && e.set && (I = this.$O3d[e.target.objectID])) {
      var T = apn.Project.getWidgetModule(this.screen.objects[e.target.objectID].create.data);
      (T &&
        (T.exeItrNoResize && (e.set.size && delete e.set.size, e.set.sizeBy && delete e.set.sizeBy),
        T.exeItrNoZoom && e.set.zoom && delete e.set.zoom),
        e.set.line &&
          this.screen.objects[e.target.objectID].init.shape.type != bx.CCanvasWnd.SHAPE_LINE &&
          delete e.set.line);
      var w;
      if (
        (e.timing &&
          (apn.Project.resolveTiming(this.project, e.timing),
          e.timing.roundUp && !parseInt(e.timing.duration) && (e.timing.duration = 1)),
        (T && T.exeItrNoText) ||
          (void 0 !== e.set.text && this.wgtSetProperty(e.target.objectID, 'apxText', e.set.text),
          void 0 !== e.set.textColor &&
            (apn.IWidget.exeSetFontStyle(I, e.set.textColor),
            this.wgtSetProperty(e.target.objectID, 'apxTextColor', e.set.textColor))),
        void 0 !== e.set.value && this.sptWgtSetProp(e.target.objectID, 'value', e.set.value),
        e.set.drag)
      ) {
        ...
        ((E.styles = E.styles || {}),
          void 0 !== e.set.drag.dragX && (E.styles.dragX = 'Yes' == e.set.drag.dragX),
          void 0 !== e.set.drag.dragY && (E.styles.dragY = 'Yes' == e.set.drag.dragY),
          'SPT' == i
            ? (void 0 !== e.set.drag.dragInParent &&
                (E.styles.dragInParent =
                  'Yes' == e.set.drag.dragInParent || 'In' == e.set.drag.dragInParent),
              void 0 !== e.set.drag.dragContainParent &&
                (E.styles.dragContainParent = 'Contain' == e.set.drag.dragInParent))
            : ((E.styles.dragInParent =
                'Yes' == e.set.drag.dragInParent || 'In' == e.set.drag.dragInParent),
              (E.styles.dragContainParent = 'Contain' == e.set.drag.dragInParent)),
          this.$O46(I) || this.$O47(I) ? (I.apnDragCsr = !0) : (I.apnDragCsr = !1),
      ...
      if (
          ...
          ('Hide' != e.set.visibility && e.set.visibility !== !1
            ? (I.$Ocq && (clearTimeout(I.$Ocq), (I.$Ocq = null)),
              ...
              'Pass' == e.set.visibility || 1 === e.set.visibility
                ? (this.tagPassPointerEvent(I, !0), this.tagBlockPointerEvent(I, !1))
                : 'Block' == e.set.visibility || 2 === e.set.visibility
                  ? (this.tagPassPointerEvent(I, !1), this.tagBlockPointerEvent(I, !0))
                  : (this.tagPassPointerEvent(I, !1), this.tagBlockPointerEvent(I, !1)),
              apn.IWidget.exeSetCursor(I, I.apnCur.orgCursor),
              T && T.exeOnShow && T.exeOnShow(this, e.target.objectID, !0, e.event),
            ...
            : (e.event &&
              ...
              T && T.exeOnShow && T.exeOnShow(this, e.target.objectID, !1, e.event),
              this._exeOnWgtVisibilityChange(e.target.objectID, !1)),
          this.wgtSetProperty(e.target.objectID, 'apxVisibility', e.set.visibility),
        ...
        e.set.position && (void 0 !== e.set.position.x || void 0 !== e.set.position.y))
      ) {
      ...
      if (e.set.positionBy && (void 0 !== e.set.positionBy.x || void 0 !== e.set.positionBy.y)) {
        ...
        if (
          e.forceQueue ||
          (e.timing && e.timing.timing && 'none' != e.timing.timing && parseInt(e.timing.duration))
        ) {
          this.viewer.isStretch() || apn.CExe.ACCEL(I);
          var U = n(I, e.timing);
          (e.trace &&
      ...
      if (e.set.size && e.set.size.w && e.set.size.h) {
        ...
        if (
          ...
          var X = n(I, e.timing);
          (this.$O7T(I, 'size'),
            (X.styles.width = { from: this.screen.objects[I.apnOID].init.shape.w, to: H, unit: u }),
            (X.styles.height = {
          ...
          (this.$O7T(I, 'size'), this.$O6G(I, null, 'size'), u(I, 'width', H), h(I, 'height', z));
      }
      if (e.set.trOrg) {
      ...
      if (e.set.zoom && e.set.zoom.w && e.set.zoom.h) {
        ...
        if (
          ...
          (this.$O7T(I, 'zoom'), this.$O6G(I, null, 'zoom'), x(I, 'scaleX', H), f(I, 'scaleY', z));
      }
      if (e.set.sizeBy && (void 0 !== e.set.sizeBy.w || void 0 !== e.set.sizeBy.h)) {
        var M = bx.$checkNaN(parseFloat(e.set.sizeBy.w)),
          k = bx.$checkNaN(parseFloat(e.set.sizeBy.h)),
      ...
      if (
        ...
        if (
          ...
          if ((this.$O7T(I, 'line'), 6 == e.set.line.length))
            ((Q.styles.px0 = { from: ee.shape.x[0], to: e.set.line[2], unit: C }),
              (Q.styles.py0 = { from: ee.shape.y[0], to: e.set.line[3], unit: C }),
              (Q.styles.px1 = { from: ee.shape.x[1], to: e.set.line[4], unit: C }),
              (Q.styles.py1 = { from: ee.shape.y[1], to: e.set.line[5], unit: C }),
              (Q.styles.x = { from: ee.position.x, to: e.set.line[0], unit: C }),
              (Q.styles.y = { from: ee.position.y, to: e.set.line[1], unit: b }));
          else {
            var te = Math.min(e.set.line.x1, e.set.line.x2),
              ae = Math.min(e.set.line.y1, e.set.line.y2);
            ((Q.styles.px0 = { from: ee.shape.x[0], to: e.set.line.x1 - te, unit: C }),
              (Q.styles.py0 = { from: ee.shape.y[0], to: e.set.line.y1 - ae, unit: C }),
              (Q.styles.px1 = { from: ee.shape.x[1], to: e.set.line.x2 - te, unit: C }),
              (Q.styles.py1 = { from: ee.shape.y[1], to: e.set.line.y2 - ae, unit: C }),
          ...
          if ((this.$O7T(I, 'line'), this.$O6G(I, null, 'line'), 6 == e.set.line.length))
      ...
      if (void 0 !== e.set.angle) {
        ...
        if (
          (!e.set.angle2 ||
            (I.apnCur.trCX == e.set.angle2.cx && I.apnCur.trCY == e.set.angle2.cy) ||
            (ne = !0),
          !ne &&
            (e.forceQueue ||
              (e.timing &&
          ...
          (a || (this.$O7T(I, 'angle'), this.$O6G(I, null, 'angle')), m(I, 'angle', e.set.angle));
      }
        ...
        e.set.animation &&
          ('Play' == e.set.animation || 'Loop' == e.set.animation
            ? this.wgtAniCheck(e.target.objectID) &&
              this.wgtAniRun(e.target.objectID, 'Play' == e.set.animation ? 1 : 2)
    ...
    return (
      t && t(),
      bx.Trace.log('APN', 'error', 'Invalid CWP tag=' + I, 'CES.runInteraction'),
      !1
    );
  }),
    ...
    return (
      ...
      ('$URL_CF' == e.target.objectID
        ...
        : '$URL_CW' == e.target.objectID
          ...
          : '$URL_NW' == e.target.objectID && this.viewer.IDevice_linkToURL(e.url, 'newTab'))
    );
  }),
  ...
  (apn.CES.prototype.$O5H = function (e, t) {
    ...
    if (a && a.length) for (var i = 0; i < a.length; i++) if (0 == a[i].event.indexOf(e)) return !0;
    return !!this.$Oco(e, t);
  }),
  (apn.CES.prototype.$O3g = function (e, t) {
    ...
    ((n = n.concat()),
      e.indexOf && 0 == e.indexOf('spt_Custom:')
        ...
        : e.indexOf && 0 == e.indexOf('wgtEvent:') && (e = decodeURIComponent(e)));
    var r;
    ...
    for (r = 0; r < s.length; r++)
      for (l = 0, s[r].sort(i), p = 0; p < s[r].length; p++)
        'WAT' == s[r][p].action && s[r][p].timing
          ? ((l += bx.$checkNaN(parseInt(s[r][p].timing.duration))), s[r].splice(p, 1), p--)
          : (s[r][p].$O3y = l);
    return s;
  }),
  ...
  (apn.CES.prototype.$O5r = function () {
    for (var e in this.$O3d)
      this.$O3d[e].apxParentPO &&
        (this.$O3d[e].apxParentPO.appendChild(this.$O3d[e]), delete this.$O3d[e].$O6I);
  }),
  (apn.CES.prototype.pageOverEnd = apn.CES.prototype.$O5r),
  (apn.CES.prototype.$O5s = function () {
    for (var e in this.$O3d)
      this.wgtGetProperty(e, 'apxFixOverPage') &&
        ((this.$O5O = this.$O5O || this.tag.$TAG('div', { style: 'display:none' })),
        (this.$O3d[e].apxParentPO = this.$O3d[e].parentNode),
  ...
  (apn.CES.prototype.$O3C = function () {
    ...
    for (e in this.screen.objects)
      if (((a = this.screen.objects[e]), a.layout && a.layout.children && a.layout.children.length))
        for (t = 0; t < a.layout.children.length; t++)
          this.screen.objects[a.layout.children[t]] && this.$O3t(a.layout.children[t], 'parent', e);
    for (e in this.screen.objects)
    ...
    for (e in this.screen.objects)
      ((a = this.screen.objects[e]), 'apn.CScrollContainer' == a.module && this.$ObI(a));
    for (e in this.screen.objects)
      if (((a = this.screen.objects[e]), 1 == apn.Project.checkStateType(a.layout)))
        ...
        for (t in a.layout.layers)
          (t != a.create.data.styles.state
            ...
            'apn.CScrollContainer' != a.module &&
              bx.$copyObject(this.screen.objects[a.layout.layers[t].id].init, a.init));
      }
    for (e in this.screen.objects)
      ((a = this.screen.objects[e]),
        a.create.data &&
  ...
  (apn.CES.prototype.$O3E = function (e) {
    function t() {
      (i.viewer.$Ocg &&
        (i.tag && void 0 !== i.tag.$Ocs && ((i.tag.style.opacity = i.tag.$Ocs), delete i.tag.$Ocs),
    ...
    (this.$O3u(e, 'isHidden') && (t.style.display = 'none'),
      this.$O3u(e, 'visibility') === !1
        ...
        : 1 === this.$O3u(e, 'visibility')
          ? (this.tagPassPointerEvent(t, !0), apn.IWidget.exeSetCursor(t, t.apnCur.orgCursor))
          : 2 === this.$O3u(e, 'visibility') &&
            (this.tagBlockPointerEvent(t, !0), apn.IWidget.exeSetCursor(t, t.apnCur.orgCursor)));
  }),
      ...
      for (var a in this.screen.objects)
        ((t = apn.Project.getWidgetModule(this.screen.objects[a].create.data)),
          t &&
            ...
            null !==
              t.exeSetState(this, this.$O3d[a], this.wgtGetProperty(a, 'apxState'), void 0, !0) &&
            t.exeFireStateEvent &&
            this.fireEvent(
              'stateChange',
    ...
    for (var p, l, d, c, g = {}, u = 0; u < t.length; u++)
      (s = this.screen.objects[t[u]]) &&
        ...
        s.init.shape.type == bx.CCanvasWnd.SHAPE_LINE
          ? ((d = s.init.position.x + Math.abs(s.init.shape.x[1] - s.init.shape.x[0]) + 1),
            (c = s.init.position.y + Math.abs(s.init.shape.y[1] - s.init.shape.y[0]) + 1))
          : ((d = s.init.position.x + s.init.shape.w), (c = s.init.position.y + s.init.shape.h)),
        apn.Project.isWidget(s.create.data) &&
          void 0 !== s.create.data.styles.angle &&
          ((s.create.data.styles.angle = bx.$checkNaN(parseFloat(s.create.data.styles.angle))),
          bx.CCanvasWnd.getEnclosingRect(p, l, d - p, c - l, s.create.data.styles.angle, g),
          void 0 !== g.x1 && (p = g.x1),
          void 0 !== g.y1 && (l = g.y1),
          void 0 !== g.x2 && (d = g.x2),
          void 0 !== g.y2 && (c = g.y2)),
        ...
        (void 0 === r || r < d) && (r = d),
        (void 0 === o || o < c) && (o = c));
    return (void 0 !== i && ((a.x = i), (a.y = n), (a.w = r - i), (a.h = o - n)), a);
  }),
  ...
  (apn.CES.prototype.$O3I = function () {
    ...
    return (
      ...
      (this.__pageLoadRefCountCur && this._pageLoadRefCount != this.__pageLoadRefCountCur) ||
      ...
      if (this._timeoutsConP)
        for (var t in this._timeoutsConP)
          ((e = this._timeoutsConP[t]),
            'clear' == e.type ? this.$Ocz(e.id) : 'complete' == e.type && this.clearTimeout(e.id));
  ...
  (apn.CES.prototype.eventExe = function (e, t, a, i) {
    ...
    ((n = s
      ...
      this.sptEval(e, t, { oId: t, ev: e, depth: 0, orgPgId: a, byStart: i }) && (o = !0),
      ('pointerOver' != e && 'pointerOut' != e) ||
    ...
    return (
      ...
      l &&
        ...
        ((l = !1),
        (d = !1),
        1 === this.$O3d[t].apxBubblingCtl[p] && delete this.$O3d[t].apxBubblingCtl[p]),
      l &&
  ...
  (apn.CES.prototype.$O3X = function (e, t, a) {
    ...
    if (this.screen)
      for (var n in this.screen.objects) {
        if (((i = apn.Project.getWidgetModule(this.screen.objects[n].create.data)), i && i[e])) {
          if ('exeOnPause' == e && this.$O3d[n].apxBackgroundRun) continue;
          if (apn.CExe.DEBUG) apn.CES.$Ocw[e] ? i[e](this, n, a) : i[e](this, n);
          else
            try {
  ...
  (apn.CES.prototype.$O3L = function (e, t, a) {
    ...
    if (
      ...
      ((this.$O3d[t] = s.exeCreateTag(this.viewer, this, a, 1 / this.$O2O, 1 / this.$O2P, t)),
        (n = this.$O3d[t]),
        (n.apnOID = t),
        (n.apnPID = this.$O1m),
        e.apnOID && (n.apnParentOID = e.apnOID),
        (this.$O5H('click', t) || this.$O5H('tapStart', t)) && (n.apnTapCsr = !0),
        e.appendChild(n),
      ...
      if (
        ...
        this.$O3d[t] || ((this.$O3d[t] = e.$TAG('div')), (this.$O3d[t].apnCur = {})),
        (n = this.$O3d[t]),
        (n.apnOID = t),
        (n.apnPID = this.$O1m),
        e.apnOID && (n.apnParentOID = e.apnOID),
      ...
      (r &&
        ...
        !a.layout || !a.layout.children || (a.ITRs && a.ITRs.length) || (n.apnCur.isHolder = !0));
    }
    if (
      ((n.apnCur.apxColDectectOn = !0), (this._apxColDectectOn = !0), !n.apnCur.apxCreatedFromTag)
    ) {
      var l;
      if (
        this.viewer.constructor.IStub_pubProcWgtAttr &&
        (l = this.viewer.constructor.IStub_pubProcWgtAttr(this.project, this.getPageID(), t))
      ) {
        if (l.attr) for (var d in l.attr) void 0 !== l.attr[d] && n.setAttribute(d, l.attr[d]);
        if (l.attr0 && n.firstChild && 1 == n.firstChild.nodeType)
          for (var d in l.attr0) void 0 !== l.attr0[d] && n.firstChild.setAttribute(d, l.attr0[d]);
      }
    }
    if (
      ...
      apn.CExe.DEBUG &&
        ...
        a.create.data.styles &&
        (n.title =
          (a.create.data.styles.title ? a.create.data.styles.title + ':' : ':') +
          t +
          '(' +
      ...
      if (
        ...
        (c.cnt++,
          ...
          (c.av = Math.round(
            window._cCntMap[a.create.data.wgtID].tm / window._cCntMap[a.create.data.wgtID].cnt,
          )),
          n.apnCur && n.apnCur.apxCreatedFromTag && (c.htmCnt++, window._htmCnt++));
      } else
        ((window._cCntMap.ETC = window._cCntMap.ETC || { cnt: 0, tm: 0 }),
          window._cCntMap.ETC.cnt++,
          (window._cCntMap.ETC.tm += new Date().getTime() - i),
          (window._cCntMap.ETC.av = Math.round(window._cCntMap.ETC.tm / window._cCntMap.ETC.cnt)));
    ...
    if (a.layout && a.layout.children && a.layout.children.length)
      for (var g = 0; g < a.layout.children.length; g++)
        this.screen.objects[a.layout.children[g]] &&
          (r || 'bx.CEditorWnd.CGroup' != a.module
            ? this.$O3L(n, a.layout.children[g], this.screen.objects[a.layout.children[g]])
            : this.$O3L(e, a.layout.children[g], this.screen.objects[a.layout.children[g]]));
  ...
  (apn.CES.prototype.$O3x = function (e, t) {
    ...
    (n && n.exeRenderTag
      ...
      : (apn.IWidget.exeRenderPosition(this, i, a, this.project, 1 / this.$O2O, 1 / this.$O2P),
        apn.IWidget.exeRenderSize(
          this.viewer,
          this,
          i,
      ...
      if (
        ...
        for (var s in t.layout.states)
          for (o in t.layout.states[s].objects)
            (void 0 !== a && a && (t.layout.states[s].objects[o].init.position.x += a),
              void 0 !== i && i && (t.layout.states[s].objects[o].init.position.y += i));
  ...
  (apn.CES.prototype._preloadAssetsCount = function () {
    var e = apn.Project.publishListAsset(this.project, { id: this.$O1m, pageOnly: !0 }),
      t = 0;
  ...
  (apn.CES.prototype.$Oct = function (e) {
    ...
    var s = apn.Project.publishListAsset(this.project, { id: this.$O1m, pageOnly: !0 }),
      p = 0,
      l = {};
  ...
  (apn.CES.prototype.$O1B = function (e, t, a, i, n) {
          ...
          for (t = 0; t < r.length; t++)
            if (r[t].disabled) (r.splice(t, 1), t--);
              ...
              for (n = !1, a = t + 1; a < r.length; a++)
                r[a].disabled ||
                  ((i = !1),
                  ((o.$O3d[r[t].oId].apnCur && o.$O3d[r[t].oId].apnCur.apxColDectectOn) ||
                    (o.$O3d[r[a].oId].apnCur && o.$O3d[r[a].oId].apnCur.apxColDectectOn)) &&
                    apx.wgt.$O4u(o, o.$O3d[r[t].oId], o.$O3d[r[a].oId], void 0, !0) &&
                    ((o._apxColDectectMap = o._apxColDectectMap || {}),
                    o._apxColDectectMap[r[t].oId + ':' + r[a].oId] ||
                      o._apxColDectectMap[r[a].oId + ':' + r[t].oId] ||
                      (o.fireEvent(
                        'spt_Collision',
                        encodeURIComponent(o.wgtGetProperty(r[t].oId, 'apxLabel') || ''),
                        r[a].oId,
                        !0,
                        !0,
                      ),
                      o.fireEvent(
                        'spt_Collision',
                        encodeURIComponent(o.wgtGetProperty(r[a].oId, 'apxLabel') || ''),
                        r[t].oId,
                        !0,
                        !0,
                      ),
              ...
              !n && o.$O3d[r[t].oId].apnCur && (o.$O3d[r[t].oId].apnCur.apxColDectectOn = !1);
            }
    ...
    for (p in this.screen.objects)
      void 0 === this.$O3u(p, 'parent') && this.$O3L(this.tag, p, this.screen.objects[p]);
    (apn.CExe.TRACE &&
      console.error(
        '[TRACE] PageID=[' +
          a +
    ...
    var c = 0;
    for (p in this.screen.objects)
      ((wgtModule = apn.Project.getWidgetModule(this.screen.objects[p].create.data)),
        wgtModule && wgtModule.exeAssetDelayedLoad && c++);
    for (p in this.screen.objects)
      ((wgtModule = apn.Project.getWidgetModule(this.screen.objects[p].create.data)),
        wgtModule &&
          wgtModule.exeAssetLoad &&
          (c > 1 && wgtModule.exeAssetDelayedLoad && this.wgtSetProperty(p, 'apxDelayedLoad', !0),
          wgtModule.exeAssetLoad(this, this.$O3d[p])));
    var g = apn.Project.getLayout(this.project).property;
    if (g.CExe && 'Y' == g.CExe.inputSave)
      for (p in this.screen.objects)
        ((wgtModule = apn.Project.getWidgetModule(this.screen.objects[p].create.data)),
          wgtModule && wgtModule.apxInputSave && this.wgtSetProperty(p, 'save', !0, !0));
    if (
      (this.$O3X('exeOnLoad', a),
      this.$Och ? this.setPaused(!1) : this.setPaused(!!this.viewer.o.clearItrOnPause),
      this._updateTickLoop(),
      void 0 !== this.$O42 && (bx.Transition.loopRemove(this.$O42), delete this.$O42),
      ...
      if ('apn.COverlayPage' != this.screen.module && u && u.pageOutline) {
        ...
        if (((x = u.pageOutline.shadow[0]), x.color && x.spread)) {
          ...
          (this.tagPassPointerEvent(y, !0),
            ...
            h.LT && y.$CSS('borderTopLeftRadius', Math.ceil(h.LT * (1 / this.$O2O)) + 'px'),
            h.RT && y.$CSS('borderTopRightRadius', Math.ceil(h.RT * (1 / this.$O2O)) + 'px'),
            h.RB && y.$CSS('borderBottomRightRadius', Math.ceil(h.RB * (1 / this.$O2O)) + 'px'),
            h.LB && y.$CSS('borderBottomLeftRadius', Math.ceil(h.LB * (1 / this.$O2O)) + 'px'),
            (y.style.border =
              'solid ' + Math.ceil(0.3 * x.spread * (1 / this.$O2O)) + 'px ' + x.color));
        }
      }
    }
    return !0;
  ...
  (apn.CES.prototype.$O3M = function () {
    if (
      (this.$O5K(!0),
      this.$O7W(),
      this.project && this.project.property.allowClearTimeout && this._cancelTimeoutAll(),
      (this.startDrag = null),
      (this.$O7P = !1),
  ...
  (apn.CES.prototype.$O3n = function (e, t, a, i, n, r, o) {
    function s(e) {
      var t = { action: 'CWP', event: 'none', forceQueue: !0, target: { objectID: _ }, set: {} };
      return (
        r && ((t.timing = bx.$cloneObject({}, r)), t.timing.effect && delete t.timing.effect),
        t
      );
    }
    var p,
    ...
    if (!a.states[i] || !a.states[n])
      return (console.error('unknown state id for state change itr generation'), l);
    var d,
      c,
      g,
      u,
    ...
    for (var _ in v) {
      ...
      ((f = !1),
        ...
        d.init.shape.type == bx.CCanvasWnd.SHAPE_LINE
          ? (d.init.position.x == c.init.position.x &&
            ...
            l.push(p))
          : ((d.init.position.x == c.init.position.x && d.init.position.y == c.init.position.y) ||
              ((p = s(_)),
              (p.set.positionBy = {
              ...
              l.push(p)),
            (d.init.shape.w == c.init.shape.w && d.init.shape.h == c.init.shape.h) ||
              ((p = s(_)),
              (p.set.sizeBy = {
      ...
      (2 == o
        ? I != this.$O3d[_].apnCur.zIndex && ((p = s(_)), (p.set.zIndex = I), l.push(p))
        : I != c.create.zIndex && ((p = s(_)), (p.set.zIndex = I), l.push(p)),
        d.create.data &&
          d.create.data.styles &&
          ((y = apn.Project.getWidgetModule(this.screen.objects[_].create.data)),
          y &&
            y.styleMap &&
            y.styleMap.angle &&
            (f ||
              apn.Project.resolveStyle(e, 'angle', d.create.data.styles.angle) !=
                apn.Project.resolveStyle(e, 'angle', c.create.data.styles.angle)) &&
            ((p = s(_)),
            (p.set.angle = {
          ...
          y &&
            ...
            apn.Project.resolveStyle(e, 'alpha', d.create.data.styles.alpha) !=
              apn.Project.resolveStyle(e, 'alpha', c.create.data.styles.alpha) &&
            ((p = s(_)),
            (p.set.alpha = apn.Project.resolveStyle(e, 'alpha', d.create.data.styles.alpha)),
            l.push(p)),
          y &&
            y.styleMap &&
            y.styleMap.visibility &&
            apn.Project.resolveStyle(e, 'visibility', d.create.data.styles.visibility) !=
              apn.Project.resolveStyle(e, 'visibility', c.create.data.styles.visibility) &&
            ((p = s(_)),
  ...
  (apn.CES.prototype.$O4f = function (e, t, a) {
    ...
    if (void 0 !== i[t] && (a || this.$O3u(this.screen.objects[e].layout.layers[t].id, 'isHidden')))
      for (var n in i)
        n == t
  ...
  (apn.CES.prototype.$O3l = function (e, t) {
    ...
    return (
      void 0 !== a ||
        t ||
        bx.Trace.log('APN', 'warning', 'Invalid layer container=' + e, 'CES.$O3l'),
      a
    );
  }),
  ...
  (apn.CES.prototype.$O3m = function (e, t, a) {
    if (
      ...
      if ((this.$O3t(e, 'activeState', t), void 0 !== e)) {
        ...
        n && n.exeSetState && !n.BLACKBOX_MODEL && n.exeSetState(this, this.$O3d[e], t, i, a);
      }
    }
  }),
  ...
  (apn.CES.prototype.$O3p = function (e, t, a) {
    ...
    for (i in t.states[a].objects) {
      if (((r = t.states[a].objects[i]), r.create.data && r.create.data.styles)) {
        ((e.objects[i].create.data = e.objects[i].create.data || {}),
          (e.objects[i].create.data.styles = e.objects[i].create.data.styles || {}));
  ...
  (apn.CES.prototype.$O3N = function (e, t) {
    ...
    for (a in t.states[0].objects)
      ((i = t.states[0].objects[a]),
        (n = null),
        i.create.data && i.create.data.properties && delete i.create.data.properties,
      ...
      n = {
        ...
        onEnd: function (t) {
          (void 0 !== i._timeouts[t.id] && delete i._timeouts[t.id],
            i._timeoutsConP && void 0 !== i._timeoutsConP[t.id] && delete i._timeoutsConP[t.id],
            e());
        },
        onCancel: function (e) {
          (void 0 !== i._timeouts[e.id] && delete i._timeouts[e.id],
            i._timeoutsConP && void 0 !== i._timeoutsConP[e.id] && delete i._timeoutsConP[e.id]);
        },
      };
    ((apn.CES.$O5Q = apn.CES.$O5Q || 0), apn.CES.$O5Q++, (n.id = 'TMR$' + apn.CES.$O5Q));
      ...
      a &&
        ...
        ('complete' == a.onPagePause || 'clear' == a.onPagePause
          ? ((this._timeoutsConP = this._timeoutsConP || {}),
            (this._timeoutsConP[n.id] = { id: r + ':' + n.id, type: a.onPagePause }))
          : this.log(
              void 0,
              "Invalid value for 'onPagePause' of setTimeout(). Value=" + a.onPagePause,
            )),
      r + ':' + n.id
    );
  }),
  ...
  (apn.CES.prototype._cancelTimeoutAll = function () {
    if (this._timeouts) for (var e in this._timeouts) bx.Transition.cancel(this._timeouts[e], e);
  }),
  (apn.CES.prototype.$O3v = function () {
    if (this.viewer.o.exeUseZIndex2) {
      ...
      for (var t in this.screen.objects)
        (e < this.screen.objects[t].create.zIndex && (e = this.screen.objects[t].create.zIndex),
          this.$O3d[t] &&
            void 0 !== this.$O3d[t].apnCur.zIndex &&
            e < this.$O3d[t].apnCur.zIndex &&
            (e = this.$O3d[t].apnCur.zIndex));
  ...
  (apn.CES.$O4p = function (e, t, a, i, n, r, o, s, p) {
    ...
    for (l = 0; l < d; l++)
      ((c = (l / d) * (2 * Math.PI)),
        ...
        n &&
          ((r[l].x0 = apn.CES.$O5M(e + a / 2 + (s || 0), t + i / 2 + (p || 0), n, r[l].x, r[l].y)),
          (r[l].y = apn.CES.$O5N(e + a / 2 + (s || 0), t + i / 2 + (p || 0), n, r[l].x, r[l].y)),
          (r[l].x = r[l].x0),
          delete r[l].x0));
    return r;
  }),
  (apn.CES._approximate_rrect_to_polygon = function (e, t, a, i, n, r, o, s, p, l, d, c, g) {
    var u,
      h,
      x,
    ...
    if (
      ...
      for (l.push({ x: e + a, y: t + x }), u = 1; u < f; u++)
        ((h = (u / f) * (0.5 * Math.PI)),
          l.push({ x: e + a - x + x * Math.cos(h), y: t + x - x * Math.sin(h) }));
      l.push({ x: e + a - x, y: t });
    } else l.push({ x: e + a, y: t });
    if ((x = n)) {
      for (l[l.length - 1].x != e + x && l.push({ x: e + x, y: t }), u = 1; u < f; u++)
        ((h = (u / f) * (0.5 * Math.PI) + 0.5 * Math.PI),
          l.push({ x: e + x + x * Math.cos(h), y: t + x - x * Math.sin(h) }));
      l.push({ x: e, y: t + x });
    } else l.push({ x: e, y: t });
    if ((x = s)) {
      for (l[l.length - 1].y != t + i - x && l.push({ x: e, y: t + i - x }), u = 1; u < f; u++)
        ((h = (u / f) * (0.5 * Math.PI) + Math.PI),
          l.push({ x: e + x + x * Math.cos(h), y: t + i - x - x * Math.sin(h) }));
      l.push({ x: e + x, y: t + i });
    } else l.push({ x: e, y: t + i });
    if ((x = o)) {
      for (l[l.length - 1].x != e + a - x && l.push({ x: e + a - x, y: t + i }), u = 1; u < f; u++)
        ((h = (u / f) * (0.5 * Math.PI) + 1.5 * Math.PI),
          l.push({ x: e + a - x + x * Math.cos(h), y: t + i - x - x * Math.sin(h) }));
      l[0].y != t + i - x && l.push({ x: e + a, y: t + i - x });
    } else l.push({ x: e + a, y: t + i });
    if (p)
      for (u = 0; u < l.length; u++)
        ((l[u].x0 = apn.CES.$O5M(e + a / 2 + (c || 0), t + i / 2 + (g || 0), p, l[u].x, l[u].y)),
          (l[u].y = apn.CES.$O5N(e + a / 2 + (c || 0), t + i / 2 + (g || 0), p, l[u].x, l[u].y)),
          (l[u].x = l[u].x0),
          delete l[u].x0);
    return l;
  }),
  ...
  (apn.CES.prototype.runITR = function (e, t, a, i) {
    function n() {
      a &&
        (e.target && e.target.objectID && o.wgtTag(e.target.objectID) ? a(e.target.objectID) : a());
    }
    if (
      e &&
      e.target &&
    ...
    this.$O35(e, n, void 0, 'SPT') ||
      this.sptLog('err', apn.CExe.GL(apn.CES.sptERR, 'errAction') + ' (Action=' + e.action + ')');
  }),
    ...
    if (((this.$OcC = a), (i = this.$Oco(e, t)))) {
      if (a.depth > 5)
        return (
          this.sptLog(
            'err',
            apn.CExe.GL(apn.CES.sptERR, 'errLoop') + ' (WidgetID=' + this.$OcB(a.oId) + ')',
          ),
          !0
        );
  ...
  (apn.CES.prototype.sptPageGetVar = function (e, t) {
    if (!e || !e.indexOf || 0 != e.indexOf('$template:'))
      return this.$Ocx && void 0 !== this.$Ocx[e] ? this.$Ocx[e] : t ? void 0 : '';
    e = e.substring(10);
    ...
    if (a && a.apxTdataF)
      for (var i = 0; i < a.apxTdataF.length; i++)
        if (a.apxTdataF[i].id && a.apxTdataF[i].id == e) return a.apxTdataF[i].json.data;
  }),
  (apn.CES.prototype.sptWgtClone = function (e, t, a) {
    ...
    return void 0 === i
      ? (this.sptLog(
          'warn',
          apn.CExe.GL(apn.CES.sptERR, 'notFound') + ' (WidgetID=' + this.$OcB(e) + ')',
        ),
        '')
      : null === i
        ? (this.sptLog(
            'warn',
            apn.CExe.GL(apn.CES.sptERR, 'noSupportClone') + ' (WidgetID=' + this.$OcB(e) + ')',
          ),
          '')
        : i;
  }),
  ...
  (apn.CES.prototype.sptWgtBubbling = function (e, t, a, i) {
    ...
    else n ? r.apxBubblingCtl[n] && delete r.apxBubblingCtl[n] : (r.apxBubblingCtl = {});
  }),
  (apn.CES.prototype.sptWgtGetProp = function (e, t, a, i) {
    ...
    if (!n.create.data || !n.create.data.wgtID)
      return (
        a ||
          this.sptLog(
            'warn',
            apn.CExe.GL(apn.CES.sptERR, 'notFound') + ' (Invalid widget=' + this.$OcB(e) + ')',
          ),
        i ? void 0 : ''
      );
    ...
    if ('state' == t) {
      ...
      if (
        ...
        return apn.Project.getExeStateTitleByObjectID(this.project, this.getPageID(), e, r);
    }
    ...
    if (!s || !s.exeItrNoText) {
      if ('text' == t)
        return (
          apn.Project.resolveStyle(this.project, 'text', this.wgtGetProperty(e, 'apxText')) || ''
        );
      if ('textColor' == t)
        return (
          apn.Project.resolveStyle(
    ...
    if ('lineDash' == t)
      return apn.CES.$OcA(
        apn.Project.resolveStyle(this.project, 'lineDash', this.wgtGetProperty(e, 'apxLineDash')),
      );
    if ('lineWeight' == t)
      return (
        apn.Project.resolveStyle(
    ...
    if ('angle' == t)
      return (
        (o = apn.Project.resolveStyle(this.project, 'angle', this.wgtGetProperty(e, 'apxAngle'))),
    ...
    if (
      'dragX' == t &&
      ((o = apn.Project.resolveStyle(this.project, 'dragX', this.wgtGetProperty(e, 'apxDragX'))),
      o === !0 || o === !1)
    )
      return o;
    if (
      'dragY' == t &&
      ((o = apn.Project.resolveStyle(this.project, 'dragY', this.wgtGetProperty(e, 'apxDragY'))),
      o === !0 || o === !1)
    )
      return o;
    ...
    if ('label' == t)
      return (
        apn.Project.resolveStyle(this.project, 'title', this.wgtGetProperty(e, 'apxLabel')) || ''
      );
    if ('cursor' == t)
      return (
        (o = apn.Project.resolveStyle(this.project, 'csr', this.wgtGetProperty(e, 'apxCursor'))),
  ...
  (apn.CES.prototype.sptWgtSetProp = function (e, t, a, i) {
    function n() {
      ...
      if ('cursor' == t)
        return void r.wgtSetProperty(e, 'apxCursor', 'Aspen/auto' == a ? 'apn.auto' : a);
      ...
      if ('fontSize' == t || 'textItalic' == t || 'textBold' == t || 'textUnderline' == t) {
        ...
        if (!i || !i.exeItrNoText)
          return (
            'fontSize' == t && r.wgtSetProperty(e, 'apxFontSize', bx.$checkNaN(parseInt(a)) + 'px'),
            'textItalic' == t && r.wgtSetProperty(e, 'apxTextItalic', a),
            'textBold' == t && r.wgtSetProperty(e, 'apxTextBold', a),
            void ('textUnderline' == t && r.wgtSetProperty(e, 'apxTextUnderline', a))
          );
      } else if ('font' == t && a) {
        var i = apn.Project.getWidgetModule(r.screen.objects[e].create.data);
        if (!i || !i.exeItrNoText) {
        ...
        if ('x' == t || 'y' == t || 'w' == t || 'h' == t) {
          ...
          if (('w' == t || 'h' == t) && s && s.init.shape.type == bx.CCanvasWnd.SHAPE_RECT) {
            ...
            return (
              'w' == t ? (d = a) : 'h' == t && (c = a),
              void r.$O3i({ action: 'CWP', target: { objectID: e }, set: { size: { w: d, h: c } } })
            );
          }
        } else {
          if ('angle' == t)
            return (
              ...
              void r.$O3i({ action: 'CWP', target: { objectID: e }, set: { angle: a } })
            );
          if ('opacity' == t)
            return void r.$O3i({ action: 'CWP', target: { objectID: e }, set: { alpha: a } });
      ...
      r.sptLog(
        'warn',
        apn.CExe.GL(apn.CES.sptERR, 'noSupportProp') + ' (Widget=' + r.$OcB(e) + ': "' + t + '")',
      );
    }
    var r = this;
    if (
  ...
  (apn.CES.prototype.sptFileGetVar = function (e, t) {
    ...
    if (i && i.apxTdataF)
      for (var n = 0; n < i.apxTdataF.length; n++)
        if (i.apxTdataF[n].id && i.apxTdataF[n].id == e) return i.apxTdataF[n].json.data;
  }),
  ...
  (apn.CES.prototype.sptFileBrowse = function (e, t) {
    ...
    if ('widgets' == e) {
      ...
      if (void 0 === t || !this.project.pages[t])
        return (
          this.sptLog(
            'err',
            apn.CExe.GL(apn.CES.sptERR, 'notFoundPage') + ' (param(pageId)=' + t + ')',
          ),
          r
        );
      var s,
    ...
    if ('scale' == e) return { x: this.viewer.getStretchX(), y: this.viewer.getStretchY() };
    ...
    this.sptLog(
      'err',
      apn.CExe.GL(apn.CES.sptERR, 'noAPIparam') + ' (API=file.browse, key=' + e + ')',
    );
  }),
        ...
        for (var y, v = i.stack.split('at '), C = 0; C < v.length; C++)
          if ((y = v[C].indexOf('<anonymous>')) != -1) {
            ...
            if (b) {
              ...
              (_[1] && (c = parseInt(_[1])),
                _[2] && (g = parseInt(_[2])),
                1 == c && g && (g = Math.max(1, g - this.sptExeIsPreview() ? 95 : 89)));
              var m = v[C].substring(y).match(/[^\/\\\(]*\.js/);
              (m && (u = m[0]), v[C].substring(y).indexOf('run_prv.html') != -1 && (h = !0));
              break;
            }
          }
      } else i && (f = i);
    ...
    (l &&
      ...
      c &&
        (s =
          ...
          ','));
    var S =
        (r || o ? '<span style="color:' + p + '">[' + r + n(o) + ']</span> ' : '') + s + ' ' + n(t),
      P = '[Aspen ' + r + o + ']' + s + ' ' + t;
    (this.viewer.$O3T
      ? this.viewer.$O3T.error(S)
      : !this.viewer.o.standAlone && apn.CExe.sbxExeIF
        ? (apn.CExe.sbxExeIF('onLog', { log: S }), window.console && !c && console.error(P))
  ...
  (apn.CES.prototype.widgetsByLabel = function (e, t, a, i) {
    ...
    return (
      ...
      !a &&
        n.length > 1 &&
        ((n = [n[0]]),
        i || this.sptLog('warn', apn.CExe.GL(apn.CES.sptERR, 'dupSearch') + ' (Label=' + e + ')')),
      n
    );
  }),
  (apn.CES.prototype.widgetsByLabel2 = function (e, t, a, i, n, r) {
    ...
    if (0 == o.length) {
      ...
      n || this.sptLog('err', apn.CExe.GL(apn.CES.sptERR, 'notFound') + ' (Label=' + e + ')');
    }
    return (
      a ||
        i ||
        ...
        (o.length > 1 &&
          ...
          !i &&
          !n &&
          this.sptLog('warn', apn.CExe.GL(apn.CES.sptERR, 'dupSearch') + ' (Label=' + e + ')'),
        (o = o[0])),
      o
    );
  }),
  ...
  (apn.CES.prototype.sptResetPage = function (e) {
    ...
    if (this._inPageCreateEvent)
      return void this.sptLog('warn', apn.CExe.GL(apn.CES.sptERR, 'errLoop') + ' (reset())');
    if (e) {
      var i = apn.CES.$OcD(e),
  ...
  (apn.CES.prototype.pageByLabel = function (e, t) {
    ...
    for (var i = t ? void 0 : '', n = 0, r = 0; r < a.length; r++)
      this.project.pages[a[r]] && this.project.pages[a[r]].UI.title == e && (i || (i = a[r]), n++);
    return (
      n > 1 && this.sptLog('warn', apn.CExe.GL(apn.CES.sptERR, 'dupSearch') + ' (Label=' + e + ')'),
      i
    );
  }),
  ...
  (apn.CES.prototype.sptResolveParam = function (e, t, a, i, n) {
      ...
      if (a) {
        ...
        if ((r && r.ev && (t = r.ev), 'spt_EvtBubble' == t)) {
          ...
          if (
            ...
            (s = apn.P.getEventWgtParam(this, this.project, this.getPageID(), e, t)) &&
              s[t] &&
              s[t].param &&
              s[t].param[a])
          )
    ...
    if (a) {
      ...
      if ((r && r.ev && (t = r.ev), 'spt_EvtBubble' == t)) {
        ...
        if ('spt_Collision' == t || 'spt_CollisionOff' == t) return decodeURIComponent(a);
        if (
          ('wgtEvent' == t && a && (a = decodeURIComponent(a)), s[t] && s[t].param && s[t].param[a])
        )
          return s[t].param[a];
      }
    }
  ...
  (apn.CES.prototype.sptPointerOrigin = function (e) {
    if (this._lastEvTag) {
      ...
      for (
        t = t.parentNode;
        t && t != this.tag && t != this.viewer.getPM().tag && t != this.tag.ownerDocument;
      ) {
        if (t.apnOID && (!t.apnCur || !t.apnCur.Event2Holder)) return t.apnOID;
        t = t.parentNode;
      }
  ...
  (apn.CES.prototype.sptExeCall = function (e, t) {
    return (this.viewer.IStub_sptRunCheck &&
      ...
      ? void this.sptLog(
          'err',
          apn.CExe.GL(apn.CES.sptERR, 'noSupportExeRun') + ' (Function=' + e + ', Param=' + t + ')',
        )
  ...
  (apn.CES.prototype.sptGetLayerID = function (e, t, a) {
    ...
    if ((i = apn.Project.getStateByObjectID(this.project, this.getPageID(), e)))
      for (var r = 0; r < i.length; r++)
        if (i[r].title == t) {
          n = apn.Project.getStateLayerObjectID(this.project, this.getPageID(), e, i[r].stateID);
          break;
        }
    return n
      ? n
  ...
  (apn.CES.prototype.sptFireCustomEvent = function (e, t, a, i, n) {
    function r(t, i) {
      t.fireEvent('spt_Custom', encodeURIComponent(e || ''), i, !0, a, s.getPageID());
    }
    function o() {
      function e(e) {
  ...
  (apn.CES.prototype.sptSizeByContent = function (e, t, a, i, n, r) {
    ...
    if (
      (a.target &&
        ...
        (o = apn.Project.getWidgetModule(this.screen.objects[a.target.objectID].create.data)),
      o && o.exeGetSizeByContent)
    ) {
      var s = o.exeGetSizeByContent(this, a.target.objectID, e, t);
      (s.w || s.h) && ((a.set.sizeBy.w = s.w), (a.set.sizeBy.h = s.h), this.runITR(a, i, n, r));
    } else
      this.sptLog(
        'warn',
  ...
  (apn.CES.prototype.sptSystem = function (e, t, a, i, n) {
    function r() {
      s.viewer.o.exePreview
        ? s.sptLog(void 0, 'extern.set("' + t + '",' + JSON.stringify(a) + ') called.')
        : (o[t] = a);
    }
    var o = n || window;
    if ('run' == e)
      if (this.viewer.o.exePreview)
        this.sptLog(void 0, 'extern.run("' + t + '",' + JSON.stringify(a) + ') called.');
    ...
    if (a.CExe && a.CExe.spt2impt) {
      ...
      if (a.CExe.spt2impt.media)
        for (var n = 0; n < a.CExe.spt2impt.media.length; n++)
          if (((i = a.CExe.spt2impt.media[n]), i.md.mediaID && i.key == t)) return i.md.mediaID;
      if (a.CExe.spt2impt.mediaA)
        for (var n = 0; n < a.CExe.spt2impt.mediaA.length; n++)
          if (((i = a.CExe.spt2impt.mediaA[n]), i.md.mediaID && i.key == t)) return i.md.mediaID;
    }
  }),
  ...
  (apn.CES.prototype.spt2detectCollision = function (e, t) {
    ...
    function i(e, t, a) {
      ...
      for (var s in e)
        ((i = e[s].apnOID || e[s].oId || e[s].id || e[s]),
          o.$O3d[i] && apx.wgt.$O4u(o, t, o.$O3d[i], void 0, !0, r) && ((n = n || []), n.push(i)));
      return n;
    }
    function n(e, t, a, i) {
    ...
    if ('string' == typeof e) this.wgtTag(e) && (s = e);
      ...
      if (e.type || void 0 === e.x || void 0 === e.y)
        if (
          ...
          if (2 == e.vertex.length) ((p = { type: 'poly', pts: [] }), n(p.pts, e.vertex, 2));
          else {
            ((p = { type: 'polySet', polygons: [], pts: [] }), n(p.pts, e.vertex));
            for (var l = 0; l < e.vertex.length - 1; l++)
              ((p.polygons[l] = p.polygons[l] || []), n(p.polygons[l], e.vertex, l + 2, l));
          }
        else
          'polygon' == e.type &&
            e.vertex &&
    ...
    t && t.target
      ...
      : t && t.all
        ? (d = this.$O3d)
        : this._apxColDectect && this._apxColDectect.length && (d = this._apxColDectect);
    var c = null;
    return (
      d &&
        (s
          ...
          : p
            ? (c = i(d, p))
            : this.sptLog('warn', "Invalid 'area' is passed for Widget:detectCollision.")),
      c
    );
  }),
      ...
      : 'Mouse Over' == t
        ...
        : 'Collision' == t
          ...
          : 'Content Change' == t
            ...
            : this.sptLog('warn', 'Unsupported event type="' + t + '" for Widget:acceptEvent.');
  }),
  ...
  (apn.CES.prototype.sptEval = function (ev, oId, stack, _cbExRun) {
    var pageId = this.getPageID(),
      src = this.$Oco(ev, oId);
    if (
      (void 0 === this.isSptCanVer2 && (this.isSptCanVer2 = apn.Project.sptCanVer2(this.project)),
      src || _cbExRun)
    ) {
      if (
        ((this.scriptEvals = this.scriptEvals || __setScriptRunIf()),
        (this.scriptStubs = this.scriptStubs || this.scriptEvals.getEvalStubs()),
        stack.depth > 5)
      )
        return (
          this.sptLog(
            'err',
            apn.CExe.GL(apn.CES.sptERR, 'errLoop') + ' (WidgetID=' + this.$OcB(stack.oId) + ')',
          ),
          !0
        );
      ...
      if (_cbExRun) {
        if (this.sptExeIsPreview()) {
          ...
          (this.sptLogStack(commonEvent), _cbExRun.call(scriptStubs, commonEvent, scriptStubs));
        this.sptLogStack();
      } else
        with (scriptStubs)
          if (this.isSptCanVer2) {
            ...
            var funcName =
              'sptFunc_' + (pageId || 'page') + '_' + (runOId || 'object') + '_' + runEvt;
  ...
  (apn.CExeSpt2.prototype.$P = function (e, t) {
    var a = apn.Project.getPages(this.project, void 0, void 0, t && t.all ? { all: !0 } : void 0);
    if ('*' == e) {
      for (var i = [], n = 0; n < a.length; n++) i.push(new apn.CExeSpt2Page(this, a[n]));
      return i;
    }
  ...
  (apn.CExeSpt2.prototype.addPage = function (e, t, a) {
    return e
      ? apn.Project.$O8R(this.project, void 0, t || '', e.data, e.id, void 0, !0)
  ...
  (apn.CExeSpt2Page.prototype.$W = function (e, t, a) {
    ...
    if (i.length) {
      if (a && a.like) {
        for (var n = [], r = 0; r < i.length; r++) n.push(new apn.CExeSpt2Wgt(this, i[r]));
        return n;
      }
  ...
  (apn.CExeSpt2Page.prototype.addWidget = function (e) {
    if (e && e.module && e.create) {
      ...
      for (var n in i.objects)
        ((void 0 === t || t < i.objects[n].create.zIndex) && (t = i.objects[n].create.zIndex),
      ...
      (t ? t++ : (t = bx.CCanvasWnd.ZINDEX_OBJECT),
        ...
        (e.init.shape = e.init.shape || { type: bx.CCanvasWnd.SHAPE_RECT, w: 64, h: 64 }),
  ...
  (apn.CExeSpt2Wgt.prototype.clone = function (e, t) {
    ...
    return (
      n || console.error('[AspenUX] srcCloneWidget failed. WidgetID=' + this.id),
  ...
  (apn.CExeSpt2Wgt.prototype.cloneLayer = function (e, t) {
    if (!e || !t)
      return void apn.CExeSpt2.log(
        " cloneLayer() - Invalid parameter. layerID='" + e + "' or newLabel='" + t + "'",
      );
    var a = this.page.data.project.pages[this.page.id];
    if (!a.objects[e])
      return void apn.CExeSpt2.log(" cloneLayer() - Layer is not found. layerID='" + e + "'");
    if (!a.objects[this.id].layout || !a.objects[this.id].layout.layers)
      return void apn.CExeSpt2.log(' cloneLayer() - This wdiget is not a contianer layer.');
  ...
  (apn.CExeSpt2Wgt.prototype.getLayer = function (e) {
    ...
    if ((t = apn.Project.getStateByObjectID(i, this.page.id, this.id)))
      for (var n = 0; n < t.length; n++)
        if (t[n].title == e) {
          a = apn.Project.getStateLayerObjectID(i, this.page.id, this.id, t[n].stateID);
          break;
        }
  ...
  (apn.CExeSpt2Wgt.prototype.put = function (e, t) {
    ...
    if (!e || !a.objects[e.id].layout || !a.objects[e.id].layout.layers)
      return (apn.CExeSpt2.log(' put() - Parent wdiget is not a contianer layer.'), !1);
    ...
    return void 0 !== t && a.objects[t]
      ? ((a.objects[t].layout = a.objects[t].layout || {}),
        ...
        !0)
      : (apn.CExeSpt2.log(" put() - Layer is not found. parentLayerID='" + t + "'"), !1);
  }),
  ...
  (apn.CExeSpt2Wgt.prototype.set = function (e, t) {
    ...
    switch (e) {
      ...
      case 'w':
        ((t = Math.round(t)),
          n.init.shape.type == bx.CCanvasWnd.SHAPE_RECT && t > 0 && (n.init.shape.w = t));
        break;
      case 'h':
        ((t = Math.round(t)),
          n.init.shape.type == bx.CCanvasWnd.SHAPE_RECT && t > 0 && (n.init.shape.h = t));
        break;
      default:
  ...
  (apx.$O4s = function (e, t, a, i, n, r, o, s) {
    function p(e, i, n, d) {
      if (0 != n)
        if (void 0 === a) i.create.data && i.create.data.wgtID && r.push(e);
        else if (1 == t && i.create.data && i.create.data.wgtID && i.create.data.wgtID == a)
          r.push(e);
        else if (
          2 == t &&
          i.create.data &&
          ...
          r.push(e);
        else if (4 == t && i.create.data && i.create.data.styles && i.create.data.styles[a] == o)
          r.push(e);
        else if (
          5 == t &&
          i.create.data &&
      ...
      if (!d && i.layout && i.layout.children)
        for (var g, u = 0; u < i.layout.children.length; u++)
          ((g = apn.Project.getWidgetModule(l.objects[i.layout.children[u]].create.data)),
            p(
              i.layout.children[u],
              l.objects[i.layout.children[u]],
              n + 1,
              (g && g.BLACKBOX_MODEL) ||
                (s && apn.Project.checkStateType(l.objects[i.layout.children[u]].layout)),
            ));
    }
    r ? (r.length = 0) : (r = []);
    var l;
    if (
      (window.apn && apn.CES && e instanceof apn.CES ? (l = e.screen) : ((l = e), (e = null)),
      n && e)
    ) {
      if (!l.objects[n])
        return (bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + n, 'searchWidgets'), r);
      for (var d in e.$O3d)
        d != n &&
          e.$O3d[d].parentNode == e.$O3d[n].parentNode &&
          (void 0 === a && l.objects[d].create.data && l.objects[d].create.data.wgtID
            ? r.push(d)
            : 1 == t && l.objects[d].create.data && l.objects[d].create.data.wgtID == a
              ? r.push(d)
              : 2 == t &&
    ...
    if (i) {
      if (!l.objects[i])
        return (bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + i, 'searchWidgets'), r);
      p(i, l.objects[i], 0);
    }
    if (!i && !n)
  ...
  (apx.wgt.$O4l = function (e, t) {
    function a(a, i) {
      if (i.frames.length > 1) {
        ...
        return (e.wgtAniSet(a, i.states[0], i.frames[0], 0, !0), (i.lastTime = t), i.lastTime);
      return 0;
    }
    if (e.__spriteLoop) {
      var i, n, r;
      for (var o in e.__spriteLoop)
        if (((n = e.__spriteLoop[o]), n && n.length))
          if (n.apxCur != -1) {
            if (void 0 === n.apxCur) {
              for (r = 0; r < n.length; r++) e.wgtAniSet(o, n[r].states[0], n[r].frames[0], 0, !0);
              n.apxCur = 0;
            }
            (i = a(o, n[n.apxCur])) &&
              (n.apxLoop
                ? ((n.apxCur = (n.apxCur + 1) % n.length), (n[n.apxCur].lastTime = i))
                : n.apxCur < n.length - 1
  ...
  (apx.wgt.$O4u = function (e, t, a, i, n, r) {
    ...
    function s(e, t, a) {
      if ('poly' == a.type)
        for (var i = 0; i < a.pts.length; i++) ((a.pts[i].x -= e), (a.pts[i].y -= t));
    ...
    function p(t, a, i) {
      function r(e, t, a) {
        for (var i, n, r = p + u / 2 + d, o = l + h / 2 + c, s = 0; s < e.length; s++)
          ((i = p + e[s].x * u),
            (n = l + e[s].y * h),
            g
              ? a
                ? ((t[s].x = apn.CES.$O5M(r, o, g, i, n)), (t[s].y = apn.CES.$O5N(r, o, g, i, n)))
                : t.push({ x: apn.CES.$O5M(r, o, g, i, n), y: apn.CES.$O5N(r, o, g, i, n) })
              : a
                ? ((t[s].x = i), (t[s].y = n))
                : t.push({ x: i, y: n }));
      }
      ...
      if (1 == s) {
        var u = a.init.shape.w,
          ...
          x = 0;
        if (
          (('bx.CEditorWnd.CEllipse' != a.module && 'apn.CEllipse' != a.module) || (x = 1),
          g || 0 != x)
        ) {
          var f;
          if (0 == x) {
            ...
            apn.CES.$O4p(p, l, u, h, g || 0, f.pts, 2 * Math.ceil(Math.max(u, h) / 5), d, c);
          }
          return f;
        }
        if ('poly' == i) {
          ...
          if (n) {
            if (!t.apnCur.apxColDectectOn && t.apnCur.apxColDectectGeoP)
              return t.apnCur.apxColDectectGeoP;
            ((t.apnCur.apxColDectectGeoP = t.apnCur.apxColDectectGeoP || { type: 'poly', pts: [] }),
              (f = t.apnCur.apxColDectectGeoP));
          } else f = { type: 'poly', pts: [] };
          return (
            (f.pts[0] = f.pts[0] || {}),
      ...
      if (3 == s || 4 == s) {
        ...
        if (4 == s) {
          if (n) {
            ...
            ((t.apnCur.apxColDectectGeoPS = { type: 'polySet', polygons: [], pts: [] }),
          ...
          if (o.polygon && o.polygon.length > 1) {
            ...
            for (var I = 0; I < o.polygon.length - 1; I++) {
              if (C > 1) {
                ...
                ((b = o.polygon[I].x),
                  (_ = o.polygon[I].y),
                  (m[0].x = apn.CES.$O5M(b, _, -(Math.PI / 2 - S), b, _ - C / h)),
                  (m[0].y = apn.CES.$O5N(b, _, -(Math.PI / 2 - S), b, _ - C / h)),
                  ...
                  (m[3].x = apn.CES.$O5M(b, _, -(Math.PI / 2 - S), b, _ - C / h)),
                  (m[3].y = apn.CES.$O5N(b, _, -(Math.PI / 2 - S), b, _ - C / h)));
              } else
                ((m = f.polygons[I] = f.polygons[I] || []),
                  (m[0] = m[0] || {}),
                  (m[1] = m[1] || {}),
          ...
          'apn.CPolycurve' == a.module && t.ctx
            ? (t.ctx.curve || apn.widgets['apn.wgt.polygon'].exeDetect(e.project, t, a, 0, 0, 0),
              r(t.ctx.curve, f.pts))
    ...
    (l && (n = !1),
      ((t.apnCur && t.apnCur.apxColDectectNoOpti) || (a.apnCur && a.apnCur.apxColDectectNoOpti)) &&
        (n = !1));
    var d, c, g, u;
    if (t.apnOID) {
    ...
    if (((i = i || 0), l)) {
      ...
      ((h = e.toCanvasY(h)), (x = e.toCanvasY(x)), (f = e.toCanvasX(f)), (y = e.toCanvasX(y)));
    } else
      var h = 0,
        x = 0,
        f = 0,
    ...
    if (
      (g
        ? ((t.apnCur.apxColDectectGeoBndR = t.apnCur.apxColDectectGeoBndR || { type: 'rect' }),
          (v = t.apnCur.apxColDectectGeoBndR))
        : (v = { type: 'rect' }),
      o(d.pts, v),
      (a.apnCur.apxColDectectGeoBndR = a.apnCur.apxColDectectGeoBndR || { type: 'rect' }),
...
((apn.CES.prototype.getWidgetsByProperty = apn.CES.prototype.widgetsByProperty),
  ...
  (apn.CES.prototype.localMediaURL = function (e, t, a) {
    if (!this || !this.screen || !this.screen.objects[e])
      return void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'localMediaURL');
    if (this.screen.objects[e].create.data && this.screen.objects[e].create.data.wgtID) {
      if (this.viewer.o.standAlone)
        return 'wgts/' + this.screen.objects[e].create.data.wgtID + '/' + (a || 'imgs') + '/' + t;
    ...
    var n =
      (i
        ? '<span style="color:#ffffff">[' +
          a(i + (this.screen.UI && this.screen.UI.title ? ' in ' + this.screen.UI.title : '')) +
          ']</span> '
        : '') + a(t);
    this.viewer.$O3T
      ? this.viewer.$O3T.error(n)
      : !this.viewer.o.standAlone && apn.CExe.sbxExeIF && apn.CExe.sbxExeIF('onLog', { log: n });
  }),
  (apn.CES.prototype.devError = function (e) {
    bx.Log.isActive() &&
      ...
      (e && this.screen.objects[e] && this.screen.objects[e].create.data
        ? (arguments[0] = '[' + this.screen.objects[e].create.data.wgtTitle + ']')
        : (arguments[0] = '[APX]'),
  ...
  (apn.CES.prototype.fireEvent = function (e, t, a, i, n, r, o) {
    ...
    if (this.viewer.isRunning() || this.viewer._apxPassEventIfExeStop) {
      if (apn.P.eventTitle[e]) {
        if (
          this.isPaused() &&
          !(i || ('media' == e && 'Pause' == t) || (t && t.indexOf && 0 == t.indexOf('$APX')))
        )
          return;
        p = !0;
      }
  ...
  (apn.CES.prototype.$OcI = function (e, t, a) {
    ...
    if (
      ...
      this.$O4i[e]
        ? (l = !0)
        : ((this.$O4i[e] = {}),
          (this.$O4i[e].tag = this.tag.$TAG('audio', { style: 'display:none;' })),
        ...
        l ||
          (s._apxPlayList
            ...
            : ((s.onerror = s.onabort =
                function (e) {
                  if (
                    ('ended' == e.type || 'error' == e.type || 'pause' == e.type) &&
                    this.$O5g &&
                    this.$O7X
                  ) {
                    this.$O7X = !1;
  ...
  (apn.CES.prototype.wgtCloneLayer = function (e, t, a) {
    function i(e) {
      ...
      if (
        ...
        for (var a = 0; a < t.layout.children.length; a++) i(t.layout.children[a]);
    }
  ...
  (apn.CES.prototype.wgtClone = function (e, t, a) {
    ...
    var n = this.screen.objects[e];
    if (!n) return void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtClone');
    if (!(n && n.create.data && n.create.data.wgtID))
      return (bx.Trace.log('APX', 'warning', 'Invalid widget id=' + e, 'wgtClone'), null);
    var r = this.screen.objects[t];
    if (t && (!r || !r.layout || !r.layout.layers))
      return (bx.Trace.log('APX', 'warning', 'Invalid parent widget id=' + e, 'wgtClone'), null);
    var o;
    if (t) {
  ...
  (apn.CES.prototype.$OcJ = function (e) {
    ...
    if (((this.screen.objects[a] = bx.$cloneObject({}, t)), this.project.property.denyCloneLocal)) {
      ...
      i && i.properties && i.properties.$apxLocal && delete i.properties.$apxLocal;
    }
    return a;
  }),
  ...
  (apn.CES.prototype.$OcL = function (e, t, a) {
    ...
    for (i in a) {
      this.$Ocu(a[i]);
      var n = apn.Project.getWidgetModule(this.screen.objects[a[i]].create.data);
      if (n) {
  ...
  (apn.CES.prototype.wgtGetProperty = function (e, t, a) {
    if (!this || !this.screen || !this.screen.objects[e])
      return void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtGetProperty');
    var i = this.screen.objects[e].create.data,
      n = apn.Project.getWidgetModule(i);
    if (n && n.exePropGet && n.exePropGet(this, e, t, !0)) return n.exePropGet(this, e, t);
    if (apx.wgt.$O4y[t]) {
      if (i && i.styles)
        return a
          ? apn.Project.resolveStyle(this.project, apx.wgt.$O4y[t], i.styles[apx.wgt.$O4y[t]], !0)
      ...
      if (
        ...
        ('apxLocal' == t &&
          ...
          (i.properties[apx.wgt.$O4z[t]] = i.properties[apx.wgt.$O4z[t]] || {})),
        i.properties)
      )
      ...
      if (
        'apxLayer' == t &&
        2 == apn.Project.checkStateTypeByObjectID(this.project, this.getPageID(), e)
      )
        return this.$O3l(e, !0);
    } else if (i && i.properties && i.properties.attrs) return i.properties.attrs[t];
  }),
  (apn.CES.prototype.wgtSetProperty = function (e, t, a, i, n) {
    if (!(this && this.screen && this.screen.objects[e] && this.screen.objects[e].create.data))
      return void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtSetProperty');
      ...
      if (((r.styles = r.styles || {}), (r.styles[apx.wgt.$O4y[t]] = a), !i)) {
        ...
        if ('apxText' == t) apn.IWidget.exeSetText(s, a);
          ...
          (apn.IWidget.exeSetLine(
            s,
            apn.Project.resolveStyle(this.project, 'lineWidth', r.styles.lineWidth),
            apn.Project.resolveStyle(this.project, 'strokeStyle', r.styles.strokeStyle),
            1 / this.getZoomX(),
            this,
          ),
            apn.IWidget.exeSetLineDash(
              s,
              apn.Project.resolveStyle(this.project, 'lineDash', r.styles.lineDash),
              this,
            ));
        else if ('apxFillStyle' == t)
          apn.IWidget.exeSetFillStyle(
            s,
            apn.Project.resolveStyle(this.project, 'fillStyle', r.styles.fillStyle),
            this,
          );
          ...
          apn.IWidget.$Obv(
            s,
            apn.Project.resolveStyle(this.project, 'fontSize', r.styles.fontSize),
            1 / this.getZoomY(),
          );
          var p = this.wgtGetProperty(e, 'apxText') || '';
          ((s.apnCur.forced = !0),
          ...
          var l;
          if (
            (this.viewer._loadedFontList && this.viewer._loadedFontList[r.styles.font]
              ? (l = !1)
              : (this.viewer.$O4Z(), (l = !0)),
            (s.style.fontFamily = apn.Project.resolveStyle(this.project, 'font', r.styles.font)),
            !l)
          ) {
            var o = apn.Project.getWidgetModule(r);
            o && o.exeOnScreenRefresh && o.exeOnScreenRefresh(this, e, { font: r.styles.font });
          }
        } else if ('apxTextItalic' == t || 'apxTextBold' == t || 'apxTextUnderline' == t) {
          'apxTextItalic' == t
            ? apn.IWidget.$Obx(
                s,
                apn.Project.resolveStyle(this.project, 'fontItalic', r.styles.fontItalic),
              )
            : 'apxTextBold' == t
              ? apn.IWidget.$Obw(
                  s,
                  apn.Project.resolveStyle(this.project, 'fontBold', r.styles.fontBold),
                  apn.Project.resolveStyle(this.project, 'font', r.styles.font),
                )
              : 'apxTextUnderline' == t &&
                apn.IWidget.$Oby(
                  s,
                  apn.Project.resolveStyle(this.project, 'fontUnderlined', r.styles.fontUnderlined),
                );
          var p = this.wgtGetProperty(e, 'apxText') || '';
    ...
    if (this.$O4m && this.$O4m.length)
      for (var i, n = 0; n < this.$O4m.length; n++)
        ((i = !1),
          ...
          (i || this.$O4m[n].always) && this.$O4m[n].key == e && this.$O4m[n].handler(t, a));
  }),
    ...
    if (
      ...
      for (var n = 0; n < this._apxColDectect.length; n++)
        if (this._apxColDectect[n].oId == e)
          return void (this._apxColDectect[n].disabled && delete this._apxColDectect[n].disabled);
      this._apxColDectect.push({ oId: e });
    } else
      for (var n = 0; n < this._apxColDectect.length; n++)
        this._apxColDectect[n].oId == e && (this._apxColDectect[n].disabled = !0);
  }),
  (apn.CES.prototype.wgtTag = function (e, t) {
    return this.$O3d[e]
      ? this.$O3d[e]
      : void (t || bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtTag'));
  }),
  ...
  (apn.CES.prototype.wgtControlMedia = function (e, t, a, i) {
    if (!this.$O3d[e])
      return (bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtControlMedia'), !1);
    var n = apn.Project.getWidgetModule(this.screen.objects[e].create.data);
    switch (t) {
      case 'play':
      case 'resume':
        if (n && n.exeMediaPlay) return (n.exeMediaPlay(this.$O3d[e], 'resume' != t, a, i), !0);
        break;
      case 'pause':
      ...
      case 'stop':
        ...
        break;
      case 'mute':
        if (n && n.exeMediaControl) return (n.exeMediaControl(this.$O3d[e], 'mute', !0), !0);
        break;
      case 'muteOff':
        if (n && n.exeMediaControl) return (n.exeMediaControl(this.$O3d[e], 'mute', !1), !0);
        break;
      default:
  ...
  (apn.CES.prototype._videoReqFullScreen = function (e, t) {
    ...
    !this.wgtGetMediaInfo(e, 'supportFullScreenControl') && i && i.oId && (a = !0);
        ...
        : n.webkitRequestFullscreen
          ? (t ||
              (a && this.wgtTag(i.oId)
                ...
                : ('edge' != bx.HCL.DV.getBrowserType() || n.controls || (n.controls = !0),
                  n.webkitRequestFullscreen())),
            !0)
          : n.requestFullscreen
  ...
  (apn.CES.prototype.wgtSetMediaInfo = function (e, t, a) {
    if (!this.$O3d[e])
      return (bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtSetMediaInfo'), !1);
    ...
    return !(!i || !i.exeMediaControl) && (i.exeMediaControl(this.$O3d[e], t, a), !0);
  }),
  (apn.CES.prototype.wgtGetMediaInfo = function (e, t) {
    if ('supportFullScreenControl' == t) return 'edge' != bx.HCL.DV.getBrowserType();
    if (!this.$O3d[e])
      return void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtGetMediaInfo');
  ...
  (apn.CES.prototype.wgtListenMediaCancel = function (e, t) {
    ...
    for (var a = 0; a < this.$O4j.length; a++)
      this.$O4j[a].oId == e && this.$O4j[a].mediaWidgetId == t && (this.$O4j.splice(a, 1), a--);
  }),
  (apn.CES.prototype.wgtListenContext = function (e, t, a, i, n) {
    if (
      ...
      this.viewer.$O3V.push({ oId: e, pId: this.wgtTag(e).apnPID, key: t, handler: a, always: i });
  }),
  (apn.CES.prototype.wgtListenProperty = function (e, t, a, i, n) {
    if (((this.$O4m = this.$O4m || []), 'apn.COverlayPage' == this.screen.module && (i = !0), n))
      for (var r = 0; r < this.$O4m.length; r++)
        this.$O4m[r].oId == e &&
          this.$O4m[r].key == t &&
          this.$O4m[r].handler == a &&
          (this.$O4m.splice(r, 1), r--);
    else this.$O4m.push({ oId: e, pId: this.wgtTag(e).apnPID, key: t, handler: a, always: i });
  }),
  (apn.CES.prototype.wgtListenPageEvent = function (e, t, a, i, n) {
    if (((this.$O4n = this.$O4n || []), 'apn.COverlayPage' == this.screen.module && (i = !0), n))
      for (var r = 0; r < this.$O4n.length; r++)
        this.$O4n[r].oId == e &&
          this.$O4n[r].event == t &&
          this.$O4n[r].handler == a &&
          (this.$O4n.splice(r, 1), r--);
    else this.$O4n.push({ oId: e, pId: this.wgtTag(e).apnPID, event: t, handler: a, always: i });
  }),
  (apn.CES.prototype.wgtListenBubbleEvent = function (e, t, a, i) {
    if (((this._apxEventListenBubble = this._apxEventListenBubble || []), i))
      ...
      this._apxEventListenBubble.push({ oId: e, pId: this.wgtTag(e).apnPID, event: t, handler: a });
  }),
  ...
  (apn.CES.prototype.tagX = function (e, t) {
    return (
      ...
      parseFloat(t) + (bx.HCL.getElementX2(e.parentNode) - bx.HCL.getElementX2(this.tag))
    );
  }),
  (apn.CES.prototype.tagY = function (e, t) {
    return (
      void 0 === t && (t = e.style.top),
      parseFloat(t) + (bx.HCL.getElementY2(e.parentNode) - bx.HCL.getElementY2(this.tag))
    );
  }),
  ...
  (apn.CES.prototype.wgtAniRun = function (e, t) {
    ...
    function i(t, i, n, o) {
      ...
      if (1 == apn.Project.checkStateType(s)) {
        ...
        for (l.sort(a), d = 0; d < l.length; d++)
          (p.frames.push(apn.Project.getStateTitleByObjectID(r.project, r.$O1m, i, l[d].id)),
            p.states.push(t),
            p.durations.push(
    ...
    if (!(this && this.screen && this.screen.objects[e] && this.$O3d[e]))
      return void bx.Trace.log('APX', 'warning', 'Invalid widget id=' + e, 'wgtAniRun');
    var n;
  ...
  (apn.CES.prototype.wgtAniCheck = function (e, t, a, i) {
    if (!this.screen.objects[e] || !this.$O3d[e])
      return (bx.Trace.log('APX', 'warning', 'Invalid widget id=' + e, 'wgtAniCheck'), 0);
    ...
    if (void 0 !== t && 2 == apn.Project.checkStateType(this.screen.objects[e].layout))
      for (n in this.screen.objects[e].layout.layers)
        this.screen.objects[e].layout.layers[n].title == t &&
          ((o = !0), (r = this.screen.objects[e].layout.layers[n].id), i && (i.stateID = n));
    if (o) {
      var s,
        p = this.screen.objects[r].layout;
      for (n = 0; n < p.children.length; n++)
        if (apn.Project.checkStateType(this.screen.objects[p.children[n]].layout)) {
          s = p.children[n];
          break;
        }
      if (!s) return 1;
    ...
    if (1 == apn.Project.checkStateType(d))
      for (n in d.states)
        ((apn.Project.getStateTitleByObjectID(this.project, this.$O1m, e, n) != a &&
          void 0 !== a) ||
          (void 0 === l && (l = n)),
          c++);
    else if (2 == apn.Project.checkStateType(d)) {
      void 0 === a && (l = this.screen.objects[e].create.data.styles.state);
      for (n in d.layers) (d.layers[n].title == a && void 0 === l && (l = n), c++);
    }
  ...
  (apn.CES.prototype.wgtAniSet = function (e, t, a, i, n) {
    ...
    if (this.wgtAniCheck(e, t, a, o)) {
      if (
        (n ||
          (this.$O3d[e].apxSpriteCtxt &&
            ((this.$O3d[e].apxSpriteCtxt.apxCur != -1 || this.$O3d[e].apxSpriteCtxt.apxEndTime) &&
              this.fireEvent('animation', 'End', e),
            delete this.$O3d[e].apxSpriteCtxt,
            this.__spriteLoop && this.__spriteLoop[e] && delete this.__spriteLoop[e])),
        ...
        if (1 == apn.Project.checkStateType(this.screen.objects[e].layout)) {
          var s = { action: 'CWS', target: { pageID: this.$O1m, objectID: e, stateID: o.frameID } };
  ...
  (apn.CES.prototype.wgtIntersectWith = function (e, t, a, i, n) {
    ...
    if (
      ...
      for (var r = 0; r < this.wgtIntersectWith.$O4C.length; r++)
        apx.wgt.$O4u(this, this.wgtTag(t), this.wgtTag(this.wgtIntersectWith.$O4C[r]), n) ||
  ...
  (apn.CES.prototype.srcCloneWidget = function (e) {
    return this.screen && this.screen.objects[e]
      ...
      : void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'srcCloneWidget');
  }),
  (apn.CES.prototype.srcAddWidget = function (e, t, a) {
    if (!this.screen || !this.screen.objects[e])
      return void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'srcAddWidget');
    ((this.screen.$O4x = this.screen.$O4x || 0), this.screen.$O4x++);
    var i = {
      create: {
        data: { properties: {}, styles: { visibility: !1 }, wgtID: t, wgtTitle: '' },
        style: {},
      },
      init: {
        position: {
    ...
    if (
      ...
      ((this.screen.objects[r].layout = this.screen.objects[r].layout || {}),
        (this.screen.objects[r].layout.children = this.screen.objects[r].layout.children || []),
  ...
  (apn.CES.prototype.srcSetWidgetStyle = function (e, t, a) {
    if (!this.screen || !this.screen.objects[e])
      return void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'srcSetWidgetStyle');
    var i = this.screen.objects[e].create;
    ((i.data = i.data || {}), (i.data.styles = i.data.styles || {}), (i.data.styles[t] = a));
  }),
  (apn.CES.prototype.srcGetWidgetStyle = function (e, t) {
    return this.screen && this.screen.objects[e]
      ? this.screen.objects[e].create.data && this.screen.objects[e].create.data.styles
        ? apn.Project.resolveStyle(this.project, t, this.screen.objects[e].create.data.styles[t])
        : void 0
      : void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'srcGetWidgetStyle');
  }),
  (apn.CES.prototype.srcSetWidgetProperty = function (e, t, a) {
    return this && this.screen && this.screen.objects[e] && this.screen.objects[e].create.data
      ? apx.wgt.$O4y[t]
      ...
      : void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'srcSetWidgetProperty');
  }),
  ...
  (apn.CES.prototype.tagPassPointerEvent = function (e, t, a) {
    ((e.apnPassPointerEvent = t),
      ...
      a || (t ? (e.style.pointerEvents = 'none') : (e.style.pointerEvents = 'auto')),
  ...
  (apn.CES.prototype.tagTransform = function (e, t, a, i) {
    ...
    if (
      ...
      (t.element = e),
      apn.CES.toBxTiming(t.timing, !0) && (t.timing = apn.CES.toBxTiming(t.timing)),
    ...
    if (!a && s.parentNode && s.parentNode.parentNode && this.wgtId(s.parentNode.parentNode)) {
      ...
      if (2 == apn.Project.checkStateType(p[g].layout)) {
        ...
        for (d in p[g].layout.layers)
          x.push({ id: d, objectID: p[g].layout.layers[d].id, order: p[g].layout.layers[d].order });
        for (apn.UTIL.sort(x, 'order', 1, !0), l = 0; l < x.length; l++)
          if (x[l].objectID == h) ((o.index = o.count), o.count++);
          else if (p[x[l].objectID].layout && (u = p[x[l].objectID].layout.children))
            for (d = 0; d < u.length; d++)
              if (
                ...
                c &&
                  c.wgtID == r &&
                  (!t ||
                    (c.properties && c.properties.attrs && c.properties.attrs[t.key] == t.value)))
              ) {
                o.count++;
                break;
              }
    ...
    for (l = 0; l < v.length; l++) {
      ...
      for (d in this.project.pages[v[l]].objects)
        ((c = this.project.pages[v[l]].objects[d].create.data),
          c &&
            c.wgtID == r &&
            (!t || (c.properties && c.properties.attrs && c.properties.attrs[t.key] == t.value)) &&
            (f = !0));
  ...
  (apn.CES.prototype.utlRunInteractionOf = function (e, t) {
    return this.$O3d[e]
      ...
      : void bx.Trace.log('APX', 'warning', 'Invalid widget id=' + e, 'utlRunInteractionOf');
  }),
  ...
  (apn.CES.prototype.netListen = function (e, t, a) {
    ...
    return (i = this.$O3d[e])
      ...
      : (bx.Trace.log('APX', 'warning', 'Invalid widget id=' + e, 'netListen'), 0);
  }),
  ...
  (apx.cloneContainerWidget = function (e) {
    ...
    return (
      ...
      (e || apx.wgtLayer).apxUI && (t.apxUI = bx.$cloneObject([], (e || apx.wgtLayer).apxUI)),
      t
    );
  }),
  ...
  (apx.wgtLayer.exeCreateTag = apn.widgets['apn.wgt.layerContainer'].exeCreateTag),
  (apx.wgtLayer.exeRenderTag = apn.widgets['apn.wgt.layerContainer'].exeRenderTag),
    ...
    if (i && i.apxUI) {
      for (var n, r = {}, o = 0; o < i.apxUI.length; o++)
        if (
          ...
          for (n = 0; n < i.apxUI[o].wgtClass.length; n++) r[i.apxUI[o].wgtClass[n]] = !0;
      var s = [];
      for (n in r) s.push(n);
  ...
  (apn.CExe.prototype.apxDispatchMessage = function (e, t) {
    function a(a) {
      if (a.canvas) {
        var n = !1;
        (i.isCurrentPage(a.id) && (n = !0), a.canvas._inPagePauseEvent && (n = !0));
  ...
  (apn.CES.prototype.wgtPageId = function (e) {
    return this.$O3d[e]
      ? this.$O3d[e].apnPID
      : void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtPageId');
  }),
  (apn.CES.prototype.wgtPageTitle = function (e) {
    return this.$O3d[e] && this.$O3d[e].apnPID
      ...
      : void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtPageTitle');
  }),
  (apn.CES.prototype.wgtDelayLinkToPage = function (e, t) {
    return this.$O3d[e]
      ? void (this.$O5e = t)
      : void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtDelayPageLink');
  }),
  (apn.CES.prototype.utlFindClosest = function () {
    function e(e, t, a) {
      var i = Math.abs(parseInt(a.style.left) + 0.5 * parseInt(a.style.width) - e),
        n = Math.abs(parseInt(a.style.top) + 0.5 * parseInt(a.style.height) - t);
  ...
  (apn.CES.prototype.utlGetPageWith = function (e) {
    function t(e, t) {
      return void 0 === s.project.pages[e].UI.order && void 0 === s.project.pages[t].UI.order
        ? 0
  ...
  (apn.CES.prototype.wgtToScreenX = function (e, t) {
    return this.$O3d[e]
      ...
      : void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtToScreenX');
  }),
  (apn.CES.prototype.wgtToScreenY = function (e, t) {
    return this.$O3d[e]
      ? apn.widgets.utils.$O2y(this, this.$O3d[e], t, 1 / this.getZoomY())
      : void bx.Trace.log('APX', 'warning', 'Non-exist widget id=' + e, 'wgtToScreenY');
  }),
  ...
  (apn.CES.prototype.utlAllocCanvas = function (e, t, a) {
    ...
    return (
      this.viewer.$O5m[e] ||
        ((this.viewer.$O5m[e] = $TAG('canvas', { style: 'position:absolute;' })),
  ...
  (apn.CES.prototype.pageRun = function (e, t, a) {
    if (this.project && this.project.pages[e]) {
      var i = { action: 'LTP', to: { pageID: e, reset: a }, transit: t || { effect: 'none' } };
      this.viewer.run(i);
    }
  }),
    ...
    if (n)
      for (var r = 0; r < this.screen.objects[n].layout.children.length; r++)
        this.screen.objects[n].layout.children[r] != e &&
          ((i = this.screen.objects[this.screen.objects[n].layout.children[r]].create),
          i.data &&
            i.data.properties &&
  ...
  (apn.CES.prototype.wgtVolumeMedia = function (e, t) {
    return this.$O3d[e] && this.$O3d[e].mediaTag
      ? (void 0 !== t && (this.$O3d[e].mediaTag.volume = t), this.$O3d[e].mediaTag.volume)
      : 0;
  }),
  ...
  (apnx.btnize = function (e, t, a) {
    function i(e, t) {
      t == bx.CGesture.POINTER_START
        ...
        : t == bx.CGesture.POINTER_END && ((e.$OcR = !1), e.btnOnState && e.btnOnState(e));
    }
    ((e.apnxBtnizeOpts = t),
      (a = a || {}),
      (e.apxOnEvent =
      ...
      ((t.idle && t.idle.hover) || (t.selected && t.selected.hover) || a.tag) &&
        ((e.onmouseover = function (e) {
          if (!this.$OcR && !this.$OcO) {
            ...
            this.$OcP
              ? (t.selected && t.selected.hover && (this.src = t.selected.hover),
                a.tag &&
                  a.selected &&
                  ((a.tag.src = a.selected.url),
                  (a.tag.style.display = 'block'),
                  (a.tag.style.left =
                    this.offsetLeft + this.offsetWidth / 2 + a.selected.dx + 'px'),
                  (a.tag.style.top = this.offsetTop + this.offsetHeight + a.selected.dy + 'px')))
              : (t.idle && t.idle.hover && (this.src = t.idle.hover),
                a.tag &&
                  a.idle &&
                  ((a.tag.src = a.idle.url),
                  (a.tag.style.display = 'block'),
                  (a.tag.style.left = this.offsetLeft + this.offsetWidth / 2 + a.idle.dx + 'px'),
                  (a.tag.style.top = this.offsetTop + this.offsetHeight + a.idle.dy + 'px')));
          }
        }),
        (e.onmouseout = function (e) {
          ...
          (this.$OcP
            ...
            : t.idle &&
              t.idle.hover &&
              (this.$OcR && t.idle.down ? (this.src = t.idle.down) : (this.src = t.idle.normal)),
            a.tag && 'block' == a.tag.style.display && (a.tag.style.display = 'none'));
        })),
  ...
  (apx.fireEvent = function (e, t, a, i) {
    ...
    if (('Custom' == e && (e = 'Custom Event'), 'Custom Event' != e && 'Visibility Change' != e))
      return void console.error(
        '[Aspen] Unknown event is requested to be fired. (Event=' + e + ')',
      );
    if ('Visibility Change' == e)
      ('visible' != t && 'hidden' != t) ||
        window.postMessage({ CExe: { type: 'onVisibilityChange', data: t } }, '*');
    else {
  ...
  (apx.set = function (e, t) {
    void 0 !== e &&
      (window.apnExe
        ...
        : ((apx.spt2fileVar = apx.spt2fileVar || []), apx.spt2fileVar.push({ key: e, value: t })));
  }),
    ...
    if (((e.$O3U = e.$O3U || {}), (e.$O3U[t] = a), e.$O3V && e.$O3V.length))
      for (var i, n, r = 0; r < e.$O3V.length; r++)
        ((i = !1),
          ...
          (n = e.getPage(e.$O3V[r].pId)) && n.canvas && n.canvas._inPagePauseEvent && (i = !0),
          (i || e.$O3V[r].always) && e.$O3V[r].key == t && e.$O3V[r].handler(a, t));
  }),
  (apx.srcCloneWidget = function (e, t, a) {
    ...
    function n(t) {
      if ((l.push({ idOld: t }), e.objects[t].layout && e.objects[t].layout.children))
  ...
  (AspenWebAudio.prototype.setMedia = function (e) {
    ...
    (AspenWebAudio.audioContext ||
      (AspenWebAudio.audioContext = new (
        window.AudioContext ||
    ...
    return this.tag.wgCtx.loadedUrl !== this.tag.wgCtx.requestUrl
      ...
      : this.tag.wgCtx.isPlaying
        ...
        : void (this.tag.wgCtx.Buffer
            ? ((this.tag.wgCtx.source = AspenWebAudio.audioContext.createBufferSource()),
              (this.tag.wgCtx.processor = AspenWebAudio.audioContext.createScriptProcessor(
                2048,
                1,
                1,
              )),
              ...
              (this.tag.wgCtx.processor.onaudioprocess = function (e) {
                ((a.tag.wgCtx.currentTime = AspenWebAudio.audioContext.currentTime),
              ...
              this.tag.wgCtx.gainNode.connect(AspenWebAudio.audioContext.destination),
              this.tag.wgCtx.processor.connect(this.tag.wgCtx.gainNode),
              this.tag.wgCtx.source.start(0, t),
              (this.tag.wgCtx.startedAt = AspenWebAudio.audioContext.currentTime - t),
              (this.tag.wgCtx.pausedAt = 0),
              ...
              this.onStart && e ? this.onStart() : this.onResume && !e && this.onResume())
  ...
  (AspenWebAudio.prototype.close = function () {
    AspenWebAudio.audioContext &&
      ...
      (AspenWebAudio.audioContext.close(), (AspenWebAudio.audioContext = void 0));
  }),
